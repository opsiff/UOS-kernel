...
bool __weak arch_tlb_batch_flush_enable(void)
{
	return IS_ENABLED(CONFIG_ARCH_WANT_BATCHED_UNMAP_TLB_FLUSH);
}
...
{
	if (!arch_tlb_batch_flush_enable())
		return false;
...
#endif
{
	...
	struct rmap_walk_control rwc = {
		...
		.try_lock = !!g_rmap_trylock_enable,
	};
