...
void pch_mmap_readextend(struct vm_area_struct *vma,
				...
				pgoff_t offset);
#endif
extern void pch_read_around(struct readahead_control *ractl,
				struct file_ra_state *ra,
				struct file *file,
				pgoff_t offset);
#else
...
static inline void pch_mmap_readextend(struct vm_area_struct *vma,
				...
				pgoff_t offset) {}
#endif
static inline void pch_read_around(struct readahead_control *ractl,
				struct file_ra_state *ra,
...
#endif
extern int g_rmap_trylock_enable;
...
#define ALLOC_VIP		0x100 /* allow allocations from VIP areas */
#endif
