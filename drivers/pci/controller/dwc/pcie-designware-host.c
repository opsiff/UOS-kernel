...
err_free_msi:
	CALL_HCK_VH(kport_pcie_release_resource, &pdev->dev, &bridge->windows);
				 ...
				 int where, int size, u32 *val)
{
	...
	CALL_HCK_VH(kport_pcie_refclk_host_vote, pp, 1);
	...
	CALL_HCK_VH(kport_pcie_refclk_host_vote, pp, 0);
	return ret;
}
