...
static int g_try_set_quirks_en = 0;
#endif
...
static const struct usb_device_id usb_quirk_list[] = {
	...
	{ USB_DEVICE(0x8564, 0x1000), .driver_info = US_UDEV_QUIRK_STOP_TRANS_PRE_RESET },
...
static void usb_detect_quirks(struct us_data *us)
{
	...
	if (g_try_set_quirks_en)
		us->udev_quirks |= US_UDEV_QUIRK_STOP_TRANS_PRE_RESET;
