...
extern void usb_notify_set_address_err(struct usb_device *udev);
extern void usb_notify_get_descriptor_err(struct usb_device *udev);
extern void usb_notify_enum_dev_unknown_err(struct usb_device *udev);
extern void usb_notify_transfer_err(struct usb_device *udev);
#else
static inline void usb_notify_set_address_err(struct usb_device *udev) { };
static inline void usb_notify_get_descriptor_err(struct usb_device *udev) { };
static inline void usb_notify_enum_dev_unknown_err(struct usb_device *udev) { };
static inline void usb_notify_transfer_err(struct usb_device *udev) { };
#endif
