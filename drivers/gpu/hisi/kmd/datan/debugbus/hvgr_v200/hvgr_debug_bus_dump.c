...
static bool kdatan_debug_bus_write_to_buffer(struct bus_dump_resource_info *info, const char *data)
{
	...
	ret = snprintf_s(info->buffer + *pos, (u32)(buffer_size - *pos), (u32)(buffer_size - *pos - 1), "%s",
		data);
	if (ret < 0) {
...
static u32 kdatan_debug_bus_read(struct hvgr_device * const gdev, u32 cfg)
{
	...
	while ((hvgr_read_reg(gdev, gpu_control_reg(gdev, GPU_DBG_STATUS)) == 0)
...
static void kdatan_bus_dump_gpc_lsc_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_LSC, STATE_TYEP_5, DEST_ID_GPC_LSC_STATE_5_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_LSC, STATE_TYEP_6, DEST_ID_GPC_LSC_STATE_6_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_LSC, STATE_TYEP_7, DEST_ID_GPC_LSC_STATE_7_SIZE);
}
...
static void kdatan_bus_dump_gpc_gtc_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_GTC, STATE_TYEP_1, DEST_ID_GPC_GTC_STATE_1_SIZE);
}
...
static void kdatan_bus_dump_gpc_rtu_data(struct bus_dump_resource_info *info, int core_id) {
	uint32_t gpu_id;

	gpu_id = info->gdev->dm_dev.dev_reg.gpu_id & GPU_ID1_PRODUCT_MODEL;
	if (gpu_id != GPU_ID2_PRODUCT_TV211)
		return;
	hvgr_info(info->gdev, HVGR_DATAN, "%s %s in", debug_bus_tag, __func__);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_RTU, STATE_TYEP_0, DEST_ID_GPC_RTU_STATS_0_SIZE);
}
...
static void kdatan_bus_dump_gpc_dm_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_DM1, STATE_TYEP_0, DEST_ID_GPC_DM_STATS_0_SIZE);
}
...
static void kdatan_bus_dump_gpc_rcp_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_RCP, STATE_TYEP_1, DEST_ID_GPC_RCP_STATS_1_SIZE);
}
...
static void kdatan_bus_dump_gpc_cbi_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_CBI, STATE_TYEP_1, DEST_ID_GPC_CBI_STATE_1_SIZE);
}
...
static void kdatan_bus_dump_gpc_tu_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TAG1, STATE_TYEP_0, DEST_ID_GPC_TAG_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSG, STATE_TYEP_0, DEST_ID_GPC_TSG_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSG1, STATE_TYEP_0, DEST_ID_GPC_TSG_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_0, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_1, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_2, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_3, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_4, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_5, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_6, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_7, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_8, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_9, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_10, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_11, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_12, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_13, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_14, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM, STATE_TYEP_15, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_0, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_1, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_2, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_3, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_4, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_5, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_6, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_7, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_8, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_9, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_10, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_11, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_12, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_13, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_14, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TSM1, STATE_TYEP_15, DEST_ID_GPC_TSM_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TCC, STATE_TYEP_0, DEST_ID_GPC_TCC_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TCC1, STATE_TYEP_0, DEST_ID_GPC_TCC_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TFU, STATE_TYEP_0, DEST_ID_GPC_TUF_STATE_0_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TFU1, STATE_TYEP_0, DEST_ID_GPC_TUF_STATE_0_SIZE);
}

static void kdatan_bus_dump_gpc_tl1c_data(struct bus_dump_resource_info *info, int core_id)
{
	hvgr_info(info->gdev, HVGR_DATAN, "%s %s in", debug_bus_tag, __func__);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_GPC_TL1C, STATE_TYEP_0, DEST_ID_GPC_TL1C_STATE_0_SIZE);
}
...
static void kdatan_bus_dump_gpc_debug_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_gpc_rtu_data(info, core_id);
	...
	kdatan_bus_dump_gpc_tl1c_data(info, core_id);
}
...
static void kdatan_bus_dump_bvh_debug_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_BVH_BCACHE, STATE_TYEP_0, DEST_ID_BVH_BCACHE_STATE_0_SIZE);
...
static void datan_bus_dump_fcm_debug_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_FCM_JOB, STATE_TYEP_2, DEST_ID_FCM_JOB_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_FCM_JOB, STATE_TYEP_3, DEST_ID_FCM_JOB_STATE_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_FCM_CQ, STATE_TYEP_0, DEST_ID_FCM_CQ_STATE_0_SIZE);
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_FCM_TOP, STATE_TYEP_0, DEST_ID_FCM_TOP_STATE_0_SIZE);
}
...
static void datan_bus_dump_l2mmu_debug_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_0, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_1, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_2, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_3, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_4, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_5, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_6, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_7, DEST_ID_L2MMU_MMU_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_MMU, STATE_TYEP_8, DEST_ID_L2MMU_MMU_STATE_8_SIZE);
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_JBI, STATE_TYEP_0, DEST_ID_L2MMU_JBI_STATE_0_SIZE);
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_L2MMU_PEU, STATE_TYEP_0, DEST_ID_L2MMU_PEB_STATE_0_SIZE);
}
...
static void datan_bus_dump_bin_debug_data(struct bus_dump_resource_info *info, int core_id)
{
	...
	kdatan_bus_dump_state_type(info, core_id, DEST_ID_BIN_BBI, STATE_TYEP_0, DEST_ID_BIN_BBI_STATE_0_SIZE);
...
{
	struct hvgr_device *gdev = info->gdev;
	u32 addr = (u32)gdev->dm_dev.reg_base.gpu_reg_base;
	char data[DUMP_DATA_MAX_SIZE] = {0};
	u32 reg_offset;
	int ret;
	...
	reg_offset = (u32)gpu_control_reg(gdev, GPU_DBG_RDATA);
...
static void datan_bus_dump_cq_control_register(struct bus_dump_resource_info *info)
{
	...
	int chn;
	int ret;
	u32 addr = (u32)cq_control_reg(gdev, CQ_ENABLE);
	u32 reg_offset = (u32)cq_control_reg(gdev, CQ_BC_SEND_MODE);
	char data[DUMP_DATA_MAX_SIZE] = {0};
	...
	kdatan_debug_bus_record_reg_data(info, (u32)cq_control_reg(gdev, CQ_IRQ_TOP));

	for (; addr <= reg_offset; addr += (u32)sizeof(u32))
		kdatan_debug_bus_record_reg_data(info, addr);

	kdatan_debug_bus_record_reg_data(info, (u32)cq_control_reg(gdev, CQ_SUBMIT));

	for (chn = 0; chn < CQ_CHANNEL_NUM; chn++) {
		addr = (u32)cq_control_reg(gdev, cq_irq_rawstat(chn));
		reg_offset = (u32)cq_control_reg(gdev, cq_bind_subchn_os(chn));
		for (; addr <= reg_offset; addr += (u32)sizeof(u32))
			kdatan_debug_bus_record_reg_data(info, addr);
	}
}
...
static void datan_bus_dump_misc_control_register(struct bus_dump_resource_info *info)
{
	...
	for (addr = JS_PRESENT; addr <= GPC_CONFIG_18; addr += (u32)sizeof(u32))
		kdatan_debug_bus_record_reg_data(info, addr);
}
...
static void datan_bus_dump_job_control_register(struct bus_dump_resource_info *info)
{
	...
	for (i = 0; i < array_size; i++) {
		addr = (u32)job_control_reg(gdev, job_control_reg_dump[i]);
		kdatan_debug_bus_record_reg_data(info, addr);
	}
	...
	for (j = 0; j < BASE_FCM_MAX_NR_SLOTS; j++) {
		for (i = 0; i < array_size; i++) {
			addr = (u32)job_slot_x_reg(gdev, j, job_slot_reg_dump[i]);
			kdatan_debug_bus_record_reg_data(info, addr);
		}
	}
	...
	for (j = 0; j < BASE_FCM_MAX_NR_SLOTS; j++) {
		...
		for (jc = 0; jc < JOB_CHAIN_NUM; jc++) {
			...
			for (i = 0; i < array_size; i++) {
				addr = (u32)job_jc_y_reg(gdev, jc_idx, job_jc_reg_dump[i]);
				kdatan_debug_bus_record_reg_data(info, addr);
			}
		}
	}
...
static void datan_bus_dump_mmu_register_v2xx(struct bus_dump_resource_info *info)
{
	u32 dump_addr;
	u32 addr_space_num = 0;
	struct hvgr_device *gdev = info->gdev;
	u32 end_addr = (u32)mmu_control_reg(gdev, MMU_CMD_DONE);
	u32 start_addr = (u32)gdev->dm_dev.reg_base.mmu_stage1_reg_base;

	for (; start_addr <= end_addr; start_addr += (u32)sizeof(u32))
		kdatan_debug_bus_record_reg_data(info, start_addr);
	end_addr = AS_FAULTEXTRA_HI;

	for (; addr_space_num < MAX_ADDR_SPACE_NUM; addr_space_num++) {
		start_addr = AS_COMMAND;

		for (; start_addr <= end_addr; start_addr += FCP_REG_SIZE) {
			/* according to register manual */
			dump_addr = (u32)mmu_control_reg(gdev, mmu_as_reg(addr_space_num, start_addr));
...
static void datan_bus_dump_mmu_register(struct bus_dump_resource_info *info)
{
	...
	datan_bus_dump_mmu_register_v2xx(info);
}

static void datan_bus_dump_fcp_cq_regs(struct bus_dump_resource_info *info)
{
	struct hvgr_device *gdev = info->gdev;

	u32 addr = (u32)fcp_mb_reg(gdev, FCP_MB_MCUVECTOR_ADDR_CQ);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_MCU_ERROR_CQ); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	addr = (u32)fcp_mb_reg(gdev, FCP_MB_MCU_VAADDR_CQ);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_MCU_REG_STATUS_CQ); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	addr = (u32)fcp_mb_reg(gdev, FCP_MB_CQ_MCU_IRQ);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_CQ_MCU_DONE); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	kdatan_debug_bus_record_reg_data(info, (u32)fcp_mb_reg(gdev, FCP_MB_EDMA2MCU_CQ_MASKINT));
}

static void datan_bus_dump_fcp_cf_regs(struct bus_dump_resource_info *info)
{
	struct hvgr_device *gdev = info->gdev;

	u32 addr = (u32)fcp_mb_reg(gdev, FCP_MB_MCUVECTOR_ADDR);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_MCU_ERROR); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	addr = (u32)fcp_mb_reg(gdev, FCP_MB_MCU_VAADDR);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_MCU_REG_STATUS); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	addr = (u32)fcp_mb_reg(gdev, FCP_MB_CF_MCU_IRQ);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_CF_MCU_DONE); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	kdatan_debug_bus_record_reg_data(info, (u32)fcp_mb_reg(gdev, FCP_MB_EDMA2MCU_CF_MASKINT));
}

static void datan_bus_dump_fcp_ddr_map_cq_regs(struct bus_dump_resource_info *info)
{
	u32 req_num = 0;
	u32 window_num = 0;
	u32 addr;
	...
	for (; req_num < MAX_REQ_NUM; req_num++) {
		addr = (u32)fcp_mb_mcu_ddr_map_cq_reg(gdev, req_num);
		kdatan_debug_bus_record_reg_data(info, addr);
	}

	for (; window_num < MAX_WINDOW_NUM; window_num++) {
		addr = (u32)fcp_mb_mcu_ddr_map_cq_wind(gdev, window_num);
		kdatan_debug_bus_record_reg_data(info, addr);
	}
}

static void datan_bus_dump_fcp_ddr_map_regs(struct bus_dump_resource_info *info)
{
	u32 req_num = 0;
	u32 window_num = 0;
	u32 addr;
	...
	for (; req_num < MAX_REQ_NUM; req_num++) {
		addr = (u32)fcp_mb_mcu_ddr_map_reg(gdev, req_num);
		kdatan_debug_bus_record_reg_data(info, addr);
	}

	for (; window_num < MAX_WINDOW_NUM; window_num++) {
		addr = (u32)fcp_mb_mcu_ddr_map_wind(gdev, window_num);
		kdatan_debug_bus_record_reg_data(info, addr);
	}
}

static void datan_bus_dump_fcp_status_regs(struct bus_dump_resource_info *info)
{
	struct hvgr_device *gdev = info->gdev;
	u32 addr = (u32)fcp_mb_reg(gdev, FCP_MB_EDMA2JM_MASKINT);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_EDMA2HOST_MASKINT); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);
}

static void datan_bus_dump_fcp_cmd_msg_regs(struct bus_dump_resource_info *info)
{
	u32 mb_cmd_msg_num = 0;
	u32 addr;
	struct hvgr_device *gdev = info->gdev;

	for (; mb_cmd_msg_num < MAX_MB_CMD_MSG_NUM; mb_cmd_msg_num++) {
		addr = (u32)fcp_mb_reg(gdev, FCP_MB_HOST2FCP_MSG_0) + mb_cmd_msg_num * FCP_REG_SIZE;
		kdatan_debug_bus_record_reg_data(info, addr);
	}
}

static void datan_bus_dump_fcp_status_msg_regs(struct bus_dump_resource_info *info)
{
	u32 mb_status_msg_num = 0;
	u32 addr;
	struct hvgr_device *gdev = info->gdev;

	for (; mb_status_msg_num < MAX_MB_STATUE_MSG_NUM; mb_status_msg_num++) {
		addr = (u32)fcp_mb_reg(gdev, FCP_MB_FCP2HOST_MSG_0) + mb_status_msg_num * FCP_REG_SIZE;
		kdatan_debug_bus_record_reg_data(info, addr);
	}
}

static void datan_bus_dump_fcp_other_msgrdy(struct bus_dump_resource_info *info)
{
	struct hvgr_device *gdev = info->gdev;
	u32 addr = (u32)fcp_mb_reg(gdev, FCP_MB_HOST2FCP_MSG_VLD);

	for (; addr <= fcp_mb_reg(gdev, FCP_MB_HOST2FCP_MSG_VLD_CLR); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);

	addr = (u32)fcp_mb_reg(gdev, FCP_MB_FCP2HOST_MSG_VLD);
	for (; addr <= fcp_mb_reg(gdev,  FCP_MB_FCP2HOST_MSG_VLD_CLR); addr += FCP_REG_SIZE)
		kdatan_debug_bus_record_reg_data(info, addr);
}
...
static void datan_bus_dump_fcp_dma_regs(struct bus_dump_resource_info *info)
{
	...
	kdatan_debug_bus_record_reg_data(info, (u32)fcp_dma_reg(gdev, FCP_DMA_CH_INT_TCRAW));

	for (; dma_ch < MAX_DMA_CHANNEL_NUMBER; dma_ch++) {
		addr = FCP_DMA_CX_CNT;
		for (; addr <= FCP_DMA_BUFDATA; addr += FCP_REG_SIZE) {
			dump_addr = (u32)fcp_dma_chanel_reg(gdev, dma_ch, addr);
			kdatan_debug_bus_record_reg_data(info, dump_addr);
		}
	}
}

static void datan_bus_dump_fcp_timer_regs(struct bus_dump_resource_info *info)
{
	u32 timer_number = MAX_TIMER_NUMBER;
	u32 start_addr = FCP_TIMER_CLK_CONTROL;
	u32 end_addr = FCP_TIMER_COUNTER;
	u32 dump_addr;
	u32 timer_idx;
	u32 addr;
	struct hvgr_device *gdev = info->gdev;

	for (timer_idx = 0; timer_idx < timer_number; timer_idx++) {
		addr = start_addr;
		for (; addr <= end_addr; addr += FCP_REG_SIZE) {
			dump_addr = (u32)fcp_timer_load_reg(gdev, timer_idx, addr);
			kdatan_debug_bus_record_reg_data(info, dump_addr);
		}
	}
}
...
static void datan_bus_dump_fcp_register(struct bus_dump_resource_info *info)
{
	...
	kdatan_debug_bus_write_to_buffer(info, data);
	datan_bus_dump_fcp_cf_regs(info);
	datan_bus_dump_fcp_cq_regs(info);
	datan_bus_dump_fcp_ddr_map_cq_regs(info);
	datan_bus_dump_fcp_ddr_map_regs(info);
	datan_bus_dump_fcp_status_regs(info);
	datan_bus_dump_fcp_cmd_msg_regs(info);
	datan_bus_dump_fcp_status_msg_regs(info);
	datan_bus_dump_fcp_other_msgrdy(info);
	datan_bus_dump_fcp_dma_regs(info);
	datan_bus_dump_fcp_timer_regs(info);
}
...
{
	int ret;
	/* New Arch For V200, Not For V100 or V120 */
	ret = snprintf_s(data, size, size - 1, VERSION_200);
	if (ret < 0)
		hvgr_err(gdev, HVGR_DATAN, "debug bus [%s] snprintf_s failed.", __func__);
}
...
void hvgr_debug_bus_write_to_file(char *buffer, char *file_name)
{
	...
	if (strlen(buffer) == 0 || file_name == NULL)
		return;
	...
	old_fs = get_fs();
	set_fs(KERNEL_DS);
	(void)vfs_write(data_file, buffer, strlen(buffer), &pos);
	set_fs(old_fs);
#else
	(void)kernel_write(data_file, buffer, strlen(buffer), &pos);
#endif
...
#ifdef CONFIG_LIBLINUX
	/* For RDR platform, write dbb file by debugfs. */
	return true;
#endif
...
/*
 * cat show debug bus register data
 */
static ssize_t kdatan_bus_dump_show_data(void *data, char * const buf)
{
	ssize_t ret = 0;
	...
	mutex_lock(&gdev->datan_dev.datan_bus_dev.debug_bus_mutex);
	hvgr_info(gdev, HVGR_DATAN, "%s IN.", __func__);
	buffer_offset = gdev->datan_dev.datan_bus_dev.buffer_offset;
	buffer_size = gdev->datan_dev.datan_bus_dev.buffer_size;
	hvgr_info(gdev, HVGR_DATAN, "size: %u, offset: %u.", buffer_size, buffer_offset);
	if (buffer_size == 0) {
		mutex_unlock(&gdev->datan_dev.datan_bus_dev.debug_bus_mutex);
		return ret;
	}

	tmp = gdev->datan_dev.datan_bus_dev.debugbus_buf + buffer_offset;
	if (buffer_size - buffer_offset > PAGE_SIZE) {
		/* Every read 4095 bytes, move the pointer by ret value . */
		ret = scnprintf(buf, PAGE_SIZE, "%s", tmp);
		if (ret > 0)
			gdev->datan_dev.datan_bus_dev.buffer_offset += (size_t)ret;
	} else {
		/* Read the rest data which size is less 4095. */
		ret = scnprintf(buf, buffer_size - buffer_offset, "%s", tmp);
		vfree(gdev->datan_dev.datan_bus_dev.debugbus_buf);
		gdev->datan_dev.datan_bus_dev.debugbus_buf = NULL;
		gdev->datan_dev.datan_bus_dev.debugbus_cnt--;
		gdev->datan_dev.datan_bus_dev.buffer_offset = 0;
		gdev->datan_dev.datan_bus_dev.buffer_size = 0;
	}
	mutex_unlock(&gdev->datan_dev.datan_bus_dev.debug_bus_mutex);
	return ret;
}

static ssize_t kdatan_bus_dump_clear_data(void *data, const char *buf, size_t count)
{
	return 0;
}

hvgr_debugfs_read_write_declare(fops_debug_bus, kdatan_bus_dump_show_data, kdatan_bus_dump_clear_data);

static void kdatan_bus_dump_debugfs_init(struct hvgr_device *gdev)
{
	gdev->datan_dev.datan_dir = hvgr_debugfs_create_dir("datan", gdev->root_debugfs_dir);
	if (IS_ERR_OR_NULL(gdev->datan_dev.datan_dir)) {
		hvgr_err(gdev, HVGR_DATAN, "datan debugfs init fail.");
		return;
	}
#ifdef CONFIG_DFX_DEBUG_FS
	hvgr_debugfs_register(gdev, "debugbus", gdev->datan_dev.datan_dir, &fops_debug_bus);
#endif
}
...
void kdatan_debug_bus_start_dump(struct hvgr_device * const gdev)
{
	...
	struct hvgr_debugbus_dev * const datan_bus_dev = &gdev->datan_dev.datan_bus_dev;
	struct hvgr_gpu_fault_msg *gpu_fault_msg = &gdev->datan_dev.gpu_fault_msg;
	int buffer_cnt = 0;
	...
	if (datan_debug_bus_check_disk()) {
		...
		datan_bus_dev->gpu_fault_type = gpu_fault_msg->gpu_fault_id;
...
static void kdatan_debug_bus_write_buffer_to_file(struct hvgr_device *gdev,
	struct hvgr_datan_dev *datan_dev, struct hvgr_debugbus_dev *bus_dev)
{
	int ret = 0;
	u32 buffer_size;
...
static void kdatan_debug_bus_write_file_worker(struct work_struct *data)
{
	...
	int ret;
	char time[MAX_TIME_SIZE] = {0};
	char notify_record[HVGR_DEBUG_BUS_RECORD_LEN] = {0};
	char file_name[MAX_FILE_NAME_SIZE] = {0};
#endif
...
#ifdef CONFIG_LIBLINUX
	bus_dev->buffer_size = strlen(bus_dev->debugbus_buf);
	datan_debug_bus_get_common_string(file_name, time);
	ret = sprintf_s(notify_record, sizeof(notify_record), HVGR_DEBUG_BUS_RECORD,
		HVGR_DEBUG_BUS_DEBUG_FS, file_name);
	if (ret > 0)
		(void)save_notify_log_info(notify_record, strlen(notify_record));
	else
		hvgr_err(gdev, HVGR_DATAN, "%s notify fail", __func__);
#elif defined(CONFIG_HVGR_DFX_MNTN_REPORT)
	hvgr_mntn_error_report(gdev);
#else
	kdatan_debug_bus_write_buffer_to_file(gdev, datan_dev, bus_dev);
#endif
	return;
}
...
void kdatan_debug_bus_cbit_config(struct hvgr_device * const gdev)
{
	...
	val = val | HVGR_BTC_CONFIG_OFFSET;
...
void kdatan_bus_dump_thread_init(struct hvgr_device * const gdev)
{
	...
	datan_bus_dev->buffer_offset = 0;
	datan_bus_dev->buffer_size = 0;

	gpu_hang_count = 0;
	kdatan_debug_bus_cbit_config(gdev);
	kdatan_bus_dump_debugfs_init(gdev);
