...
#define ZINITIX_WAIT_IRQ_TIMES_PSD                 10000
...
#define ZINITIX_TX_NUM_MAX                         10
#define ZINITIX_RX_NUM_MAX                         10
...
struct zinitix_platform_data {
	...
	u32 flash_size;
	u32 support_finger_number;
	u32 need_change_esd_check_times;
...
struct zinitix_touch_point_info {
	...
	u8 finger_cnt;
	u8 time_stamp;
	struct zinitix_touch_coord coord[10];
};
