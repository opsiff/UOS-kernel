...
enum display_engine_module_id {
	...
	DISPLAY_ENGINE_SRE_LUX = BIT(11),
	DISPLAY_ENGINE_EL_SWITCH = BIT(12),
	DISPLAY_ENGINE_DDIC_TEMPER = BIT(13),
};
...
struct display_engine_param {
	...
	unsigned int sre_lux; // FOR EL
	unsigned int elvss_switch;
	int ddic_temper_enable;
};
