	...
	struct device_attribute *attr, char *buf)
{
	...
	ret = snprintf(buf, PAGE_SIZE, "Device Sink Config(0x10)= 0x%x\nEprom Configuration0(0x11) = 0x%x\n \
			...
			lm3697_bl_info.lm3697_reg[0], lm3697_bl_info.lm3697_reg[1], lm3697_bl_info.lm3697_reg[2], lm3697_bl_info.lm3697_reg[3],
			lm3697_bl_info.lm3697_reg[4], lm3697_bl_info.lm3697_reg[5], lm3697_bl_info.lm3697_reg[6], lm3697_bl_info.lm3697_reg[7],
			lm3697_bl_info.lm3697_reg[8], lm3697_bl_info.lm3697_reg[9], lm3697_bl_info.lm3697_reg[10], lm3697_bl_info.lm3697_reg[11],
			lm3697_bl_info.lm3697_reg[12], lm3697_bl_info.lm3697_reg[13], lm3697_bl_info.lm3697_reg[14], lm3697_bl_info.lm3697_reg[15],
			lm3697_bl_info.lm3697_reg[16], lm3697_bl_info.lm3697_reg[17], lm3697_bl_info.lm3697_reg[18], lm3697_bl_info.lm3697_reg[19]);
	return ret;
