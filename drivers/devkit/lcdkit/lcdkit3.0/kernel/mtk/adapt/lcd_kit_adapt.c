...
int lcd_kit_dsi_cmds_tx(int panel_id, void *dsi, struct lcd_kit_dsi_panel_cmds *cmds)
{
	int i;
...
int lcd_kit_dsi_cmds_rx(int panel_id, void *dsi, unsigned char *out, int out_len,
