...
#define LCD_KIT_INITIAL_CODE_MAX_BLEN (2 * 1024 * 1024) // max lines: 2 * 1024 * 1024 / 66 = 31775 lines
...
struct lcd_kit_dbg_ops {
	...
	int (*dbg_dual_mipi_diff_rx)(unsigned char *out0, unsigned char *out1,
		int out_len, struct lcd_kit_dsi_panel_cmds *cmds0,
		struct lcd_kit_dsi_panel_cmds *cmds1);
	bool (*is_dual_mipi_panel)(int panel_id);
