...
uint8_t service_get_valid(uint8_t service);
...
int32_t hw_bfgx_write_check(struct file *filp, const char __user *buf,
...
int32_t plat_gt_dump_rotate_cmd_read(unsigned long arg);
