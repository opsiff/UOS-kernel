...
enum wlan_cfg_init {
    ...
    WLAN_CFG_INIT_5G_POW_PARA_L0,
    WLAN_CFG_INIT_5G_POW_PARA_L1,
    WLAN_CFG_INIT_5G_POW_PARA_L2,
    WLAN_CFG_INIT_5G_POW_PARA_L3,
    WLAN_CFG_INIT_5G_POW_PARA_L4,
    WLAN_CFG_INIT_5G_POW_PARA_L5,
    WLAN_CFG_INIT_2G_POW_PARA_L0,
    WLAN_CFG_INIT_2G_POW_PARA_L1,
    WLAN_CFG_INIT_2G_POW_PARA_L2,
    WLAN_CFG_INIT_2G_POW_PARA_L3,
    WLAN_CFG_INIT_2G_POW_PARA_L4,
    WLAN_CFG_INIT_2G_POW_PARA_L5,
#endif
#ifdef _PRE_WLAN_EXPORT
    WLAN_CFG_INIT_EFUSE_MAC_ADDR,
    WLAN_CFG_INIT_EFUSE_MAC_ADDR_2BYTE,
#endif
    WLAN_CFG_INIT_BUTT,
};
