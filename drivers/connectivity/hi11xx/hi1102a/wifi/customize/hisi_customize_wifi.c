...
OAL_STATIC wlan_cfg_cmd g_wifi_config_cmds[] = {
    ...
    {"nv_5g_pow_para_l0",               WLAN_CFG_INIT_5G_POW_PARA_L0},
    {"nv_5g_pow_para_l1",               WLAN_CFG_INIT_5G_POW_PARA_L1},
    {"nv_5g_pow_para_l2",               WLAN_CFG_INIT_5G_POW_PARA_L2},
    {"nv_5g_pow_para_l3",               WLAN_CFG_INIT_5G_POW_PARA_L3},
    {"nv_5g_pow_para_l4",               WLAN_CFG_INIT_5G_POW_PARA_L4},
    {"nv_5g_pow_para_l5",               WLAN_CFG_INIT_5G_POW_PARA_L5},
    {"nv_2g_pow_para_l0",               WLAN_CFG_INIT_2G_POW_PARA_L0},
    {"nv_2g_pow_para_l1",               WLAN_CFG_INIT_2G_POW_PARA_L1},
    {"nv_2g_pow_para_l2",               WLAN_CFG_INIT_2G_POW_PARA_L2},
    {"nv_2g_pow_para_l3",               WLAN_CFG_INIT_2G_POW_PARA_L3},
    {"nv_2g_pow_para_l4",               WLAN_CFG_INIT_2G_POW_PARA_L4},
    {"nv_2g_pow_para_l5",               WLAN_CFG_INIT_2G_POW_PARA_L5},
#endif
#ifdef _PRE_WLAN_EXPORT
    {"efuse_mac_addr",                  WLAN_CFG_INIT_EFUSE_MAC_ADDR},
    {"efuse_mac_addr_2byte",            WLAN_CFG_INIT_EFUSE_MAC_ADDR_2BYTE},
#endif
    { OAL_PTR_NULL, 0 }
};
...
#ifdef _PRE_WLAN_NARROW_BAND
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L0] = 0x6f03aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L1] = 0x6f03aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L2] = 0x6f03aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L3] = 0x6f02aa;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L4] = 0x6f0296;
    g_host_init_params[WLAN_CFG_INIT_5G_POW_PARA_L5] = 0x6f005a;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L0] = 0x6f02aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L1] = 0x6f02aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L2] = 0x6f02aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L3] = 0x6f02aa;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L4] = 0x6f0296;
    g_host_init_params[WLAN_CFG_INIT_2G_POW_PARA_L5] = 0x6f025a;
#endif
#ifdef _PRE_WLAN_EXPORT
    g_host_init_params[WLAN_CFG_INIT_EFUSE_MAC_ADDR] = 0;
    g_host_init_params[WLAN_CFG_INIT_EFUSE_MAC_ADDR_2BYTE] = 0;
#endif
