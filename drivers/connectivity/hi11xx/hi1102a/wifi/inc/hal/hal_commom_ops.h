...
#define NB_SEND_CTRL_DATA  1         /* 无人机控制信息 */
#define NB_NOKEY_MODE  2         /* 无人机对频模式 */
#define NB_KEY_SET  3         /* 无人机下发key信息 */
#define NB_KEY_REPORT  4         /* 无人机上报key信息 */
#define NB_APP_TRX_ACTION 101   /* 上层收发action帧 */
#define MAX_NB_ACTION_LEN 128   /* 窄带最长action帧长 */
#define NB_ACTION_HDR_LEN 2     /* 窄带action 头长度 */
/*****************************************************************************
  3 枚举
*****************************************************************************/
typedef enum {
...
extern oal_void hi1102_set_primary_channel(hal_to_dmac_device_stru *pst_hal_device,
                                           ...
                                           wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void  hi1102_set_vendor_channel(
    hal_to_dmac_device_stru *pst_hal_device,
    oal_uint8                uc_channel_num,
    oal_uint8                uc_band,
    oal_uint8                uc_channel_idx,
