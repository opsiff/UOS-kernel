...
typedef enum {
    ...
    *************************************************************************/
...
#endif
    WLAN_CFGID_PDET_VAL_READ = 348,        /*读取pdet值 */
    WLAN_CFGID_TSENSOR_READ = 349,        /*读取tsensor值 */
    ...
    WLAN_CFGID_REG_INFO_REPORT = 356,   /* 寄存器地址上报信息 */
    WLAN_CFGID_POWER_PARAM_READ = 357,   /* 读取功率信息 */

    WLAN_CFGID_SET_AUTO_PROTECTION = 362, /* 设置auto protection开关 */

#ifdef _PRE_WLAN_NARROW_BAND
    WLAN_CFGID_NB_REPORT_INFO_READ = 363, /* 读取速率档位 */
    WLAN_CFGID_AUTORATE_CFG_SET = 364, /* 设置自适应使能参数 */
    WLAN_CFGID_AUTORATE_PARAM = 365, /* 设置自适应所有参数 */
    WLAN_CFGID_NOKEY_MODE_SET = 366, /* 设置对频模式 */
    WLAN_CFGID_KEY_INFO_RPT = 367, /* 设置对频模式 */
#endif
    ...
    WLAN_CFGID_QUERY_TID_QUEUE = 473, /* tid缓存队列信息上报查询命令 */
    ...
    WLAN_CFGID_SET_DISTANCE = 579,
    WLAN_CFGID_SET_POWER_PARAM = 580,
#ifdef _PRE_WLAN_FEATURE_APF
    WLAN_CFGID_SET_APF = 581, /* 设置APF PROGRAM */
#endif
    WLAN_CFGID_PM_DEBUG_SWITCH = 582, /* 低功耗调试命令 */
    WLAN_CFGID_SET_VENDOR_CHANNEL = 583,
    ...
    WLAN_CFGID_CHAN_MEAS_EVENT = 686,
