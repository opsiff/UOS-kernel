...
extern oal_uint32  dmac_alg_register_nbfh_start_notify_func_ram(
    dmac_alg_nbfh_start_notify_enum_uint8 en_notify_sub_type,
    p_alg_nbfh_start_notify_func p_func);
extern oal_uint32  dmac_alg_nbfh_start_notify_ram(mac_vap_stru *pst_mac_vap);
extern oal_uint32  dmac_alg_unregister_nbfh_start_notify_func_ram(
        dmac_alg_nbfh_start_notify_enum_uint8 en_notify_sub_type);
...
extern oal_uint32  dmac_alg_unregister_nbfh_stop_notify_func_ram(
    dmac_alg_nbfh_stop_notify_enum_uint8 en_notify_sub_type);
...
extern oal_uint32  dmac_alg_unregister_nbfh_sync_notify_func_ram(
    dmac_alg_nbfh_sync_notify_enum_uint8 en_notify_sub_type);
#endif
