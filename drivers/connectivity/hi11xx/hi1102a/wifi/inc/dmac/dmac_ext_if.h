...
/* :修改创建BA 需要先发10 个帧，规避P2P 6.1.12 认证用例由于执行机执行时间长，协议栈发送ARP 帧使得认证失败问题 */
...
typedef enum {
    ...
    DMAC_WLAN_CRX_EVENT_SUB_TYPE_HID2D_CHAN_MEAS_RESULT,
...
struct mac_tx_ctl {
    ...
    oal_uint8 bit_change_level_rsp; /* 速率自适应用，标记是change_level_rsp帧 */
    oal_uint8 auc_resv[2];
