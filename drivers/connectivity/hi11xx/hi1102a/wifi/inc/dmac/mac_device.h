...
extern oal_uint32 mac_fcs_init(mac_fcs_mgr_stru *pst_fcs_mgr, oal_uint8 uc_chip_id, oal_uint8 uc_device_id);
...
extern mac_fcs_err_enum_uint8 mac_fcs_start(mac_fcs_mgr_stru *pst_fcs_mgr, mac_fcs_cfg_stru *pst_fcs_cfg,
    hal_one_packet_status_stru *pst_status, oal_uint8 uc_fake_tx_q_id);
extern oal_void mac_fcs_set_one_pkt_timeout_time(mac_fcs_mgr_stru *pst_fcs_mgr);

#ifdef _PRE_WLAN_FEATURE_NBFH
extern  mac_fcs_err_enum_uint8 dmac_fcs_start_nb(mac_fcs_mgr_stru *pst_fcs_mgr, mac_fcs_cfg_stru *pst_fcs_cfg,
...
extern oal_uint32 mac_fcs_notify(mac_fcs_mgr_stru *pst_fcs_mgr, mac_fcs_notify_type_enum_uint8 uc_notify_type);
