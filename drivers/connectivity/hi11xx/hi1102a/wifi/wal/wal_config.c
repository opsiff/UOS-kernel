...
OAL_STATIC oal_uint32 wal_config_mac_addr_write(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_mac_addr_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_pdet_val_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_tsensor_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_power_param_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);

#ifdef _PRE_WLAN_NARROW_BAND
OAL_STATIC oal_uint32 wal_config_autorate_level_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_autorate_cfg_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_autorate_param(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_nokey_mode_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
OAL_STATIC oal_uint32 wal_config_hitalk_key_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
#endif
...
OAL_STATIC OAL_CONST wal_wid_op_stru g_ast_board_wid_op[] = {
    ...
    { WLAN_CFGID_MAC_ADDR_WRITE, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_mac_addr_write },
    { WLAN_CFGID_MAC_ADDR_READ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_mac_addr_read },
    { WLAN_CFGID_PDET_VAL_READ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_pdet_val_read },
    { WLAN_CFGID_TSENSOR_READ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_tsensor_read },
    { WLAN_CFGID_POWER_PARAM_READ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_power_param_read },
#ifdef _PRE_WLAN_NARROW_BAND
    { WLAN_CFGID_NB_REPORT_INFO_READ, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_autorate_level_read },
    { WLAN_CFGID_AUTORATE_CFG_SET, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_autorate_cfg_set },
    { WLAN_CFGID_AUTORATE_PARAM, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_autorate_param },
    { WLAN_CFGID_NOKEY_MODE_SET, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_nokey_mode_set },
    { WLAN_CFGID_KEY_INFO_RPT, OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_hitalk_key_set },
#endif
...
OAL_STATIC oal_uint32 wal_config_pdet_val_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_pdet_val_read(mac_vap, len, param);
}


OAL_STATIC oal_uint32 wal_config_tsensor_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_tsensor_read(mac_vap, len, param);
}


OAL_STATIC oal_uint32 wal_config_power_param_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_power_param_read(mac_vap, len, param);
}
...
OAL_STATIC oal_uint32 wal_config_autorate_level_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_autorate_level_read(mac_vap, len, param);
}


OAL_STATIC oal_uint32 wal_config_autorate_cfg_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_autorate_cfg_set(mac_vap, len, param);
}
OAL_STATIC oal_uint32 wal_config_autorate_param(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_autorate_param(mac_vap, len, param);
}


OAL_STATIC oal_uint32 wal_config_nokey_mode_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_nokey_mode_set(mac_vap, len, param);
}


OAL_STATIC oal_uint32 wal_config_hitalk_key_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    return hmac_config_hitalk_key_set(mac_vap, len, param);
}
#endif
