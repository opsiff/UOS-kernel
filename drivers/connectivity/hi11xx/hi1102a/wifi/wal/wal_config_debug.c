...
OAL_STATIC oal_uint32 wal_config_set_distance(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ul_ret;

    if (oal_unlikely((mac_vap == NULL) || (param == NULL))) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_config_set_distance::pst_mac_vap/puc_param is null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(mac_vap, WLAN_CFGID_SET_DISTANCE, len, param);
    if (oal_unlikely(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_set_distance::send_event failed[%d]}",
                         ul_ret);
    }

    return OAL_SUCC;
}
OAL_STATIC oal_uint32 wal_config_set_power_param(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ul_ret;

    if (oal_unlikely((mac_vap == NULL) || (param == NULL))) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_config_set_power_param::mac_vap/param is null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(mac_vap, WLAN_CFGID_SET_POWER_PARAM, len, param);
    if (oal_unlikely(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_set_power_param::send_event failed[%d]}",
                         ul_ret);
    }

    return OAL_SUCC;
}
OAL_STATIC oal_uint32 wal_config_set_vendor_channel(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param)
{
    oal_uint32 ul_ret;

    if (oal_unlikely((mac_vap == NULL) || (param == NULL))) {
        oam_warning_log0(0, OAM_SF_ANY, "{wal_config_set_vendor_channel::mac_vap/param is null ptr!}\r\n");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /***************************************************************************
        抛事件到DMAC层, 同步DMAC数据
    ***************************************************************************/
    ul_ret = hmac_config_send_event(mac_vap, WLAN_CFGID_SET_VENDOR_CHANNEL, len, param);
    if (oal_unlikely(ul_ret != OAL_SUCC)) {
        OAM_WARNING_LOG1(mac_vap->uc_vap_id, OAM_SF_CFG, "{wal_config_set_vendor_channel::send_event failed[%d]}",
                         ul_ret);
    }
...
OAL_CONST wal_wid_op_stru g_ast_board_wid_op_debug[] = {
    ...
    { WLAN_CFGID_SET_DISTANCE,  OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_distance },
    { WLAN_CFGID_SET_POWER_PARAM,  OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_power_param },
    { WLAN_CFGID_SET_VENDOR_CHANNEL,  OAL_FALSE, { 0 }, OAL_PTR_NULL, wal_config_set_vendor_channel },
#endif
