...
oal_uint8 g_narrow_bw = NARROW_BW_BUTT;
...
oal_uint32 wal_hipriv_narrow_bw(oal_net_device_stru *pst_net_dev, oal_int8 *pc_param)
{
    ...
    ***************************************************************************/
    ...
    if (pst_nrw_bw->en_open == OAL_TRUE) {
        ...
        wal_hipriv_alg_cfg(pst_net_dev, "cca_opt_alg_en_mode 0");
        wal_hipriv_alg_cfg(pst_net_dev, "ar_enable 0");
        wal_hipriv_set_ucast_data_dscr_param(pst_net_dev, "data0 4915729");
        wal_hipriv_set_ucast_data_dscr_param(pst_net_dev, "data0 4915729");
        ...
        wal_hipriv_alg_cfg(pst_net_dev, "cca_opt_alg_en_mode 2");
        wal_hipriv_alg_cfg(pst_net_dev, "ar_enable 1");
...
oal_uint32 wal_hipriv_set_distance(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 l_ret;
    mac_cfg_distance_stru *cfg_distance;
    oal_uint32 ul_ret;
    oal_uint32 off_set;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    if (oal_unlikely((net_dev == OAL_PTR_NULL) || (param == OAL_PTR_NULL))) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_set_distance: input pointer is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /***************************************************************************
                                抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_SET_DISTANCE, OAL_SIZEOF(mac_cfg_distance_stru));

    /* 解析并设置配置命令参数 */
    cfg_distance = (mac_cfg_distance_stru *)(write_msg.auc_value);

    ul_ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_distance::get distance  [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    param = param + off_set;

    cfg_distance->distance = (oal_uint8)oal_atoi(ac_arg);

    ul_ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_distance::get bw  [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    param = param + off_set;

    if (0 == (strcmp("1m", ac_arg))) {
        cfg_distance->en_bw = NARROW_BW_1M; /* 窄带1M带宽 */
    } else if (0 == (strcmp("5m", ac_arg))) {
        cfg_distance->en_bw = NARROW_BW_5M; /* 窄带5M带宽 */
    } else if (0 == (strcmp("10m", ac_arg))) {
        cfg_distance->en_bw = NARROW_BW_10M; /* 窄带10M带宽 */
    } else {
        cfg_distance->en_bw = NARROW_BW_BUTT;
        oam_warning_log0(0, OAM_SF_ANY, "{wal_hipriv_set_distance::bw should be 1/5/10 m");
        return OAL_ERR_CODE_INVALID_CONFIG;
    }

    l_ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
                               WAL_MSG_WRITE_MSG_HDR_LENGTH + OAL_SIZEOF(mac_cfg_distance_stru),
                               (oal_uint8 *)&write_msg,
                               OAL_FALSE,
                               OAL_PTR_NULL);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
...
oal_uint32 wal_hipriv_set_power_param(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 l_ret;
    ...
    /* 入参合法判断 */
    if (oal_unlikely((net_dev == OAL_PTR_NULL) || (param == OAL_PTR_NULL))) {
        OAM_ERROR_LOG0(0, OAM_SF_ANY, "{wal_hipriv_set_power_param: input pointer is null!}");
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /***************************************************************************
                                抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_SET_POWER_PARAM, OAL_SIZEOF(mac_cfg_power_param_stru));
    ...
    ul_ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_power_param::get type  [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    param = param + off_set;
    if ((strcmp("upc", ac_arg)) == 0) {
        cfg_power->type = POWER_PARAM_UPC; /* 修改UPC */
    } else if ((strcmp("lpf", ac_arg)) == 0) {
        cfg_power->type = POWER_PARAM_LPF; /* 修改LPF */
    } else if ((strcmp("dbb", ac_arg)) == 0) {
        cfg_power->type = POWER_PARAM_DBB; /* 修改DBB */
    } else {
        cfg_power->type = POWER_PARAM_BUTT;
        oam_warning_log0(0, OAM_SF_ANY, "{wal_hipriv_set_power_param::type should be upc/lpf/dbb !");
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
    ...
    ul_ret = wal_get_cmd_one_arg(param, ac_arg, OAL_SIZEOF(ac_arg), &off_set);
    if (ul_ret != OAL_SUCC) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_power_param::get value [%d]!}\r\n", ul_ret);
        return ul_ret;
    }
    param = param + off_set;

    cfg_power->value = (oal_uint8)oal_atoi(ac_arg);
...
oal_uint32 wal_hipriv_set_vendor_channel(oal_net_device_stru *net_dev, oal_int8 *param)
{
    wal_msg_write_stru write_msg;
    oal_int32 l_ret;
    mac_cfg_vendor_channel_stru *cfg_vendor_channel = NULL;
    oal_uint32 ul_ret;
    oal_uint32 off_set;
    oal_int8 ac_arg[WAL_HIPRIV_CMD_NAME_MAX_LEN];
    ...
    /***************************************************************************
                                抛事件到wal层处理
    ***************************************************************************/
    wal_write_msg_hdr_init(&write_msg, WLAN_CFGID_SET_VENDOR_CHANNEL, OAL_SIZEOF(mac_cfg_distance_stru));

    /* 解析并设置配置命令参数 */
    cfg_vendor_channel = (mac_cfg_vendor_channel_stru *)(write_msg.auc_value);
    ...
    cfg_vendor_channel->vendor_channel = (oal_uint8)oal_atoi(ac_arg);
    if (cfg_vendor_channel->vendor_channel > 1) {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{wal_hipriv_set_power_param::invalid vendor_channel[%d]!}\r\n",
            cfg_vendor_channel->vendor_channel);
        return OAL_FAIL;
    }
    l_ret = wal_send_cfg_event(net_dev,
                               WAL_MSG_TYPE_WRITE,
...
OAL_STATIC uint32_t wal_hipriv_get_tid_queue_info(oal_net_device_stru *net_dev, int8_t *param)
{
...
OAL_CONST wal_hipriv_cmd_entry_stru  g_ast_hipriv_cmd_debug[] = {
    ...
    {"distance",                 wal_hipriv_set_distance},             /* 设置距离优化参数 */
    {"power_param",              wal_hipriv_set_power_param},          /* 设置功率优化参数 */
    {"vendor_channel",           wal_hipriv_set_vendor_channel},       /* 设置私有信道 */
#endif
#ifdef _PRE_WLAN_TCP_OPT
