...
#endif
extern struct nb_globals g_nb_handler_data;
/*****************************************************************************
  5 消息头定义
*****************************************************************************/
/*****************************************************************************
...
typedef struct
{
    oal_int32  uc_pdet_val_i_mv;
    oal_int32  uc_pdet_val_q_mv;
    oal_int32  uc_pdet_val_i_db;
    oal_int32  uc_pdet_val_q_db;
}hmac_dyn_cali_vdet_val_stru;
...
extern oal_uint32 hmac_config_mac_addr_write(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_mac_addr_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_report_mac_addr(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
extern oal_uint32 hmac_config_pdet_val_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_pdet_val_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
extern oal_uint32 hmac_config_tsensor_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_tsensor_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
extern oal_uint32 hmac_config_power_param_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_power_param_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
extern oal_uint32 hmac_config_reg_info_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
#ifdef _PRE_WLAN_NARROW_BAND
extern oal_uint32 hmac_config_autorate_level_read(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_autorate_level_report(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
extern oal_uint32 hmac_config_autorate_cfg_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_autorate_param(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_nokey_mode_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_hitalk_key_set(mac_vap_stru *mac_vap, oal_uint16 len, oal_uint8 *param);
extern oal_uint32 hmac_config_hitalk_key_rpt(mac_vap_stru *mac_vap, oal_uint8 len, oal_uint8 *param);
#endif
...
extern oal_uint32 hmac_config_query_tid_queue(mac_vap_stru *pst_mac_vap, oal_uint16 us_len, oal_uint8 *puc_param);
#ifdef _PRE_WLAN_DFT_STAT
...
extern oal_int32 nb_netlink_send(oal_uint8 *data, oal_int data_len);
#ifdef __cplusplus
#if __cplusplus
}
#endif
