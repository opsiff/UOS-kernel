 ...
 *
 * Description: oal_net.c header file
...
/* 由于内核注册端口28 NETLINK_HISI_WIFI_MSG已被占用，所以此处使用未使用的27 NETLINK_HISI_WIFI_PMF */
#ifdef NETLINK_WIFI_DFR_HISI // Hisi WiFi Declare the netlink_pid
...
#define ICMPV6_ND_RADVT 134 /* Router Advertisement */
#define ICMPV6_ND_NSOL  135 /* Neighbor Solicitation */
#define ICMPV6_ND_NADVT 136 /* Neighbor Advertisement */
#define ICMPV6_ND_RMES  137 /* Redirect Message */
...
/*
 * wal 层到hmac侧传递使用该数据，mp13 WLAN_WPS_IE_MAX_SIZE扩容到608字节，超过事件队列大小，
