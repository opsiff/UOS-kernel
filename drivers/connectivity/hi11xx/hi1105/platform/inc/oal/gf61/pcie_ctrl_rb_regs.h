 ...
 *
 * Description: gf61 pcie ctrl rb regs
 * Author: @CompanyNameTag
 */

#ifndef PCIE_CTRL_RB_REGS_H
#define PCIE_CTRL_RB_REGS_H
...
#define GT_HOST2DEVICE_INTR_SET_OFF    0x650
#define GT_HOST2DEVICE_INTR_SET_REG \
    (PCIE_CTRL_RB_BASE + GT_HOST2DEVICE_INTR_SET_OFF)
...
typedef union {
    struct {
        ...
        unsigned int device2host_rx_intr_raw_status : 1; /* 3 */
        unsigned int device2host_intr_raw_status : 1; /* 4 */
        unsigned int reserved0 : 27; /* 10:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_raw_status;
#define GT_HOST_INTR_RAW_STATUS_OFF    0x654
#define GT_HOST_INTR_RAW_STATUS_REG \
    (PCIE_CTRL_RB_BASE + GT_HOST_INTR_RAW_STATUS_OFF)
...
typedef union {
    struct {
        ...
        unsigned int device2host_rx_intr_mask : 1; /* 3 */
        unsigned int device2host_intr_mask : 1; /* 4 */
        unsigned int host_ete_rx_intr_mask : 1; /* 5 */
        unsigned int host_ete_tx_intr_mask : 1; /* 6 */
        unsigned int rx_ch_dr_empty_intr_mask : 1; /* 7 */
        unsigned int tx_ch_dr_empty_intr_mask : 1; /* 8 */
        unsigned int reserved0 : 23; /* 10:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_mask;
#define GT_HOST_INTR_MASK_OFF    0x658
#define GT_HOST_INTR_MASK_REG \
    (PCIE_CTRL_RB_BASE + GT_HOST_INTR_MASK_OFF)
...
typedef union {
    struct {
        ...
        unsigned int device2host_rx_intr_status : 1; /* 3 */
        unsigned int device2host_intr_status : 1; /* 4 */
        unsigned int host_ete_rx_intr_status : 1; /* 5 */
        unsigned int host_ete_tx_intr_status : 1; /* 6 */
        unsigned int rx_ch_dr_empty_intr_status : 1; /* 7 */
        unsigned int tx_ch_dr_empty_intr_status : 1; /* 8 */
        unsigned int reserved0 : 23; /* 10:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_status;
#define GT_HOST_INTR_STATUS_OFF    0x65C
#define GT_HOST_INTR_STATUS_REG \
    (PCIE_CTRL_RB_BASE + GT_HOST_INTR_STATUS_OFF)
...
#define GT_HOST_INTR_CLR_OFF    0x660
#define GT_HOST_INTR_CLR_REG \
    (PCIE_CTRL_RB_BASE + GT_HOST_INTR_CLR_OFF)
