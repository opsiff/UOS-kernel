 ...
 *
 * Description: gf61 host ctrl rb regs
 * Author: @CompanyNameTag
 */

#ifndef HOST_CTRL_RB_REGS_H
#define HOST_CTRL_RB_REGS_H

/* This file is generated automatically. Do not modify it */

#define HOST_CTRL_RB_BASE    (0x4010D000)
...
typedef union {
    struct {
        unsigned int soc_clkreq_sel : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_clkreq_in_delay_sel;
#define HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_SEL_OFF    0xE38
#define HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_SEL_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_SEL_OFF)

/*  0xE3C */
typedef union {
    struct {
        unsigned int soc_clkreq_delay_cnt : 20; /* 0:19 */
        unsigned int reserved0 : 12; /* 20:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_clkreq_in_delay_ctl;
#define HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_CTL_OFF    0xE3C
#define HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_CTL_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CLKREQ_IN_DELAY_CTL_OFF)

/*  0xE40 */
typedef union {
    struct {
        unsigned int soc_l1sub_rb_disable_ctl : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_l1sub_rb_disable_ctl;
#define HOST_CTRL_RB_PCIE_L1SUB_RB_DISABLE_CTL_OFF    0xE40
#define HOST_CTRL_RB_PCIE_L1SUB_RB_DISABLE_CTL_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_L1SUB_RB_DISABLE_CTL_OFF)
...
typedef union {
    struct {
        unsigned int host_axi_mstr_rs_cg_sel : 1; /* 0 */
        unsigned int reserved0 : 3; /* 1:3 */
        unsigned int host_axi_slv_rs_cg_sel : 1; /* 4 */
        unsigned int reserved1 : 27; /* 5:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_host_axi_rs_cg_ctl;
#define HOST_CTRL_RB_PCIE_HOST_AXI_RS_CG_CTL_OFF    0xE80
#define HOST_CTRL_RB_PCIE_HOST_AXI_RS_CG_CTL_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_HOST_AXI_RS_CG_CTL_OFF)

/* MAC寄存器地址0 0xE84 */
typedef union {
    struct {
        unsigned int addr_l_0 : 16; /* 0:15 */
        unsigned int addr_l_1 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l0;
#define HOST_CTRL_RB_MAC_ADDR_L0_OFF    0xE84
#define HOST_CTRL_RB_MAC_ADDR_L0_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L0_OFF)

/* MAC寄存器地址1 0xE88 */
typedef union {
    struct {
        unsigned int addr_l_2 : 16; /* 0:15 */
        unsigned int addr_l_3 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l1;
#define HOST_CTRL_RB_MAC_ADDR_L1_OFF    0xE88
#define HOST_CTRL_RB_MAC_ADDR_L1_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L1_OFF)

/* MAC寄存器地址2 0xE8C */
typedef union {
    struct {
        unsigned int addr_l_4 : 16; /* 0:15 */
        unsigned int addr_l_5 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l2;
#define HOST_CTRL_RB_MAC_ADDR_L2_OFF    0xE8C
#define HOST_CTRL_RB_MAC_ADDR_L2_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L2_OFF)

/* MAC寄存器地址3 0xE90 */
typedef union {
    struct {
        unsigned int addr_l_6 : 16; /* 0:15 */
        unsigned int addr_l_7 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l3;
#define HOST_CTRL_RB_MAC_ADDR_L3_OFF    0xE90
#define HOST_CTRL_RB_MAC_ADDR_L3_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L3_OFF)

/* MAC寄存器地址4 0xE94 */
typedef union {
    struct {
        unsigned int addr_l_8 : 16; /* 0:15 */
        unsigned int addr_l_9 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l4;
#define HOST_CTRL_RB_MAC_ADDR_L4_OFF    0xE94
#define HOST_CTRL_RB_MAC_ADDR_L4_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L4_OFF)

/* MAC寄存器地址5 0xE98 */
typedef union {
    struct {
        unsigned int addr_l_a : 16; /* 0:15 */
        unsigned int addr_l_b : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_l5;
#define HOST_CTRL_RB_MAC_ADDR_L5_OFF    0xE98
#define HOST_CTRL_RB_MAC_ADDR_L5_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_L5_OFF)

/* MAC寄存器地址6 0xE9C */
typedef union {
    struct {
        unsigned int addr_h_0 : 16; /* 0:15 */
        unsigned int addr_h_1 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_h0;
#define HOST_CTRL_RB_MAC_ADDR_H0_OFF    0xE9C
#define HOST_CTRL_RB_MAC_ADDR_H0_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_H0_OFF)

/* MAC寄存器地址7 0xEA0 */
typedef union {
    struct {
        unsigned int addr_h_2 : 16; /* 0:15 */
        unsigned int addr_h_3 : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_h1;
#define HOST_CTRL_RB_MAC_ADDR_H1_OFF    0xEA0
#define HOST_CTRL_RB_MAC_ADDR_H1_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_H1_OFF)

/* MAC寄存器地址8 0xEA4 */
typedef union {
    struct {
        unsigned int addr_l_res : 16; /* 0:15 */
        unsigned int addr_h_res : 16; /* 16:31 */
    } bits;
    unsigned int as_dword;
} hreg_mac_addr_res;
#define HOST_CTRL_RB_MAC_ADDR_RES_OFF    0xEA4
#define HOST_CTRL_RB_MAC_ADDR_RES_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_MAC_ADDR_RES_OFF)

/* HOST_TRIGER_DEVIE_REG_0 0xEA8 */
typedef union {
    struct {
        unsigned int host_trigger_device_reg_0 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_trigger_devie_reg_0;
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_0_OFF    0xEA8
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_0_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_0_OFF)

/* HOST_TRIGER_DEVIE_REG_1 0xEAC */
typedef union {
    struct {
        unsigned int host_trigger_device_reg_1 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_trigger_devie_reg_1;
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_1_OFF    0xEAC
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_1_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_TRIGGER_DEVIE_REG_1_OFF)

/* HOST_TRIGGER_DEVIE_INTR_MASK 0xEB0 */
typedef union {
    struct {
        unsigned int host_trigger_device_intr_mask : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_trigger_devie_intr_mask;
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_MASK_OFF    0xEB0
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_MASK_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_MASK_OFF)

/* HOST_TRIGGER_DEVIE_INTR_CLR 0xEB4 */
typedef union {
    struct {
        unsigned int host_trigger_device_intr_clr : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_trigger_devie_intr_clr;
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_CLR_OFF    0xEB4
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_CLR_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_TRIGGER_DEVIE_INTR_CLR_OFF)

/* HOST_TRIGGER_DEVIE__INTR_STS 0xEB8 */
typedef union {
    struct {
        unsigned int host_trigger_device_intr_status : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_host_trigger_devie__intr_sts;
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE__INTR_STS_OFF    0xEB8
#define HOST_CTRL_RB_HOST_TRIGGER_DEVIE__INTR_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_HOST_TRIGGER_DEVIE__INTR_STS_OFF)
...
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_MASK_OFF    0xF00
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_MASK_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTL_ETE_INTR_MASK_OFF)

/*  0xF04 */
typedef union {
    struct {
        unsigned int host_tx_err_intr_clear : 5; /* 0:4 */
        unsigned int reserved0 : 3; /* 5:7 */
        unsigned int host_tx_done_intr_clear : 5; /* 8:12 */
        unsigned int reserved1 : 3; /* 13:15 */
        unsigned int host_rx_err_intr_clear : 6; /* 16:21 */
        unsigned int reserved2 : 2; /* 22:23 */
        unsigned int host_rx_done_intr_clear : 6; /* 24:29 */
        unsigned int reserved3 : 2; /* 30:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_ctl_ete_intr_clr;
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_CLR_OFF    0xF04
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_CLR_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTL_ETE_INTR_CLR_OFF)
...
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_STS_OFF    0xF08
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTL_ETE_INTR_STS_OFF)
...
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_RAW_STS_OFF    0xF10
#define HOST_CTRL_RB_PCIE_CTL_ETE_INTR_RAW_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTL_ETE_INTR_RAW_STS_OFF)

/* TX中断上报延迟 0xF14 */
typedef union {
    struct {
        unsigned int host_rx_done_intr_delay_cnt : 16; /* 0:15 */
        unsigned int host_rx_intr_delay_sel : 1; /* 16 */
        unsigned int reserved0 : 15; /* 17:31 */
    } bits;
    unsigned int as_dword;
} hreg_rx_host_int_delay;
#define HOST_CTRL_RB_RX_HOST_INT_DELAY_OFF    0xF14
#define HOST_CTRL_RB_RX_HOST_INT_DELAY_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_RX_HOST_INT_DELAY_OFF)

/* TX中断上报延迟 0xF18 */
typedef union {
    struct {
        unsigned int host_tx_done_intr_delay_cnt : 16; /* 0:15 */
        unsigned int host_tx_intr_delay_sel : 1; /* 16 */
        unsigned int reserved0 : 15; /* 17:31 */
    } bits;
    unsigned int as_dword;
} hreg_tx_host_int_delay;
#define HOST_CTRL_RB_TX_HOST_INT_DELAY_OFF    0xF18
#define HOST_CTRL_RB_TX_HOST_INT_DELAY_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_TX_HOST_INT_DELAY_OFF)
...
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_MASK_OFF    0xF20
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_MASK_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_MASK_OFF)

/*  0xF24 */
typedef union {
    struct {
        unsigned int host_tx_ch_dr_empty_intr_clear : 4; /* 0:3 */
        unsigned int host_rx_ch_dr_empty_intr_clear : 6; /* 4:9 */
        unsigned int reserved0 : 22; /* 10:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_ctrl_ete_ch_dr_empty_intr_clr;
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_CLR_OFF    0xF24
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_CLR_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_CLR_OFF)
...
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_STS_OFF    0xF28
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_STS_OFF)
...
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_RAW_STS_OFF    0xF2C
#define HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_RAW_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_PCIE_CTRL_ETE_CH_DR_EMPTY_INTR_RAW_STS_OFF)

/*  0xF30 */
typedef union {
    struct {
        unsigned int fifo_err_sts_comb_mask : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_fifo_err_sts_comb_mask;
#define HOST_CTRL_RB_FIFO_ERR_STS_COMB_MASK_OFF    0xF30
#define HOST_CTRL_RB_FIFO_ERR_STS_COMB_MASK_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_FIFO_ERR_STS_COMB_MASK_OFF)

/*  0xF34 */
typedef union {
    struct {
        unsigned int fifo_err_sts_comb_clr : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_fifo_err_sts_comb_clr;
#define HOST_CTRL_RB_FIFO_ERR_STS_COMB_CLR_OFF    0xF34
#define HOST_CTRL_RB_FIFO_ERR_STS_COMB_CLR_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_FIFO_ERR_STS_COMB_CLR_OFF)

/*  0xF38 */
typedef union {
    struct {
        unsigned int soc_fifo_mask_0 : 32; /* 0:31 */
    } bits;
    unsigned int as_dword;
} hreg_fifo_err_sts_mask_0;
#define HOST_CTRL_RB_FIFO_ERR_STS_MASK_0_OFF    0xF38
#define HOST_CTRL_RB_FIFO_ERR_STS_MASK_0_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_FIFO_ERR_STS_MASK_0_OFF)

/*  0xF3C */
typedef union {
    struct {
        unsigned int soc_fifo_mask_1 : 22; /* 0:21 */
        unsigned int reserved0 : 10; /* 22:31 */
    } bits;
    unsigned int as_dword;
} hreg_fifo_err_sts_mask_1;
#define HOST_CTRL_RB_FIFO_ERR_STS_MASK_1_OFF    0xF3C
#define HOST_CTRL_RB_FIFO_ERR_STS_MASK_1_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_FIFO_ERR_STS_MASK_1_OFF)

/*  0xF40 */
typedef union {
    struct {
        unsigned int rch1_cnt_err_check_length_start : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_rch1_cnt_err_check_length_start;
#define HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_START_OFF    0xF40
#define HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_START_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_START_OFF)

/*  0xF44 */
typedef union {
    struct {
        unsigned int rch1_cnt_err_check_length_end : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_rch1_cnt_err_check_length_end;
#define HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_END_OFF    0xF44
#define HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_END_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_RCH1_CNT_ERR_CHECK_LENGTH_END_OFF)

/*  0xF48 */
typedef union {
    struct {
        unsigned int rch2_cnt_err_check_length_start : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_rch2_cnt_err_check_length_start;
#define HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_START_OFF    0xF48
#define HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_START_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_START_OFF)

/*  0xF4C */
typedef union {
    struct {
        unsigned int rch2_cnt_err_check_length_end : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_rch2_cnt_err_check_length_end;
#define HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_END_OFF    0xF4C
#define HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_END_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_RCH2_CNT_ERR_CHECK_LENGTH_END_OFF)

/*  0xF50 */
typedef union {
    struct {
        unsigned int wch0_cnt_err_check_length_start : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_wch0_cnt_err_check_length_start;
#define HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_START_OFF    0xF50
#define HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_START_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_START_OFF)

/*  0xF54 */
typedef union {
    struct {
        unsigned int wch0_cnt_err_check_length_end : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_wch0_cnt_err_check_length_end;
#define HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_END_OFF    0xF54
#define HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_END_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_WCH0_CNT_ERR_CHECK_LENGTH_END_OFF)

/*  0xF58 */
typedef union {
    struct {
        unsigned int wch1_cnt_err_check_length_start : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_wch1_cnt_err_check_length_start;
#define HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_START_OFF    0xF58
#define HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_START_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_START_OFF)

/*  0xF5C */
typedef union {
    struct {
        unsigned int wch1_cnt_err_check_length_end : 11; /* 0:10 */
        unsigned int reserved0 : 21; /* 11:31 */
    } bits;
    unsigned int as_dword;
} hreg_wch1_cnt_err_check_length_end;
#define HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_END_OFF    0xF5C
#define HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_END_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_WCH1_CNT_ERR_CHECK_LENGTH_END_OFF)

/*  0xF60 */
typedef union {
    struct {
        unsigned int wch0_cnt_err_check_en : 1; /* 0 */
        unsigned int wch1_cnt_err_check_en : 1; /* 1 */
        unsigned int rch1_cnt_err_check_en : 1; /* 2 */
        unsigned int rch2_cnt_err_check_en : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_err_check_en;
#define HOST_CTRL_RB_ERR_CHECK_EN_OFF    0xF60
#define HOST_CTRL_RB_ERR_CHECK_EN_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_ERR_CHECK_EN_OFF)

/*  0xF64 */
typedef union {
    struct {
        unsigned int wch0_cnt_err_check_sts_clr : 1; /* 0 */
        unsigned int wch1_cnt_err_check_sts_clr : 1; /* 1 */
        unsigned int rch1_cnt_err_check_sts_clr : 1; /* 2 */
        unsigned int rch2_cnt_err_check_sts_clr : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_err_check_sts_clr;
#define HOST_CTRL_RB_ERR_CHECK_STS_CLR_OFF    0xF64
#define HOST_CTRL_RB_ERR_CHECK_STS_CLR_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_ERR_CHECK_STS_CLR_OFF)

/*  0xF68 */
typedef union {
    struct {
        unsigned int wch0_cnt_err_check_sts : 1; /* 0 */
        unsigned int wch1_cnt_err_check_sts : 1; /* 1 */
        unsigned int rch1_cnt_err_check_sts : 1; /* 2 */
        unsigned int rch2_cnt_err_check_sts : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_err_check_sts;
#define HOST_CTRL_RB_ERR_CHECK_STS_OFF    0xF68
#define HOST_CTRL_RB_ERR_CHECK_STS_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_ERR_CHECK_STS_OFF)
