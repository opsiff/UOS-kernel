 ...
 *
 * Description: oal_types.h header file
 * Author: @CompanyNameTag
 */

#ifndef OAL_SCHEDULE_H
#define OAL_SCHEDULE_H
...
#define oal_time_get_runtime_us(_ul_start, _ul_end) \
    (((_ul_start) > (_ul_end)) ? (oal_time_calc_runtime_us((_ul_start), (_ul_end))) : ((_ul_end) - (_ul_start)))
...
#endif
    strcpy_s(pst_wakelock->name, sizeof(pst_wakelock->name), name);
    oal_wakeup_source_init(&pst_wakelock->st_wakelock, pst_wakelock->name);
