 ...
 *
 * Description: oal_hcc_comm.c header file
 * Author: @CompanyNameTag
 */

#ifndef OAL_HCC_COMM_H
#define OAL_HCC_COMM_H
...
#define HCC_RESERVED_LEN         36 /* 临时定义宏!后续代码上库后改为使用MAC_CB_FRM_OFFSET */
