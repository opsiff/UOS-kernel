 ...
 *
 * Description: host_ctrl_rb_regs.h header file
 * Author: @CompanyNameTag
 */

#ifndef MP16C_HOST_CTRL_RB_REGS_H
#define MP16C_HOST_CTRL_RB_REGS_H
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_SDIO_OFF    0xE20
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_SDIO_OFF    0xE24
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG0_AON_OFF    0xE28
...
#define HOST_CTRL_RB_PCIE_SLV_ADDR_CFG1_AON_OFF    0xE2C
...
typedef union {
    struct {
        unsigned int soc_fifo_err_clr_clken : 1; /* 0 */
        unsigned int reserved0 : 31; /* 1:31 */
    } bits;
    unsigned int as_dword;
} hreg_fifo_err_clr_clken;
#define HOST_CTRL_RB_FIFO_ERR_CLR_CLKEN_OFF    0xF70
#define HOST_CTRL_RB_FIFO_ERR_CLR_CLKEN_REG \
    (HOST_CTRL_RB_BASE + HOST_CTRL_RB_FIFO_ERR_CLR_CLKEN_OFF)
