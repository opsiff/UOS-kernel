...
#ifndef MP16C_PCIE_CTRL_RB_REGS_H
#define MP16C_PCIE_CTRL_RB_REGS_H
...
typedef union {
    struct {
        ...
        unsigned int reserved1 : 23; /* 9:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_status1;
...
typedef union {
    struct {
        unsigned int soc_radm_fatal_err : 1; /* 0 */
        unsigned int soc_radm_nonfatal_err : 1; /* 1 */
        unsigned int soc_radm_correctable_err : 1; /* 2 */
        unsigned int soc_radm_qoverflow : 1; /* 3 */
...
typedef union {
    struct {
        unsigned int soc_radm_fatal_err_status : 1; /* 0 */
        unsigned int soc_radm_nonfatal_err_status : 1; /* 1 */
        unsigned int soc_radm_correctable_err_status : 1; /* 2 */
        unsigned int soc_radm_qoverflow_status : 1; /* 3 */
...
typedef union {
    struct {
        unsigned int soc_radm_fatal_err_clr : 1; /* 0 */
        unsigned int soc_radm_nonfatal_err_clr : 1; /* 1 */
        unsigned int soc_radm_correctable_err_clr : 1; /* 2 */
        unsigned int soc_radm_qoverflow_clr : 1; /* 3 */
...
typedef union {
    struct {
        unsigned int soc_radm_fatal_err_mask : 1; /* 0 */
        unsigned int soc_radm_nonfatal_err_mask : 1; /* 1 */
        unsigned int soc_radm_correctable_err_mask : 1; /* 2 */
        unsigned int soc_radm_qoverflow_mask : 1; /* 3 */
...
typedef union {
    struct {
        ...
        unsigned int reserved0 : 9; /* 11:19 */
        unsigned int host_ete_rx_intr_status : 1; /* 20 */
        unsigned int host_ete_tx_intr_status : 1; /* 21 */
        unsigned int sync_rx_ch_dr_empty_intr_status : 1; /* 22 */
        unsigned int sync_tx_ch_dr_empty_intr_status : 1; /* 23 */
        unsigned int reserved1 : 8; /* 24:31 */
    } bits;
    unsigned int as_dword;
...
typedef union {
    struct {
        unsigned int dbi_clk_en_sel : 1; /* 0 */
        unsigned int reserved0 : 3; /* 1:3 */
        unsigned int dbi_clk_en_manual : 1; /* 4 */
        unsigned int reserved1 : 27; /* 5:31 */
    } bits;
    unsigned int as_dword;
} hreg_pcie_dbi_apb_cg_ctl;
#define PCIE_CTRL_RB_PCIE_DBI_APB_CG_CTL_OFF    0x63C
#define PCIE_CTRL_RB_PCIE_DBI_APB_CG_CTL_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_PCIE_DBI_APB_CG_CTL_OFF)
...
typedef union {
    struct {
        unsigned int gt_host2device_tx_intr_set : 1; /* 0 */
        unsigned int gt_host2device_rx_intr_set : 1; /* 1 */
        unsigned int gt_device2host_tx_intr_set : 1; /* 2 */
        unsigned int gt_device2host_rx_intr_set : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host2device_intr_set;
#define PCIE_CTRL_RB_GT_HOST2DEVICE_INTR_SET_OFF    0x650
#define PCIE_CTRL_RB_GT_HOST2DEVICE_INTR_SET_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_GT_HOST2DEVICE_INTR_SET_OFF)

/* PCIE屏蔽前中断上报 0x654 */
typedef union {
    struct {
        unsigned int gt_host2device_tx_intr_raw_status : 1; /* 0 */
        unsigned int gt_host2device_rx_intr_raw_status : 1; /* 1 */
        unsigned int gt_device2host_tx_intr_raw_status : 1; /* 2 */
        unsigned int gt_device2host_rx_intr_raw_status : 1; /* 3 */
        unsigned int gt_device2host_intr_raw_status : 1; /* 4 */
        unsigned int reserved0 : 27; /* 5:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_raw_status;
#define PCIE_CTRL_RB_GT_HOST_INTR_RAW_STATUS_OFF    0x654
#define PCIE_CTRL_RB_GT_HOST_INTR_RAW_STATUS_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_GT_HOST_INTR_RAW_STATUS_OFF)

/* PCIE中断上报 0x658 */
typedef union {
    struct {
        unsigned int gt_host2device_tx_intr_mask : 1; /* 0 */
        unsigned int gt_host2device_rx_intr_mask : 1; /* 1 */
        unsigned int gt_device2host_tx_intr_mask : 1; /* 2 */
        unsigned int gt_device2host_rx_intr_mask : 1; /* 3 */
        unsigned int gt_device2host_intr_mask : 1; /* 4 */
        unsigned int gt_host_ete_rx_intr_mask : 1; /* 5 */
        unsigned int gt_host_ete_tx_intr_mask : 1; /* 6 */
        unsigned int gt_rx_ch_dr_empty_intr_mask : 1; /* 7 */
        unsigned int gt_tx_ch_dr_empty_intr_mask : 1; /* 8 */
        unsigned int reserved0 : 23; /* 9:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_mask;
#define PCIE_CTRL_RB_GT_HOST_INTR_MASK_OFF    0x658
#define PCIE_CTRL_RB_GT_HOST_INTR_MASK_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_GT_HOST_INTR_MASK_OFF)

/* PCIE屏蔽后中断上报 0x65C */
typedef union {
    struct {
        unsigned int gt_host2device_tx_intr_status : 1; /* 0 */
        unsigned int gt_host2device_rx_intr_status : 1; /* 1 */
        unsigned int gt_device2host_tx_intr_status : 1; /* 2 */
        unsigned int gt_device2host_rx_intr_status : 1; /* 3 */
        unsigned int gt_device2host_intr_status : 1; /* 4 */
        unsigned int gt_host_ete_rx_intr_status : 1; /* 5 */
        unsigned int gt_host_ete_tx_intr_status : 1; /* 6 */
        unsigned int gt_rx_ch_dr_empty_intr_status : 1; /* 7 */
        unsigned int gt_tx_ch_dr_empty_intr_status : 1; /* 8 */
        unsigned int reserved0 : 23; /* 9:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_status;
#define PCIE_CTRL_RB_GT_HOST_INTR_STATUS_OFF    0x65C
#define PCIE_CTRL_RB_GT_HOST_INTR_STATUS_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_GT_HOST_INTR_STATUS_OFF)

/* PCIE中断上报 0x660 */
typedef union {
    struct {
        unsigned int gt_host2device_tx_intr_clr : 1; /* 0 */
        unsigned int gt_host2device_rx_intr_clr : 1; /* 1 */
        unsigned int gt_device2host_tx_intr_clr : 1; /* 2 */
        unsigned int gt_device2host_rx_intr_clr : 1; /* 3 */
        unsigned int reserved0 : 28; /* 4:31 */
    } bits;
    unsigned int as_dword;
} hreg_gt_host_intr_clr;
#define PCIE_CTRL_RB_GT_HOST_INTR_CLR_OFF    0x660
#define PCIE_CTRL_RB_GT_HOST_INTR_CLR_REG \
    (PCIE_CTRL_RB_BASE + PCIE_CTRL_RB_GT_HOST_INTR_CLR_OFF)
