 ...
 *
 * Description: oal_pcie_edma.c header file
...
/* MACRO DEFINITIONS */
#define PCIE_CTRL_IP_MP13_5_00A 0x002
#define PCIE_CTRL_IP_VERSION PCIE_CTRL_IP_MP13_5_00A
#define PCIE_CONFIG_BASE_ADDRESS 0x40102000 /* pcie config base address,4KB, 4.70a */

/* mp13 5.00a pcie dma address */
