                                              ...
                                              int32_t *ret)
{
    ...
    *ret = OAL_SUCC;
    ...
    for (i = 0; i < request_cnt; i++) {
        ...
        pci_print_log(PCI_LOG_DBG, "d2h ringbuf write [netbuf:0x%p, data:[va:0x%llx,pa:0x%llx]",
                      pst_netbuf, (uint64_t)(uintptr_t)oal_netbuf_data(pst_netbuf), st_write_item.buff_paddr.addr);
