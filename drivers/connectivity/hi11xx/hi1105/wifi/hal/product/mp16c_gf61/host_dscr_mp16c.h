...
#ifndef HOST_DSCR_MP16C_H
#define HOST_DSCR_MP16C_H
...
typedef struct {
    ...
    uint32_t msdu_timestamp : 16,
             resv3 : 16;
} mp16c_tx_msdu_dscr_stru;

/* 接收描述符定义 */
typedef struct tag_mp16c_rx_mpdu_desc_stru {
    /* word0~1 */
...
typedef struct  mp16c_ftm_word0 mp16c_ftm_word0_stru;

struct mp16c_ftm_word1 {
    uint8_t  snr_ant[HAL_HOST_MAX_RF_NUM];
    int8_t   rssi_hltf[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp16c_ftm_word1 mp16c_ftm_word1_stru;

typedef struct {
    uint16_t agc_code_ant : 8; /* [8..0]    */
    uint16_t reserved : 8;        /* [15..9]  */
} mp16c_ftm_agc_code_stru;

struct mp16c_ftm_word2 {
    mp16c_ftm_agc_code_stru st_agc_code_ant[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp16c_ftm_word2 mp16c_ftm_word2_stru;

struct mp16c_ftm_word3 {
    mp16c_ftm_agc_code_stru nd_agc_code_ant[HAL_HOST_MAX_RF_NUM];
} DECLARE_PACKED;
typedef struct mp16c_ftm_word3 mp16c_ftm_word3_stru;

struct mp16c_ftm_word4 {
...
typedef struct mp16c_ftm_word4 mp16c_ftm_word4_stru;

struct mp16c_ftm_word5 {
    uint64_t ra : 48;           /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp16c_ftm_word5 mp16c_ftm_word5_stru;

struct mp16c_ftm_word6 {
    uint64_t ta : 48;           /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp16c_ftm_word6 mp16c_ftm_word6_stru;

struct mp16c_ftm_word7 {
    uint64_t timestamp : 48;     /* [47..0]    */
    uint64_t bit_reserved : 16;  /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp16c_ftm_word7 mp16c_ftm_word7_stru;

struct mp16c_ftm_word8 {
    uint64_t tx_time : 48;      /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp16c_ftm_word8 mp16c_ftm_word8_stru;

struct mp16c_ftm_word9 {
    uint64_t rx_time : 48;      /* [47..0]    */
    uint64_t bit_reserved : 16; /* [63..48]  */
} DECLARE_PACKED;
typedef struct mp16c_ftm_word9 mp16c_ftm_word9_stru;

struct mp16c_ftm_word10 {
...
typedef struct mp16c_ftm_word10 mp16c_ftm_word10_stru;

struct mp16c_ftm_dscr {
    mp16c_ftm_word0_stru word0;
    mp16c_ftm_word1_stru word1;
    mp16c_ftm_word2_stru word2;
    mp16c_ftm_word3_stru word3;
    mp16c_ftm_word4_stru word4;
    mp16c_ftm_word5_stru word5;
    mp16c_ftm_word6_stru word6;
    mp16c_ftm_word7_stru word7;
    mp16c_ftm_word8_stru word8;
    mp16c_ftm_word9_stru word9;
    mp16c_ftm_word10_stru word10;
} DECLARE_PACKED;
typedef struct mp16c_ftm_dscr mp16c_ftm_dscr_stru;

struct mp16c_csi_ppu {
    mp16c_ftm_word0_stru word0;
    mp16c_ftm_word1_stru word1;
    mp16c_ftm_word2_stru word2;
    mp16c_ftm_word3_stru word3;
...
typedef struct mp16c_csi_ppu mp16c_csi_ppu_stru;

#pragma pack(pop)

uint32_t mp16c_rx_host_start_dscr_queue(uint8_t hal_dev_id);
int32_t mp16c_rx_host_stop_dscr_queue(uint8_t hal_dev_id);
void mp16c_tx_ba_info_dscr_get(uint8_t *ba_info_data, hal_tx_ba_info_stru *tx_ba_info);
void mp16c_tx_msdu_dscr_info_get(oal_netbuf_stru *netbuf, hal_tx_msdu_dscr_info_stru *tx_msdu_info);
void mp16c_host_ba_ring_regs_init(uint8_t hal_dev_id);
void mp16c_host_intr_regs_init(uint8_t hal_dev_id);
void mp16c_host_ring_tx_init(uint8_t hal_dev_id);
int32_t mp16c_rx_host_init_dscr_queue(uint8_t hal_dev_id);
void mp16c_host_rx_add_buff(hal_host_device_stru *hal_device, uint8_t en_queue_num);
uint32_t mp16c_rx_mpdu_que_len(hal_host_device_stru *pst_device);
...
oal_netbuf_stru *mp16c_rx_get_next_sub_msdu(hal_host_device_stru *hal_device, oal_netbuf_stru *netbuf);
...
#endif
#endif /* end of host_dscr_mp16c.h */
