...
#ifndef HOST_SNIFFER_MP16C_H
#define HOST_SNIFFER_MP16C_H
...
typedef struct tag_mp16c_rx_ppdu_vector_info_stru {
    /* word 0 */
    ...
    /* word 4 */
    uint32_t bit_rpt_snr_ant0              : 8; /* mp16c rpt_snr_0ch */
    uint32_t bit_rpt_snr_ant1              : 8; /* mp16c rpt_snr_1ch */
...
} mp16c_rx_ppdu_vector_info_stru;

/* word8-13 */
typedef struct tag_mp16c_rx_ppdu_frame_info_stru {
    /* word 8 */
...
} mp16c_rx_ppdu_frame_info_stru;

#define MP16C_HIMIT_RECV_TX_ADN_NUM        8

typedef struct tag_mp16c_rx_ppdu_himit_stru {
    uint32_t aul_himit_recv_tx_adn[MP16C_HIMIT_RECV_TX_ADN_NUM];
} mp16c_rx_ppdu_himit_stru;

typedef struct tag_mp16c_rx_ppdu_user_info_stru {
...
} mp16c_rx_ppdu_user_info_stru;

/* 接收ppdu描述信息 */
typedef struct tag_mp16c_rx_ppdu_desc_stru {
    /* word0-7 */
    mp16c_rx_ppdu_vector_info_stru rx_ppdu_vector_info;
    /* word8-13 */
    mp16c_rx_ppdu_frame_info_stru  rx_ppdu_frame_info;
    /* word14-21 */
    mp16c_rx_ppdu_himit_stru       rx_ppdu_himit;
    /* word22-27 */
    mp16c_rx_ppdu_user_info_stru   rx_ppdu_user_info;
} mp16c_rx_ppdu_desc_stru;

typedef struct {
    oal_dlist_head_stru entry;
    edma_paddr_t paddr;
    mp16c_rx_ppdu_desc_stru hw_ppdu_data;
...
void mp16c_sniffer_rx_ppdu_free_ring_deinit(hal_host_device_stru *hal_device);
