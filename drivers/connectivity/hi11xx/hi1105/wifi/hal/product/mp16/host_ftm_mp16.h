...
* 创建日期   : 2020年12月8日
*/
#ifndef HOST_FTM_MP16_H
#define HOST_FTM_MP16_H
...
#define MP16_MAC_CFG_FTM_EN_LEN              1
#define MP16_MAC_CFG_FTM_EN_OFFSET           0
#define MP16_MAC_CFG_FTM_EN_MASK             0x1

#define MP16_PHY_GLB_REG_BANK_CFG_FTM_EN_LEN                      1
#define MP16_PHY_GLB_REG_BANK_CFG_FTM_EN_OFFSET                   0
#define MP16_PHY_GLB_REG_BANK_CFG_FTM_EN_MASK                     0x1

#define MP16_RF_CTRL_REG_BANK_0_CFG_FTM_CALI_WR_RF_REG_EN_LEN    1
#define MP16_RF_CTRL_REG_BANK_0_CFG_FTM_CALI_WR_RF_REG_EN_OFFSET 1
#define MP16_RF_CTRL_REG_BANK_0_CFG_FTM_CALI_WR_RF_REG_EN_MASK   0x2

#define MP16_PHY_GLB_REG_BANK_CFG_FTM_CALI_CH_SEL_LEN             2
#define MP16_PHY_GLB_REG_BANK_CFG_FTM_CALI_CH_SEL_OFFSET          16
#define MP16_PHY_GLB_REG_BANK_CFG_FTM_CALI_CH_SEL_MASK            0x30000

#define MP16_CALI_TEST_REG_BANK_0_CFG_REG_TX_FIFO_EN_LEN     4
#define MP16_CALI_TEST_REG_BANK_0_CFG_REG_TX_FIFO_EN_OFFSET  0
#define MP16_CALI_TEST_REG_BANK_0_CFG_REG_TX_FIFO_EN_MASK    0xF

#define MP16_MAC_CFG_FTM_BUF_SIZE_LEN        16
#define MP16_MAC_CFG_FTM_BUF_SIZE_OFFSET     4
#define MP16_MAC_CFG_FTM_BUF_SIZE_MASK       0xFFFF0
...
#define MP16_RX_AGC_REG_BANK_CFG_WEAK_SIG_IMMUNITY_EN_LEN    1
#define MP16_RX_AGC_REG_BANK_CFG_WEAK_SIG_IMMUNITY_EN_OFFSET 0
#define MP16_RX_AGC_REG_BANK_CFG_WEAK_SIG_IMMUNITY_EN_MASK   0x1
...
typedef struct {
    ...
    uint8_t   ftm_snr_ant[HAL_HOST_MP16_RF_NUM];
    int8_t    ftm_rssi_ant[HAL_HOST_MP16_RF_NUM];
