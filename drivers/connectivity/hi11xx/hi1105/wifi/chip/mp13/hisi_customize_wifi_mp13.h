...
#ifndef HISI_CUSTOMIZE_WIFI_MP13_H
#define HISI_CUSTOMIZE_WIFI_MP13_H
...
#define DELTA_CCA_ED_HIGH_TH_RANGE      25   /*  δ调整上限，最大向上或向下调整25dB */
...
/* 根据产线delt power更新系数 */
static inline void cus_flush_nv_ratio_by_delt_pow(int32_t *pow_par0, int32_t *pow_par1,
    int32_t pow_par2, int32_t delt_power)
{
    int32_t tmp_pow_par0 = *pow_par0;
    int32_t tmp_pow_par1 = *pow_par1;
    *pow_par0 = (((int32_t)(delt_power) * (delt_power) * (pow_par2)) +
                 (((int32_t)(tmp_pow_par1) << DY_CALI_FIT_PRECISION_A1) * (delt_power)) +
                 ((int32_t)(tmp_pow_par0) << DY_CALI_FIT_PRECISION_A0)) >> DY_CALI_FIT_PRECISION_A0;
    *pow_par1 = (((int32_t)(delt_power) * (pow_par2) * 2) +  // 2倍扩展因子
                 ((int32_t)(tmp_pow_par1) << DY_CALI_FIT_PRECISION_A1)) >> DY_CALI_FIT_PRECISION_A1;
}
...
uint32_t hwifi_get_sar_ctrl_params_mp13(uint8_t lvl_num, uint8_t *data_addr, uint16_t *data_len, uint16_t dest_len);
...
#endif  // hisi_customize_wifi_mp13.h
