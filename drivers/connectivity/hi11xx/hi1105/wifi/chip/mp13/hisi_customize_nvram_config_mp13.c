...
OAL_STATIC wlan_cfg_cmd g_nvram_config_ini[NVRAM_PARAMS_PWR_INDEX_BUTT] = {
    ...
    /* CN */
    { "cn_side_band_txpwr_limit_5g_20m_0", NVRAM_PARAMS_CN_INDEX_00 },
    { "cn_side_band_txpwr_limit_5g_20m_1", NVRAM_PARAMS_CN_INDEX_01 },
    { "cn_side_band_txpwr_limit_5g_40m_0", NVRAM_PARAMS_CN_INDEX_02 },
    { "cn_side_band_txpwr_limit_5g_40m_1", NVRAM_PARAMS_CN_INDEX_03 },
    { "cn_side_band_txpwr_limit_5g_80m_0", NVRAM_PARAMS_CN_INDEX_04 },
    { "cn_side_band_txpwr_limit_5g_80m_1", NVRAM_PARAMS_CN_INDEX_05 },
    { "cn_side_band_txpwr_limit_5g_160m",  NVRAM_PARAMS_CN_INDEX_06 },
    { "cn_side_band_txpwr_limit_24g_ch1",  NVRAM_PARAMS_CN_INDEX_07 },
    { "cn_side_band_txpwr_limit_24g_ch2",  NVRAM_PARAMS_CN_INDEX_08 },
    { "cn_side_band_txpwr_limit_24g_ch3",  NVRAM_PARAMS_CN_INDEX_09 },
    { "cn_side_band_txpwr_limit_24g_ch4",  NVRAM_PARAMS_CN_INDEX_10 },
    { "cn_side_band_txpwr_limit_24g_ch5",  NVRAM_PARAMS_CN_INDEX_11 },
    { "cn_side_band_txpwr_limit_24g_ch6",  NVRAM_PARAMS_CN_INDEX_12 },
    { "cn_side_band_txpwr_limit_24g_ch7",  NVRAM_PARAMS_CN_INDEX_13 },
    { "cn_side_band_txpwr_limit_24g_ch8",  NVRAM_PARAMS_CN_INDEX_14 },
    { "cn_side_band_txpwr_limit_24g_ch9",  NVRAM_PARAMS_CN_INDEX_15 },
    { "cn_side_band_txpwr_limit_24g_ch10", NVRAM_PARAMS_CN_INDEX_16 },
    { "cn_side_band_txpwr_limit_24g_ch11", NVRAM_PARAMS_CN_INDEX_17 },
    { "cn_side_band_txpwr_limit_24g_ch12", NVRAM_PARAMS_CN_INDEX_18 },
    { "cn_side_band_txpwr_limit_24g_ch13", NVRAM_PARAMS_CN_INDEX_19 },
    { NULL,                          NVRAM_PARAMS_CN_END_INDEX_BUTT },

    { "cn_side_band_txpwr_limit_5g_20m_0_c1", NVRAM_PARAMS_CN_INDEX_00_C1 },
    { "cn_side_band_txpwr_limit_5g_20m_1_c1", NVRAM_PARAMS_CN_INDEX_01_C1 },
    { "cn_side_band_txpwr_limit_5g_40m_0_c1", NVRAM_PARAMS_CN_INDEX_02_C1 },
    { "cn_side_band_txpwr_limit_5g_40m_1_c1", NVRAM_PARAMS_CN_INDEX_03_C1 },
    { "cn_side_band_txpwr_limit_5g_80m_0_c1", NVRAM_PARAMS_CN_INDEX_04_C1 },
    { "cn_side_band_txpwr_limit_5g_80m_1_c1", NVRAM_PARAMS_CN_INDEX_05_C1 },
    { "cn_side_band_txpwr_limit_5g_160m_c1",  NVRAM_PARAMS_CN_INDEX_06_C1 },
    { "cn_side_band_txpwr_limit_24g_ch1_c1",  NVRAM_PARAMS_CN_INDEX_07_C1 },
    { "cn_side_band_txpwr_limit_24g_ch2_c1",  NVRAM_PARAMS_CN_INDEX_08_C1 },
    { "cn_side_band_txpwr_limit_24g_ch3_c1",  NVRAM_PARAMS_CN_INDEX_09_C1 },
    { "cn_side_band_txpwr_limit_24g_ch4_c1",  NVRAM_PARAMS_CN_INDEX_10_C1 },
    { "cn_side_band_txpwr_limit_24g_ch5_c1",  NVRAM_PARAMS_CN_INDEX_11_C1 },
    { "cn_side_band_txpwr_limit_24g_ch6_c1",  NVRAM_PARAMS_CN_INDEX_12_C1 },
    { "cn_side_band_txpwr_limit_24g_ch7_c1",  NVRAM_PARAMS_CN_INDEX_13_C1 },
    { "cn_side_band_txpwr_limit_24g_ch8_c1",  NVRAM_PARAMS_CN_INDEX_14_C1 },
    { "cn_side_band_txpwr_limit_24g_ch9_c1",  NVRAM_PARAMS_CN_INDEX_15_C1 },
    { "cn_side_band_txpwr_limit_24g_ch10_c1", NVRAM_PARAMS_CN_INDEX_16_C1 },
    { "cn_side_band_txpwr_limit_24g_ch11_c1", NVRAM_PARAMS_CN_INDEX_17_C1 },
    { "cn_side_band_txpwr_limit_24g_ch12_c1", NVRAM_PARAMS_CN_INDEX_18_C1 },
    { "cn_side_band_txpwr_limit_24g_ch13_c1", NVRAM_PARAMS_CN_INDEX_19_C1 },
    { NULL,                         NVRAM_PARAMS_CN_C1_END_INDEX_BUTT },
};
...
void original_value_for_nvram_params(void)
{
    ...
    for (uc_param_idx = NVRAM_PARAMS_CN_START_INDEX;
         uc_param_idx < NVRAM_PARAMS_CN_C1_END_INDEX_BUTT; uc_param_idx++) {
        /* CN功率认证 */
        g_nvram_init_params[uc_param_idx] = 0xFFFFFFFF;
    }
#ifdef _PRE_WLAN_FEATURE_TAS_ANT_SWITCH
...
{
    int32_t etsi_start_id[] = { NVRAM_PARAMS_CE_START_INDEX, NVRAM_PARAMS_CE_C1_START_INDEX };
    int32_t etsi_end_id[] = { NVRAM_PARAMS_CE_END_INDEX_BUTT, NVRAM_PARAMS_CE_C1_END_INDEX_BUTT};
    int32_t fcc_start_id[] = { NVRAM_PARAMS_FCC_START_INDEX, NVRAM_PARAMS_FCC_C1_START_INDEX };
    int32_t fcc_end_id[] = { NVRAM_PARAMS_FCC_END_INDEX_BUTT, NVRAM_PARAMS_FCC_C1_END_INDEX_BUTT };
    int32_t cn_start_id[] = { NVRAM_PARAMS_CN_START_INDEX, NVRAM_PARAMS_CN_C1_START_INDEX };
    int32_t cn_end_id[] = { NVRAM_PARAMS_CN_END_INDEX_BUTT, NVRAM_PARAMS_CN_C1_END_INDEX_BUTT };

    if (regdomain_type == REGDOMAIN_CN) {
        *start_idx = cn_start_id[chain_idx];
        *end_idx = cn_end_id[chain_idx];
    } else if (regdomain_type == REGDOMAIN_ETSI) {
        *start_idx = etsi_start_id[chain_idx];
        *end_idx = etsi_end_id[chain_idx];
    } else {
        *start_idx = fcc_start_id[chain_idx];
        *end_idx = fcc_end_id[chain_idx];
    }
}
...
/*
 * 函 数 名  : hwifi_get_delt_ru_pow_val_5g
...
/*
 * 函 数 名  : hwifi_get_delt_ru_pow_val_2g
 * 功能描述  : host查看ini定制化参数维测命令
 * 修改历史      :
 *   1.日    期   : 2019年8月21日
 *     作    者   : wifi
...
/*
 * 函 数 名  : hwifi_get_5g_ru_max_ru_pow_val
 * 功能描述  : 获取定制化ru的5g最大发射功率(区分RU SIZE/band/管制域)
 * 修改历史      :
 *   1.日    期   : 2020年2月21日
 *     作    者   : wifi
 *     修改内容   : 新生成函数
    ...
    for (band_idx = 0; band_idx < MAC_NUM_5G_BAND; band_idx++) {
        for (idx = CUS_POW_TX_CHAIN_MIMO; idx < CUS_POW_TX_CHAIN_BUTT; idx++) {
            ...
            ret += memcpy_s(&g_cust_nv_params->auc_tpc_tb_ru_5g_max_power[band_idx].auc_tb_ru_5g_max_power\
                ...
                &nvram_params, 3 * sizeof(uint8_t)); // 1992_996_484,3个ru的定制化项
            nvram_idx++;
        }
    }
...
/*
 * 函 数 名  : hwifi_get_total_max_ru_pow_val
 * 功能描述  : 获取定制化ru的整体最大发射功率
 * 修改历史      :
 *   1.日    期   : 2019年11月26日
 *     作    者   : wifi
 *     修改内容   : 新生成函数
...
/*
 * 函 数 名  : hwifi_get_max_ru_pow_val
 * 功能描述  : 获取定制化ru的最大发射功率
 * 修改历史      :
 *   1.日    期   : 2019年11月5日
 *     作    者   : wifi
...
/*
 * 函 数 名  : hwifi_config_init_ru_pow_nvram
 * 功能描述  : 定制化初始化ax功率相关项
 * 修改历史      :
 *   1.日    期   : 2019年11月7日
 *     作    者   : wifi
