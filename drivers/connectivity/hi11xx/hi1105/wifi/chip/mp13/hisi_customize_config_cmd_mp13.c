...
OAL_STATIC wlan_cfg_cmd g_wifi_config_cmds[] = {
    ...
    {"nrcoex_version",                  WLAN_CFG_INIT_NRCOEX_VERSION},
    ...
    { "reduce_pwr_2g_40mhz_channel_bitmap", WLAN_CFG_INIT_REDUCE_PWR_2G_40MHZ_CHANNEL_BITMAP },
    { NULL,         0 }
};
...
static void host_param_init_nrcoex_param(void)
{
    ...
    g_host_init_params[WLAN_CFG_INIT_NRCOEX_VERSION]                 = 0x01;
...
void host_params_init_first(void)
{
     ...
     */
    g_host_init_params[WLAN_CFG_INIT_REDUCE_PWR_2G_40MHZ_CHANNEL_BITMAP] = 0;
...
OAL_STATIC void hwifi_custom_adapt_device_ini_nrcoex_param(uint8_t *puc_data, uint32_t *pul_data_len)
{
    ...
    ini_info.nrcoex_version = (uint8_t)hwifi_get_init_value(CUS_TAG_INI, WLAN_CFG_INIT_NRCOEX_VERSION);
