...
struct wlan_chip_ops {
    ...
    oal_bool_enum_uint8 (*ap_p2p_device_coex_check_valid)(mac_device_stru *mac_device,
        mac_cfg_add_vap_param_stru *add_vap_param);
    uint32_t (*get_reduce_pwr_channel_2g_bitmap)(void);
};
...
OAL_STATIC OAL_INLINE oal_bool_enum_uint8 wlan_chip_ap_p2p_device_coex_check_valid(mac_device_stru *mac_device,
    mac_cfg_add_vap_param_stru *add_vap_param)
{
    if (g_wlan_chip_ops->ap_p2p_device_coex_check_valid != NULL) {
        return g_wlan_chip_ops->ap_p2p_device_coex_check_valid(mac_device, add_vap_param);
    }
    return OAL_TRUE;
}
