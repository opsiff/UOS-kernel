 ...
 * 功能说明   : wifi oam 统计对外公共接口头文件
 * 作者       : wifi
 * 创建日期   : 2021年12月23日
 */
#ifndef OAM_STAT_WIFI_H
#define OAM_STAT_WIFI_H

#include "wlan_types.h"
#include "platform_spec_mp13.h"
...
static inline oam_stat_info_stru *oam_stat_get_stat_all(void)
{
    return &g_oam_stat_info;
}
uint32_t oam_stats_report_info_to_sdt(uint8_t en_ota_type, uint32_t *param);
