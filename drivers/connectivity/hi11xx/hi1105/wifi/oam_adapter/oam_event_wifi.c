...
/* en_frame_direction->oam_ota_frame_direction_type_enum */
                                                  ...
                                                  uint8_t en_frame_direction)
{
    ...
    if (us_skb_len > SDT_NETBUF_MAX_PAYLOAD) {
        ...
        us_mac_frame_len = SDT_NETBUF_MAX_PAYLOAD - sizeof(oam_ota_hdr_stru);
    }
                                ...
                                uint8_t en_frame_direction)
{
    ...
    switch (g_oam_mng_ctx[OAM_CTX_WIFI].en_output_type) {
        /* 输出至控制台 */
...
/* en_beacon_direction->oam_ota_frame_direction_type_enum */
                                             ...
                                             uint8_t en_beacon_direction)
{
    ...
    if (us_skb_len > SDT_NETBUF_MAX_PAYLOAD) {
        us_skb_len = SDT_NETBUF_MAX_PAYLOAD;
        us_beacon_len = SDT_NETBUF_MAX_PAYLOAD - sizeof(oam_ota_hdr_stru);
    }
