...
void wal_event_fsm_init_2(void)
{
    ...
    g_ast_wal_host_ctx_table[HMAC_HOST_CTX_EVENT_SUB_TYPE_PMF_REASSOC_PORT_AUTH].p_func = wal_report_sta_pmf_port_auth;
#endif
}
/*****************************************************************************
