 ...
 * 功能说明 : wal_linux_scan.c 的头文件
 * 作    者 : wifi
 * 创建日期 : 2013年8月26日
 */

#ifndef WAL_LINUX_SCAN_H
#define WAL_LINUX_SCAN_H
...
#define PNO_SCHED_SCAN_INTERVAL_LEVEL1 (60) /* 60s */
#define PNO_SCHED_SCAN_INTERVAL_LEVEL2 (300) /* 300s */
