...
#define MAC_CHBA_NEGOTIATION_ACTION_HDR_LEN 9 /* chba negotiation action帧头长度 */
...
typedef enum {
    ...
    MAC_CHBA_SYNC_BEACON = 9,
    MAC_CHBA_NEGOTIATION = 10,
...
typedef enum {
    ...
    CHBA_CHANNEL_CFG_DIRECT_SET_CHANNEL = BIT2, /* 直接切换信道 */
