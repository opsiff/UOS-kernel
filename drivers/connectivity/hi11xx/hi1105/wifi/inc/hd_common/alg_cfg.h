...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define ALG_CFG_PARAM_MAX_NUM           20    /* 算法配置命令最大数目 */
/*****************************************************************************
  3 枚举定义
*****************************************************************************/
typedef enum {
...
typedef enum {
    ...
    MAC_ALG_CFG_WATERFILLING_BW_MODE,
    MAC_ALG_CFG_WATERFILLING_SUB_ASNR,
    MAC_ALG_CFG_WATERFILLING_CI_ASNR,
    MAC_ALG_CFG_WATERFILLING_LIMIT_ASNR,
    MAC_ALG_CFG_WATERFILLING_DEBUG,
    MAC_ALG_CFG_WATERFILLING_FORCE_FLAG,
    MAC_ALG_CFG_HARDAMARDTX_FORCE_FLAG,
...
typedef struct {
    alg_cfg_hdr_stru    alg_cfg_hdr;
    oal_bool_enum_uint8 waterfilling_bw_mode; /* waterfilling算法带宽模式 */
    uint8_t auc_resv[3];  /* 3 预留，4 字节对齐 */
} alg_cfg_param_waterfilling_bw_mode_stru;

typedef struct {
    alg_cfg_hdr_stru    alg_cfg_hdr;
    uint8_t waterfilling_rank_num;
    uint8_t waterfilling_nss_num;
    uint8_t waterfilling_asnr_value[HAL_WF_SUB_BW_NUM];
    uint8_t auc_resv[2];  /* 2 预留，4 字节对齐 */
} alg_cfg_param_waterfilling_sub_asnr_stru;
typedef struct {
    alg_cfg_hdr_stru    alg_cfg_hdr;
...
typedef struct {
    alg_cfg_hdr_stru    alg_cfg_hdr;
    oal_bool_enum_uint8 wf_force_flag;
    uint8_t auc_resv[3];  /* 3 预留，4 字节对齐 */
} alg_cfg_param_waterfilling_force_flag_stru;

typedef struct {
    alg_cfg_hdr_stru    alg_cfg_hdr;
    oal_bool_enum_uint8 hdtx_force_flag;
    uint8_t auc_resv[3];  /* 3 预留，4 字节对齐 */
} alg_cfg_param_hardamard_force_flag_stru;
/* -------------------waterfilling END---------------------- */
typedef enum {
    ...
    MAC_ALG_CFG_AUTORATE_TXMODE_PROBE,
    ...
    MAC_ALG_CFG_SIFS_RSP_START = 161,
    MAC_ALG_CFG_SIFS_RSP_LOG,
    MAC_ALG_CFG_SIFS_RSP_SOUNDING,
    MAC_ALG_CFG_SIFS_RSP_SIFS,
    MAC_ALG_CFG_SIFS_RSP_END,

    MAC_ALG_CFG_DDC_START,
    MAC_ALG_CFG_DDC_CTRL_ENABLE,
    MAC_ALG_CFG_DDC_LOG_ENABLE,
    MAC_ALG_CFG_DDC_END,

    MAC_ALG_CFG_TPC_LOWPOWER_START,
    MAC_ALG_CFG_TPC_LOWPOWER_ENABLE,
    MAC_ALG_CFG_TPC_LOWPOWER_LOG,
    MAC_ALG_CFG_TPC_LOWPOWER_END,

    MAC_ALG_CFG_ACI_NACI_START,
    MAC_ALG_CFG_ACI_NACI_DET_EN,
    MAC_ALG_CFG_ACI_NACI_FIX_MODE,
    MAC_ALG_ACI_NACI_DEBUG_LOG,
    MAC_ALG_CFG_ACI_NACI_END,
