...
static inline uint8_t mac_get_snap_type(mac_llc_snap_stru *llc_snap)
{
...
uint8_t mac_get_data_type_from_8023(oal_netbuf_stru *netbuf, uint8_t *frame_hdr,
    mac_netbuff_payload_type uc_hdr_type, uint32_t payload_len, uint8_t direction);
