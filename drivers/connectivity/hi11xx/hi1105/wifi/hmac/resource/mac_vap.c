...
uint8_t mac_vap_get_ap_usr_opern_bandwidth(mac_vap_stru *pst_mac_sta, mac_user_stru *pst_mac_user)
{
    ...
    **********************************************************************/
    ...
    tmp_channel = pst_mac_sta->st_channel;
    tmp_channel.en_bandwidth = en_sta_new_bandwidth;
    en_sta_new_bandwidth = hmac_config_update_2g_40mhz_bandwidth(pst_mac_sta, &tmp_channel);
