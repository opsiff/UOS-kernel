 ...
 * 功能说明 : mac_regdomain.c 的头文件
 * 作    者 :
 * 创建日期 : 2013年9月18日
 */

#ifndef MAC_REGDOMAIN_H
#define MAC_REGDOMAIN_H
...
static inline uint32_t mac_get_ch_bit(uint8_t ch_idx)
{
    return (uint32_t)((uint32_t)1 << ch_idx);
}
...
#define MAX_CHANNEL_NUM_FREQ_2G 14
...
extern mac_channel_info_stru g_ast_channel_list_5g[MAC_CHANNEL_FREQ_5_BUTT];
extern mac_channel_info_stru g_ast_channel_list_2g[MAC_CHANNEL_FREQ_2_BUTT];
extern const mac_freq_channel_map_stru g_ast_freq_map_5g[MAC_CHANNEL_FREQ_5_BUTT];
extern const mac_freq_channel_map_stru g_ast_freq_map_2g[MAC_CHANNEL_FREQ_2_BUTT];
