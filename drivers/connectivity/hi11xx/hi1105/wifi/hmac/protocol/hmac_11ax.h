...
uint32_t hmac_update_he_opern_ie_sta(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user, uint8_t *puc_payload);
...
uint32_t hmac_proc_he_6ghz_band_cap_ie(mac_vap_stru *pst_mac_vap, hmac_user_stru *pst_hmac_user, uint8_t *puc_payload);
#endif
#endif
