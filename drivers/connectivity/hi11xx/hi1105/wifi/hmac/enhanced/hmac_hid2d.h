...
extern hmac_hid2d_chan_stru g_aus_channel_candidate_list_2g[HMAC_HID2D_CHANNEL_NUM_2G];
extern hmac_hid2d_chan_stru g_aus_channel_candidate_list_5g[HMAC_HID2D_CHANNEL_NUM_5G];
extern uint8_t g_scan_chan_list[HMAC_HID2D_MAX_SCAN_CHAN_NUM];
...
int32_t wal_hid2d_gso_mode(oal_net_device_stru *net_dev, uint8_t ctrl);
