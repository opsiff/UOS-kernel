...
#ifndef HMAC_WIFI6_SELF_CURE_C
#define HMAC_WIFI6_SELF_CURE_C
...
/*
 * 功能描述  : 查询当前mac是否在wifi6 blacklist里面
 * 1.日    期  : 2020年1月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
...
/*
 * 功能描述  : 查询当前mac是否在htc blacklist里面
 * 1.日    期  : 2020年1月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
...
/*
 * 功能描述  : 自愈初始化，默认初始化为驱动处理，待调试完毕修改为上层处理
 * 1.日    期  : 2020年1月8日
 *   作    者  : wifi
 *   修改内容  : 新生成函数
 */
...
#endif
#endif /* end of HMAC_WIFI6_SELF_CURE_C */
