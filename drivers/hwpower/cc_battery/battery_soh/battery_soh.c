...
static DEVICE_ATTR_RO(bsoh_battery_removed);
static DEVICE_ATTR_RO(bsoh_subsys);
static DEVICE_ATTR_WO(bsoh_dmd_report);
#ifdef CONFIG_HUAWEI_POWER_DEBUG
static DEVICE_ATTR_WO(bsoh_sysfs_notify);
#endif /* CONFIG_HUAWEI_POWER_DEBUG */
