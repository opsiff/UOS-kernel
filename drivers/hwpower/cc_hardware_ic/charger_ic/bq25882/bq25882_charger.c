...
static int bq25882_chip_init(struct charge_init_data *init_crit)
{
	int ret = -1;
	struct bq25882_device_info *di = g_bq25882_dev;
	...
	const struct i2c_device_id *id)
{
	...
	di->wlock = power_wakeup_source_register(di->dev, "bq25882_wakelock");
...
bq25882_fail_0:
	power_wakeup_source_unregister(di->wlock);
	kfree(di);
	g_bq25882_dev = NULL;
