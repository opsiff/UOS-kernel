...
static int bd99954_chip_init(struct charge_init_data *init_crit)
{
	int ret = -1;
	struct bd99954_device_info *di = g_bd99954_dev;
...
static void bd99954_charge_term_check(struct bd99954_device_info *di)
{
	...
	curr_avg = charge_get_battery_current_avg();
	curr = -power_platform_get_battery_current();
	...
	const struct i2c_device_id *id)
{
	...
	di->wakelock = power_wakeup_source_register(di->dev, "bd99954_wakelock");
