...
struct stwlc88_mtp_check_delay {
	u32 user;
	u32 fac;
};
...
struct stwlc88_dev_info {
	...
	struct stwlc88_mtp_check_delay mtp_check_delay;
...
void stwlc88_enable_irq_wake(struct stwlc88_dev_info *di);
void stwlc88_disable_irq_wake(struct stwlc88_dev_info *di);
...
/* stwlc88 hw_test */
int stwlc88_hw_test_ops_register(struct stwlc88_dev_info *di);
