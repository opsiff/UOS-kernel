...
static void stwlc88_rx_set_turbo_chg_flag(bool flag, void *dev_data)
{
	struct stwlc88_dev_info *di = dev_data;
...
static void stwlc88_rx_set_cur_pmode_name(const char *cur_pmode_name, void *dev_data)
{
	struct stwlc88_dev_info *di = dev_data;
...
static struct wlrx_ic_ops g_stwlc88_rx_ic_ops = {
	...
	.set_turbo_chg_flag     = stwlc88_rx_set_turbo_chg_flag,
	.set_cur_pmode_name     = stwlc88_rx_set_cur_pmode_name,
