...
#define MT5785_CALI_VRECT_DIFF_MIN        (-5500)
#define MT5785_CALI_VRECT_DIFF_MAX        100
#define MT5785_CALI_VRECT_POWERON_MIN     4000
#define MT5785_CALI_VRECT_POWERON_MAX     5500
...
static bool mt5785_cali_is_poweron(struct mt5785_dev_info *di)
{
	...
	if ((vrect > MT5785_CALI_VRECT_POWERON_MIN) &&
		(vrect < MT5785_CALI_VRECT_POWERON_MAX) &&
		(vout - vrect < MT5785_CALI_VRECT_DIFF_MAX) &&
		(vout - vrect > MT5785_CALI_VRECT_DIFF_MIN)) {
