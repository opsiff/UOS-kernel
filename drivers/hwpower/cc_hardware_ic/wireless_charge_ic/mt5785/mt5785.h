...
/* for rx dummy iload */
enum mt5785_dummy_iload {
	MT5785_DUMMY_ILOAD_BEGIN = 0,
	MT5785_DUMMY_ILOAD_5V_TH = MT5785_DUMMY_ILOAD_BEGIN,
	MT5785_DUMMY_ILOAD_9V_TH,
	MT5785_DUMMY_ILOAD_SC_TH,
	MT5785_DUMMY_ILOAD_FODCHK_TH,
	MT5785_DUMMY_ILOAD_END,
};
...
struct mt5785_dev_info {
	...
	u32 rx_ldo_opp_en;
	u32 dummy_iload;
	u32 dummy_iload_new[MT5785_DUMMY_ILOAD_END];
	u32 fodchk_ask_cap;
