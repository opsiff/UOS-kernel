...
#define SC8565_IBAT_OCP_MIN                       8000
#define SC8562_IBAT_OCP_MAX                       13500
#define SC8565_IBAT_OCP_MAX                       15500
...
/* CTRL_CONV_OCP_DIS reg=0x79 */
#define SC8565_CONV_OCP_REG                       0x79
#define SC8565_CONV_OCP_MASK                      BIT(5)
#define SC8565_CONV_OCP_SHIFT                     5
#define SC8565_CONV_OCP_DISABLE                   1
#define SC8565_CONV_OCP_ENABLE                    0
