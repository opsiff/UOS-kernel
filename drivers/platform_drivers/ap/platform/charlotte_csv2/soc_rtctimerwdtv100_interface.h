...
#define SOC_HIWDGV500_WDUNLOCK_ADDR(base) ((base) + (0x0000))
#define SOC_HIWDGV500_WDLOCK_ADDR(base) ((base) + (0x0004))
#define SOC_HIWDGV500_WDUNLOCK_CHECK_ADDR(base) ((base) + (0x0008))
#define SOC_HIWDGV500_WDINTCNT_ADDR(base) ((base) + (0x000C))
#define SOC_HIWDGV500_WDRST_ADDR(base) ((base) + (0x0010))
#define SOC_HIWDGV500_WDCONTROL_ADDR(base) ((base) + (0x0014))
#define SOC_HIWDGV500_WDKICK_ADDR(base) ((base) + (0x0018))
#define SOC_HIWDGV500_WDINTCLR_ADDR(base) ((base) + (0x001C))
#define SOC_HIWDGV500_WDMIS_ADDR(base) ((base) + (0x0020))
#define SOC_HIWDGV500_WDMIRST_ADDR(base) ((base) + (0x0024))
#define SOC_HIWDGV500_WDRIS_ADDR(base) ((base) + (0x0028))
#define SOC_HIWDGV500_WDVALUE_ADDR(base) ((base) + (0x0030))
