...
#define M3_RDR_HECA_OFFSET (M3_RDR_THERMAL_FREQ_LIMIT_OFFSET + M3_RDR_THERMAL_FREQ_LIMIT_SIZE)
#define M3_RDR_HECA_ADDR (M3_RDR_SYS_CONTEXT_BASE_ADDR + M3_RDR_HECA_OFFSET)
#define M3_RDR_HECA_SIZE (0x4000)
#define M3_RDR_SYS_CONTEXT_RESERVED_ADDR (M3_RDR_HECA_ADDR + M3_RDR_HECA_SIZE)
