...
#ifndef PAGE_PRIV_OSH_SHIFT
#define PAGE_PRIV_OSH_SHIFT 6 /* Same as the macro defined in mm_lb_priv.h */
#endif
			      ...
			      int iommu_prot, gfp_t gfp, size_t *mapped)
{
	...
	if (page_private(pg) & BIT(PAGE_PRIV_OSH_SHIFT))
		iommu_prot |= IOMMU_OSH;
#endif
