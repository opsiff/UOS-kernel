 ...
 * 2lvl: L1 entries= 512( 1 << 9), mem = 512 * 8 = 4k,
 *       256 lazy entries per table (each table covers a PCI bus)
 */
#define STRTAB_L1_SZ_SHIFT		12
...
#define ARM_SMMU_IRPT_STAT_NS		(MM_TOP_CTL_BASE + 0x78)
...
#define TCU_MEM_ERR_DETECT		BIT(10)
#define TCU_MEM_ERR_MULTI		BIT(9)
...
enum ssid_type {
	SHARE_SSID, /* arm smmu driver share stage1 pagetable for all ssid */
	ISOLATE_SSID, /* arm smmu driver isolate stage1 pagetable for all ssid */
};
...
extern int hi_pcie_get_ssid_by_dev(struct device *dev);
