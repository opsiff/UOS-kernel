...
#ifdef QCOM_8425_DISPLAY_REFRESH_RATE
...
static void dubai_calculate_delta(const hist_data *last, const hist_data *curr, hist_data *delta, int size)
{
#if (defined CONFIG_POWER_DUBAI_RGB_STATS) || (defined CONFIG_HUAWEI_DUBAI_RGB_STATS)
	int i;
...
static int dubai_get_display_refresh_rate(void __user *argp)
{
	...
	refresh_rate_cmd.refresh_count.count_1hz = info.refresh_cnt[RATE_1HZ];
	refresh_rate_cmd.refresh_count.count_5hz = info.refresh_cnt[RATE_5HZ];
	refresh_rate_cmd.refresh_count.count_10hz = info.refresh_cnt[RATE_10HZ];
	refresh_rate_cmd.refresh_count.count_15hz = info.refresh_cnt[RATE_15HZ];
	refresh_rate_cmd.refresh_count.count_24hz = info.refresh_cnt[RATE_24HZ];
	refresh_rate_cmd.refresh_count.count_30hz = info.refresh_cnt[RATE_30HZ];
	refresh_rate_cmd.refresh_count.count_45hz = info.refresh_cnt[RATE_45HZ];
	refresh_rate_cmd.refresh_count.count_60hz = info.refresh_cnt[RATE_60HZ];
	refresh_rate_cmd.refresh_count.count_90hz = info.refresh_cnt[RATE_90HZ];
	refresh_rate_cmd.refresh_count.count_120hz = info.refresh_cnt[RATE_120HZ];
	refresh_rate_cmd.refresh_count.count_180hz = info.refresh_cnt[RATE_180HZ];
#endif
