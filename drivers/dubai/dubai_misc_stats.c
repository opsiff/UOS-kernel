...
static void dubai_get_uevent_stats(struct buffered_log_entry *log_entry, long long timestamp, int max_count)
{
	unsigned char *data = NULL;
	struct dubai_uevent_entry *entry = NULL;
	struct dubai_uevent_entry *tmp = NULL;
...
{
	struct dubai_binder_client_entry *client = NULL;
	struct dubai_binder_client_entry *tmp = NULL;
...
static void dubai_init_binder_stats(void)
{
	...
	struct dubai_binder_stats_entry *temp = NULL;
...
{
	struct dubai_binder_client_entry *client = NULL;
	struct dubai_binder_client_entry *temp = NULL;
...
{
	struct dubai_binder_stats_entry *tmp = NULL;
	struct dubai_binder_stats_entry *stats = NULL;
...
void dubai_misc_stats_exit(void)
{
	...
	struct hlist_node *tmp = NULL;
	struct dubai_uevent_entry *uevent = NULL;
	struct dubai_uevent_entry *temp = NULL;
	unsigned long bkt;
