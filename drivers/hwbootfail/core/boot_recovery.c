...
static void select_upper_method_without_bopd(
	struct select_param *pparam)
{
	switch (pparam->count_upper) {
	case FAIL_COUNT_1:
...
static void select_bottom_method_without_bopd(
	struct select_param *pparam)
{
	switch (pparam->count_bottom) {
	case FAIL_COUNT_1:
	...
	struct select_param *pparam)
{
	...
	if (pparam->count_upper > 0) {
		select_upper_method_without_bopd(pparam);
	} else {
		select_bottom_method_without_bopd(pparam);
	}
