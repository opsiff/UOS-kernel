...
static void track_dmabuf_add(struct dmabuf_page_pool *pool)
{
	atomic_long_add((1 << pool->order), &ion_total_cache);;
}

static void track_dmabuf_remove(struct dmabuf_page_pool *pool)
{
