...
#endif
#ifdef CONFIG_IPA_THERMAL
	u32 cur_enable = tz->tzp->cur_enable;
...
static int power_allocator_throttle(struct thermal_zone_device *tz, int trip)
{
	...
	if (strcmp(tz->type, "soc_thermal") == 0)
		trace_perf(clock_set_rate, "soc_temp", tz->temperature, raw_smp_processor_id());

	if (strcmp(tz->type, "board_thermal") == 0)
		trace_perf(clock_set_rate, "board_temp", tz->temperature, raw_smp_processor_id());
