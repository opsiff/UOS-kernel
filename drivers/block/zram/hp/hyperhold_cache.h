...
#define CACHE_SIZE_HIGH (PKG_EXTENT_SIZE * 3 / 4)
#define CACHE_SIZE_LOW (PKG_EXTENT_SIZE / 4)
...
struct extent_cache *new_extent_cache(struct page *pages[PKG_EXTENT_PG_CNT],
