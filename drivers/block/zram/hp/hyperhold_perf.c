...
static void hyperhold_perf_warning(struct timer_list *timer)
{
	struct hyperhold_key_point_record *record =
		container_of(timer, struct hyperhold_key_point_record, lat_monitor);
#else
...
static void hyperhold_perf_start_proc(
	struct hyperhold_key_point_record *record,
...
static void hyperhold_perf_end_proc(
	struct hyperhold_key_point_record *record,
	enum hyperhold_key_point type, ktime_t curr_time,
	unsigned long long current_ravg_sum)
{
...
static void hyperhold_perf_lat_stat(
	struct hyperhold_key_point_record *record)
{
