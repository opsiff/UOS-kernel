...
{
	if (!g_hall_interface_dev || !g_hall_interface_dev->p_ops || !g_hall_interface_dev->p_ops->get_hall_status)
		return false;
...
{
	if (!g_hall_interface_dev || !g_hall_interface_dev->p_ops || !g_hall_interface_dev->p_ops->get_ext_fold_status)
		return false;
