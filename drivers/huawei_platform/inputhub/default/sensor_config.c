...
uint8_t gsensor2_calibrate_data[ACC2_CALIBRATE_DATA_LENGTH];
int gsensor2_offset[ACC2_OFFSET_DATA_LENGTH]; /* gsensor2 calibrate data */
uint8_t gyro2_sensor_calibrate_data[GYRO2_OFFSET_NV_SIZE];
int gyro2_sensor_offset[GYRO2_CALIBRATE_DATA_LENGTH];
