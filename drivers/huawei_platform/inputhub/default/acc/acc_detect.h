...
#define ACC_DEV_COUNT_MAX 3 // add acc2

#define ACC_OFFSET_CALIBRATE_LENGTH 3

// Don't modify following definition, it's will used in camera hardcoded
#define FIX_2_I2C_SENSOR_DEFAULT 0
#define FIX_2_I2C_SENSOR_NEED 1
#define FIX_2_I2C_SENSOR_INIT_FIINSHED 2
#define FIX_2_I2C_SENSOR_NO_GRL_DEDICATED_BOARD 3
