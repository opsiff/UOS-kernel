...
#define GRL_BOE_RESOLUTION_X 2232
#define GRL_BOE_RESOLUTION_Y 3184 // 2232 * 3184
#define GRL_M_RESOLUTION_X   2048 // 2048 * 2232
#define GRL_F_RESOLUTION_X   (GRL_BOE_RESOLUTION_Y - GRL_M_RESOLUTION_X)
...
struct lcd_als_map {
	uint8_t product;
	int als[LCD_PANEL_MAX]; // LCD_PANEL_MAIN, LCD_PANEL_1_OUTSIDE
};
