...
als_para_normal_table stk37670_als_para[] = {
	{ ALTB, V3, DEFAULT_TPLCD, STK37670_PARA_SIZE,
		{ 128, -4643, 8281, 27336, 0, 1000, 0, 5690, -4716, 2529, -5526, 100,
		0, 1, 20, -1000, 0, 0, 2776, 12000, 0, 0, -317, 1, 20, 0, 1838,
		1072, 919, 411, 4000, 250 }
	},
};
...
als_para_normal_table *als_get_stk37670_table_by_id(uint32_t id)
{
	if (id >= ARRAY_SIZE(stk37670_als_para))
		return NULL;
	return &(stk37670_als_para[id]);
}

als_para_normal_table *als_get_stk37670_first_table(void)
{
	return &(stk37670_als_para[0]);
}

uint32_t als_get_stk37670_table_count(void)
{
	return ARRAY_SIZE(stk37670_als_para);
}