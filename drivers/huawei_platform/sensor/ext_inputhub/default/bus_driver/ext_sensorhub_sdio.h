...
#else
static inline void ext_sensorhub_detect_sdio_card(void)
{
	return;
}

static inline int ext_sensorhub_sdio_func_probe(void)
{
	return 0;
}

static inline void ext_sensorhub_sdio_exit(void)
{
	return;
}

static inline void dw_mci_1135_card_detect_change(void)
{
	return;
}

static inline int ext_sensorhub_mmc_sdio_dev_write(u8 *buf, u32 len)
{
	return 0;
}

static inline int ext_sensorhub_mmc_sdio_dev_read(u8 *buf, u32 len)
{
	return 0;
}

static inline int ext_sensorhub_mmc_sdio_get_xfercount(u32 *xfercount)
{
	return 0;
}
