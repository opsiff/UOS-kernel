...
#define MAX_IS_SUPPORT_OEMINFO_LEN     30
...
enum report_type {
	...
	// si_sip5005 10 raw data SEQ: f1,f2,f3,...,nir,clear,0,...,0
	AWB_SENSOR_RAW_SEQ_TYPE_SIP5005 = 7,
...
struct color_chip {
	...
	void (*set_polling_time_type)(struct color_chip *, int);
	char *(*get_oeminfo_data)(void);
};
