...
struct batt_ct_ops {
	...
	int (*rt_check)(struct platform_device *pdev, struct power_genl_attr *key_res);
...
#define BACKUP_ID_CHECK_STRUCT_LEN                  3
...
struct batt_ct_wrapper_ops {
	...
	int (*get_batt_safe_info)(struct batt_chk_data *data,
		enum batt_safe_info_t type, void *value);
	int (*rt_check)(struct batt_chk_data *data);
...
struct batt_chk_data {
	...
	struct backup_id_check backup_check_item;
