...
static void aw8692x_play_mode(struct aw_haptic *aw_haptic, uint8_t play_mode)
{
	...
	case AW_RAM_MODE:
		...
		if (aw_haptic->index >= HAPTIC_RAM_BRK_DISABLE_ID_1)
			hv_i2c_w_bits(aw_haptic, AW8692X_REG_PLAYCFG3,
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_MASK & AW8692X_BIT_PLAYCFG3_BRK_EN_MASK),
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_RAM | AW8692X_BIT_PLAYCFG3_BRK_DISABLE));
		else
			hv_i2c_w_bits(aw_haptic, AW8692X_REG_PLAYCFG3,
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_MASK & AW8692X_BIT_PLAYCFG3_BRK_EN_MASK),
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_RAM | AW8692X_BIT_PLAYCFG3_BRK_ENABLE));
		break;
	...
	case AW_RTP_MODE:
		...
		hv_i2c_w_bits(aw_haptic, AW8692X_REG_PLAYCFG3,
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_MASK & AW8692X_BIT_PLAYCFG3_BRK_EN_MASK),
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_RTP | AW8692X_BIT_PLAYCFG3_BRK_DISABLE));
		/* bst mode */
	...
	case AW_CONT_MODE:
		...
		hv_i2c_w_bits(aw_haptic, AW8692X_REG_PLAYCFG3,
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_MASK & AW8692X_BIT_PLAYCFG3_BRK_EN_MASK),
				(AW8692X_BIT_PLAYCFG3_PLAY_MODE_CONT | AW8692X_BIT_PLAYCFG3_BRK_ENABLE));
		/* bst mode */
		aw8692x_bst_mode_config(aw_haptic, AW_BST_BYPASS_MODE);
		break;
	default:
