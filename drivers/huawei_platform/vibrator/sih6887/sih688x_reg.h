...
#define SIH_SYSINT2_BIT_F0_TRACKING_INT_EN			(0 << 2)
#define SIH_SYSINT2_BIT_F0_TRACKING_INT_OFF			(1 << 2)
#define SIH_SYSINT2_BIT_F0_DETECT_DONE_INT_MASK			(1 << 1)
#define SIH_SYSINT2_BIT_F0_DETECT_DONE_INT_EN			(0 << 1)
#define SIH_SYSINT2_BIT_F0_DETECT_DONE_INT_OFF			(1 << 1)
#define SIH_SYSINT2_BIT_BRK_SHORT_TIMEOUT_MASK			(1 << 1)
#define SIH_SYSINT2_BIT_BRK_SHORT_TIMEOUT_EN			(0 << 1)
#define SIH_SYSINT2_BIT_BRK_SHORT_TIMEOUT_OFF			(1 << 1)
...
#define SIH_ANA_CTRL_BST_LEVEL_6			6
#define SIH_ANA_CTRL_BST_LEVEL_7			7
#define SIH_ANA_CTRL_BST_LEVEL_8			8
#define SIH_ANA_CTRL_BST_LEVEL_9			9
#define SIH_ANA_CTRL_BST_LEVEL_10			10
#define SIH_ANA_CTRL_BST_LEVEL_11			11
...
#define SIH_SMOOTH_F0_DETECT_MASK			(1 << 5)
#define SIH_SMOOTH_F0_DETECT_EN				(1 << 5)
#define SIH_SMOOTH_F0_DETECT_OFF			(0 << 5)
