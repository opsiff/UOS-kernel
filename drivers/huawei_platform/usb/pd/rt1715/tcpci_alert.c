...
bool g_vbus_only_first_insert = true;
#endif
...
int tcpci_alert(struct tcpc_device *tcpc)
{
	int rv = 0, i = 0;
#ifdef CONFIG_TCPC_RT1715
	bool et_power_state_change = false;
#endif
