...
#ifndef UKMD_ACQUIRE_FENCE_H
#define UKMD_ACQUIRE_FENCE_H
...
#define ACQUIRE_FENCE_WAIT_WARN(frame_rate) (1000000 / (((frame_rate) == 0 ? 60 : (frame_rate))))
