...
static void lcd_init_dirty_region(struct panel_drv_private *priv)
{
	...
	priv->user_pinfo.top_align = 60;
	priv->user_pinfo.bottom_align = 60;
	priv->user_pinfo.w_align = -1;
	priv->user_pinfo.h_align = 120;
	priv->user_pinfo.w_min = 1080;
	priv->user_pinfo.h_min = 120;
