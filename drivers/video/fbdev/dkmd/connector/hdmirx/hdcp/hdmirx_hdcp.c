...
{
	// start HDCP 1.4
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A038, 0x1, 32, 0);
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A02C, 0x6, 32, 0);

	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A108, 0xf02, 32, 0);
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A114, 0x12160210, 32, 0);
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A024, 0x91, 32, 0);

	// start MCU HDCP 2.2
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x18008, 0x7, 32, 0);
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x1A02C, 0x6, 32, 0);

	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x00020, 0, 1, 31);
	hdmirx_set_reg(hdmirx->hdmirx_pwd_base + 0x04004, 0x4c84200, 32, 0);
	return 0;
}