...
#define DPRX0_GT_PCLK_HIDPRX0PHY BIT(20)
#define DPRX0_GT_PCLK_HIDPRX1PHY BIT(19)
#define DPRX0_GT_CLK_HIDPRX0PHY_REF BIT(8)
#define DPRX0_GT_CLK_HIDPRX1PHY_REF BIT(7)
#define DPRX0_GT_CLK_HIDPRX0PHY_AUX BIT(6)
#define DPRX0_GT_CLK_HIDPRX1PHY_AUX BIT(5)

#define DPRX0_DISABLE_CLK_OFFSET 0x14
#define DPRX0_GT_CLK_HIDPRX0PHY_AUX BIT(6)
#define DPRX0_GT_CLK_HIDPRX0PHY_REF BIT(8)
#define DPRX0_GT_PCLK_HIDPRX0 BIT(10)
#define DPRX0_GT_PCLK_HIDPRX0_AUX BIT(12)
#define DPRX0_GT_PCLK_HIDPRX0PHY BIT(20)
#define DPRX_GT_PCLK_EIDI BIT(3)
#define DPRX_GT_PCLK_DPRX_ASYNC_BRIDGE BIT(26)
...
#define DPRX_IP_RST_HIDPRX0PHY_POR BIT(6)
#define DPRX_IP_PRST_HIDPRX0PHY BIT(13)
...
#define DPRX0_RST_HIDPRX0PHY_POR_BIT BIT(6)
#define DPRX0_RST_HIDPRX1PHY_POR_BIT BIT(3)
#define DPRX0_IP_PRST_HIDPRX0PHY_BIT BIT(13)
#define DPRX0_IP_PRST_HIDPRX1PHY_BIT BIT(12)
/* hsdt1_crg_start rx1 */
...
#define DPRX1_DISABLE_CLK_OFFSET 0x14
#define DPRX1_GT_CLK_HIDPRX1PHY_AUX BIT(5)
#define DPRX1_GT_CLK_HIDPRX1PHY_REF BIT(7)
#define DPRX1_GT_PCLK_HIDPRX1 BIT(9)
#define DPRX1_GT_PCLK_HIDPRX1_AUX BIT(11)
#define DPRX1_GT_PCLK_HIDPRX1PHY BIT(19)
...
#define DPRX_IP_PRST_HIDPRX1PHY BIT(12)
#define DPRX_IP_RST_HIDPRX1PHY_POR BIT(3)
...
#define DPRX_AUX_CTRL0 0x200
#define DPRX_SYNC_NUM_BIT BIT(10)
...
#define DPRX_ATC_PWR_DOWN_MODE BIT(22)
...
#define DPRX_DSC_CTRL0 0x810

#define DPRX_DSC_CTRL1 0x814

#define DPRX_VIDEO_CTRL 0x830
#define VIDEO_OUT_EN BIT(0)

#define DPRX_PHY_RST_CTRL 0x900
#define DPRX_PHY_RATE_SEL_BIT BIT(7)
#define DPRX_LANE0_POWERDOWN_BIT BIT(8)
#define DPRX_LANE1_POWERDOWN_BIT BIT(9)
#define DPRX_LANE2_POWERDOWN_BIT BIT(10)
#define DPRX_LANE3_POWERDOWN_BIT BIT(11)
#define LANE_POWERDOWN_SEL GENMASK(11, 8)

#define DPRX_PHY_STATUS 0x9C4
...
#define DPRX_LANE0_POWERDOWN GENMASK(3, 0)
#define DPRX_LANE1_POWERDOWN GENMASK(7, 4)
#define DPRX_LANE2_POWERDOWN GENMASK(11, 9)
#define DPRX_LANE3_POWERDOWN GENMASK(15, 12)
...
#define DPRX_SCTRL_ERR_INTR_MASKED_STATUS 0xB58
#define DPRX_MASKED_LANE_PHYSTATUS_MASK GENMASK(5, 2)

#define DPRX_SINKSTATUS_CTRL 0xD48

#define DPRX_SCTRL_DFX_DEBUG_SELECT 0xD00
#define DPRX_DBG_PHY_SEL_MASK GENMASK(7, 4)

#define DPRX_SCTRL_DFX_DEBUG_BUS 0xD04
#define DPRX_DBG_PHY_CTRL_MASK GENMASK(17, 16)

// start phy register start
#define DPRX_PHY_REG_OFFSET 0x108000
#define PPI_REG_SET 0x0
#define PPI_REG_SET2 0x4
#define XBAR_AUX_PULSE 0x8
#define REG_PHY_MODE_MASK GENMASK(11, 8)
#define REG_PHY_MODE_OFFSET 8

#define PMA_AUX 0x24
#define REG_DPRX_AUX_PWDNB BIT(4)


#define DA_TEST_EN 0x30
#define DA_TEST_EN_2 0x34
#define REG_T_DA_2 0x44
#define REG_T_DA_10 0x64
#define REG_T_DA_13 0x70
#define REG_T_DA_14 0x74
#define REG_T_DA_15 0x78

#define DA_RATE_R0 0x80
#define DA_RATE_R0_2 0x84
#define DA_RATE_R0_3 0x88
#define DA_RATE_R0_4 0x8C

#define DA_RATE_R1 0x90
#define DA_RATE_R1_2 0x94
#define DA_RATE_R1_3 0x98
#define DA_RATE_R1_4 0x9C

#define DA_RATE_R2 0xA0
#define DA_RATE_R2_2 0xA4
#define DA_RATE_R2_3 0xA8
#define DA_RATE_R2_4 0xAC

#define DA_RATE_R3 0xB0
#define DA_RATE_R3_2 0xB4
#define DA_RATE_R3_3 0xB8
#define DA_RATE_R3_4 0xBC

#define DA_RATE_R4 0xC0
#define DA_RATE_R4_2 0xC4
#define DA_RATE_R4_3 0xC8
#define DA_RATE_R4_4 0xCC

#define DA_RATE_R5 0xD0
#define DA_RATE_R5_2 0xD4
#define DA_RATE_R5_3 0xD8
#define DA_RATE_R5_4 0xDC

#define DA_RATE_R6 0xE0
#define DA_RATE_R6_2 0xE4
#define DA_RATE_R6_3 0xE8
#define DA_RATE_R6_4 0xEC

#define DA_RATE_R7 0xF0
#define DA_RATE_R7_2 0xF4
#define DA_RATE_R7_3 0xF8
#define DA_RATE_R7_4 0xFC

#define DPRX_D_LANE_REG_OFFSET 0x1000
#define DPRX_CTLE_ADAPT0 0x100
#define DPRX_CTLE_ADAPT1 0x180
#define DPRX_CTLE_ADAPT2 0x200
#define DPRX_CTLE_ADAPT3 0x280
// end for phy register
#define IOMG_SE_10 0x728
#define IOMG_SE_11 0x72C
#define IOMG_SE_12 0x730
