...
#define DPTX_PHYIF_CTRL_RATE_INVALID	0xF

#define DPTX_PHYIF_MAX_LANE_COUNT_INVALID  0x0
#define DPTX_PHYIF_MAX_LANE_COUNT1  0x1
#define DPTX_PHYIF_MAX_LANE_COUNT2  0x2
#define DPTX_PHYIF_MAX_LANE_COUNT4  0x4
...
#define DP_SYMBOL_ERROR_COUNT_LANE3		0x218
#define DP_SYMBOL_ERROR_VALID			(1 << 7)
...
#define DP_LINK_BW_2_16				0x08
#define DP_LINK_BW_2_43				0x09
#define DP_LINK_BW_3_24				0x0C
#define DP_LINK_BW_4_32				0x10    /* 1.4 */
...
#define DP_DSC_ERROR_STATUS            0x20F

/* Private definition for sink device irq_hpd error check */
#define DP_SINK_ERROR_STATUS           0x30C
#define DP_SINK_ESD_ERROR              BIT(0)
...
#define DP_TEST_CRC_R_CR_LSB   0x240
#define DP_TEST_CRC_R_CR_MSB   0x241
#define DP_TEST_CRC_G_Y_LSB    0x242
#define DP_TEST_CRC_G_Y_MSB    0x243
#define DP_TEST_CRC_B_CB_LSB   0x244
#define DP_TEST_CRC_B_CB_MSB   0x245
...
/* Macro for edp backligt set */
#define EDP_BACKLIGHT_ADJUSTMENT_CAPABILITIES   0x702
#define EDP_DISPLAY_CONTROL                     0x720
#define EDP_BACKLIGHT_MODE_SET                  0x721
#define EDP_BACKLIGHT_BRIGHTNESS_MSB            0x722
#define EDP_BACKLIGHT_BRIGHTNESS_LSB            0x723
#define EDP_PWMGEN_BIT_COUNT                    0x724
#define EDP_PWMGEN_BIT_COUNT_CAP_MIN            0x725
#define EDP_PWMGEN_BIT_COUNT_CAP_MAX            0x726
#define EDP_CAPABILITIES_MSB_LSB_MODE           0x4
#define EDP_BACKLIGHT_HIGH_BIT_MASK             0xFF00
#define EDP_BACKLIGHT_LOW_BIT_MASK              0xFF
#define EDP_PWMGEN_BIT_VALUE                    0xE
#define EDP_BACKLIGHT_MAX_VALUE                 16383
