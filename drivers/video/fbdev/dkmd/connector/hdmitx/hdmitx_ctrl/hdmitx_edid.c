...
static u32 edid_add_established_modes(struct hdmitx_connector *connector, const struct edid *edid)
{
	...
	dpu_pr_info("hdmitx edid_add_established_modes");
...
static u32 edid_add_standard_modes(struct hdmitx_connector *connector, const struct edid *edid)
{
	...
	dpu_pr_info("hdmitx edid_add_standard_modes");
...
static u32 edid_add_detailed_modes(struct hdmitx_connector *connector, const struct edid *edid)
{
	...
	dpu_pr_info("hdmitx edid_add_detailed_modes");
...
static u32 edid_add_cea_modes(struct hdmitx_connector *connector, const struct edid *edid)
{
	...
	dpu_pr_info("hdmitx edid_add_cea_modes");
	...
	const u8 *hf_vsdb)
{
	...
	dpu_pr_info("display info max_frl_rate = %u, hf_vsdb[7] = %u", display->max_frl_rate, hf_vsdb[7]);
	...
	const struct edid *edid)
{
	...
	dpu_pr_info("edid_add_display_info, start = %u, end = %u", start, end);
	for_each_cea_db(edid_ext, i, start, end) {
		dpu_pr_info("edid_parse_cea_ext %u", i);
		db = &edid_ext[i];
