...
#define REG_GEN_PKT_HEADER 0x18A8 // static HDR
...
// hsdt1 crg
// dpc_pll select config
#define CLKDIV11                      0x0E0
#define SEL_PLL_HDMI0_MASK            GENMASK(24, 7)
#define SC_GT_CLK_PLL_HDMI0_MASK      GENMASK(22, 6)
#define DIV_PLL_HDMI0_MASK            GENMASK(21, 0)
...
#define GT_CLK_DPC_PLL_MASK         BIT(26)
#define DPC_PLL_EN_MASK             BIT(0)
#define DPC_PLL_BP_MASK             BIT(1)
#endif
