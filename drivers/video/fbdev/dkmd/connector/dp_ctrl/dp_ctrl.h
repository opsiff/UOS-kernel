...
struct dp_ctrl {
	...
	struct workqueue_struct *dptx_pluggable_wq;
	...
	void (*dpu_dp_intr_handle)(struct dp_ctrl *dptx, struct dkmd_isr *isr_ctrl, uint32_t intr_status);
	void (*dpu_dp_timing_isr_handle)(struct dp_ctrl *dptx, struct dkmd_isr *isr_ctrl, uint32_t timing_gen_irq_status);
