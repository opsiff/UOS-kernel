...
module_param_named(debug_ktz8864_msg_level, ktz8864_msg_level, int, 0640);
...
static DEVICE_ATTR(reg_bl, 0640, ktz8864_reg_bl_show, ktz8864_reg_bl_store);
...
static DEVICE_ATTR(reg, 0640, ktz8864_reg_show, ktz8864_reg_store);
