...
module_param_named(mdfx_kmsg_level, mdfx_debug_level, int, 0640);
...
static DEVICE_ATTR(debug_event,  (S_IRUSR | S_IRGRP | S_IWUSR), NULL, mdfx_debugger_event_store);
...
static DEVICE_ATTR(update_debugger, S_IRUSR | S_IRGRP, mdfx_show_debugger, NULL);
