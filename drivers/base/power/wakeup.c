...
#if (defined CONFIG_HUAWEI_SLEEPLOG) || (defined CONFIG_POWER_DUBAI)
...
#define wakeup_source_is_timerfd(ws_name) (ws_name != NULL && !strncmp(ws_name, "[timerfd]", 9))
#endif
...
#ifdef CONFIG_PM_FAIL_DEBUG
	if (wakeup_source_is_timerfd(ws->name))
