...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_connect(intf, &switch_result);
	if (switch_result)
		return -ENXIO;
#endif
...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_set_chip(chip);
#endif
...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_check_auto_suspend(dev);
#endif
...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_disconnect(intf);
#endif
...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_ctrl_wake_up(false);
#endif
...
#ifdef CONFIG_USB_AUDIO_DSP
	trace_hck_vh_usb_audio_ctrl_wake_up(true);
#endif
	return ret;
}
