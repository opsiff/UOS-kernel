...
hung_task_panic(struct notifier_block *this, unsigned long event, void *ptr)
{
	...
	trace_hck_set_did_panic(did_panic);
#endif
	return NOTIFY_DONE;
}
...
unsigned long hungtask_get_panic(void)
{
...
#ifdef CONFIG_DFX_HUNGTASK
	trace_hck_set_timeout_secs(sysctl_hung_task_timeout_secs);
#endif
