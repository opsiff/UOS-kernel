...
#if defined(CONFIG_DFX_TIME)
#define PREFIX_MAX		80
#elif defined(CONFIG_PRINTK_CALLER) /* !CONFIG_DFX_TIME */
#define PREFIX_MAX		48
#else /* !CONFIG_PRINTK_CALLER */
		     ...
		     const char *text, u16 text_len)
{
	...
	memcpy(&r.text_buf[0] + tmp_len, text, text_len - tmp_len);
#else
	/* fill message */
