...
#define PRMEM_WR_DATA							\
	__start_data_prmem_wr = .;			\
	*(.data..prmem_wr)						\
	__end_data_prmem_wr = .;

#define PRMEM_WR_AFTER_INIT_DATA					\
	__start_data_prmem_wr_after_init = .;		\
	*(.data..prmem_wr_after_init)					\
	__end_data_prmem_wr_after_init = .;

#define PRMEM_RW_DATA							\
	__start_data_prmem_rw = .;			\
	*(.data..prmem_rw)						\
	__end_data_prmem_rw = .;

#define PRMEM_POOLS(type)						\
	__start_data_##type##_prmem_pools = .;		\
	*(.data..##type##_prmem_pools)					\
	__end_data_##type##_prmem_pools = .;

#define PRMEM_OBJ_CACHES						\
	__start_data_prmem_object_caches = .;		\
	*(.data..prmem_object_caches)					\
	__end_data_prmem_object_caches = .;

#define PRMEM_POOLS_DATA						\
	__start_data_prmem_pools = .;			\
	__start_data_ro_no_recl_prmem_pools = .;	\
	*(.data..ro_no_recl_prmem_pools)				\
	__end_data_ro_no_recl_prmem_pools = .;		\
	__start_data_wr_no_recl_prmem_pools = .;	\
	*(.data..wr_no_recl_prmem_pools)				\
	__end_data_wr_no_recl_prmem_pools = .;		\
	__start_data_start_wr_no_recl_prmem_pools = .;	\
	*(.data..start_wr_no_recl_prmem_pools)				\
	__end_data_start_wr_no_recl_prmem_pools = .;	\
	__start_data_start_wr_recl_prmem_pools = .;	\
	*(.data..start_wr_recl_prmem_pools)				\
	__end_data_start_wr_recl_prmem_pools = .;	\
	__start_data_wr_recl_prmem_pools = .;		\
	*(.data..wr_recl_prmem_pools)					\
	__end_data_wr_recl_prmem_pools = .;		\
	__start_data_ro_recl_prmem_pools = .;		\
	*(.data..ro_recl_prmem_pools)					\
	__end_data_ro_recl_prmem_pools = .;		\
	__start_data_rw_recl_prmem_pools = .;		\
	*(.data..rw_recl_prmem_pools)					\
	__end_data_rw_recl_prmem_pools = .;		\
	__end_data_prmem_pools = .;
