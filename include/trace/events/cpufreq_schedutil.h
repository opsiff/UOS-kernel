...
#endif
#ifdef CONFIG_SCHED_COLOC_GROUP
		    __field(unsigned int,	coloc_grp_util)
#endif
...
#endif
#ifdef CONFIG_SCHED_COLOC_GROUP
		    __entry->coloc_grp_util = coloc_grp_util;
#endif
		    __entry->curr = curr;
...
TRACE_EVENT(cpufreq_schedutil_get_util,
	    ...
	    TP_printk("cpu=%u util=%lu max=%lu top=%lu pred=%lu,%lu,%lu iowait=%u flag=%#x ed=%u od=%u",
