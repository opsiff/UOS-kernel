...
struct dc_mmi_data {
	...
	int sc_succ_flag;
	int sc4_succ_flag;
	int set_test_status_delay_time;
	bool dc_mmi_test_flag;
	struct notifier_block dc_mmi_nb;
	struct delayed_work timeout_work;
	struct delayed_work set_test_status_work;
...
static inline bool dc_mmi_get_protocol_type(int *type)
{
	return false;
}
