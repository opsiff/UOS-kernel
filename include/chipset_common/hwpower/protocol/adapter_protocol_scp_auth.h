...
#define HWSCP_AUTH_RETRY_COUNT             150
#define HWSCP_AUTH_RETRY_INTERVAL_CYCLE    10
#define HWSCP_AUTH_RETRY_INTERVAL_BASE     30
#define HWSCP_AUTH_RETRY_INTERVAL_INC      25
