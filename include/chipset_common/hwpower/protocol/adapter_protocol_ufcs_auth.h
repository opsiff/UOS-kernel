...
#define HWUFCS_AUTH_RETRY_COUNT           150
#define HWUFCS_AUTH_RETRY_INTERVAL_CYCLE  10
#define HWUFCS_AUTH_RETRY_INTERVAL_BASE   30
#define HWUFCS_AUTH_RETRY_INTERVAL_INC    25
