...
#define HWSCP_POWER_A_MASK                  BIT(7)
#define HWSCP_POWER_A_SHIFT                 7
#define HWSCP_POWER_B_MASK                  (BIT(6) | BIT(5) | BIT(4) | \
	BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define HWSCP_POWER_B_SHIFT                 0
...
#define HWSCP_MAX_POWER_EXTEND              0x9d
#define HWSCP_MAX_POWER_EXTEND_TH           127 /* W */
