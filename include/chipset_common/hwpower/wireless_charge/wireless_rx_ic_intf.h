...
struct wlrx_ic_ops {
	...
	void (*set_scx_mode)(bool scx_mode, void *dev_data);
	int (*set_vout)(int vout, void *dev_data);
	int (*get_vrx_by_vfc_map)(int vtx, void *dev_data);
	int (*set_fod_coef)(const char *fod_str, void *dev_data);
	void (*set_turbo_chg_flag)(bool flag, void *dev_data);
	...
	void (*set_cur_pmode_name)(const char *cur_pmode_name, void *dev_data);
	void (*set_fod_offset)(u8 offset, void *dev_data);
};
...
void wlrx_ic_set_scx_mode(unsigned int type, bool scx_mode);
int wlrx_ic_set_vout(unsigned int type, int vout);
int wlrx_ic_get_vrx_by_vfc_map(unsigned int type, int vtx);
int wlrx_ic_set_fod_coef(unsigned int type, const char *fod_str);
void wlrx_ic_set_turbo_charge_flag(unsigned int type, bool flag);
...
void wlrx_ic_set_cur_pmode_name(unsigned int type, const char *cur_pmode_name);
void wlrx_ic_set_fod_offset(unsigned int type, u8 offset);
#else
...
static inline void wlrx_ic_set_scx_mode(unsigned int type, bool scx_mode)
{
}
...
static inline int wlrx_ic_get_vrx_by_vfc_map(unsigned int type, int vtx)
{
	return -EPERM;
}
...
static inline void wlrx_ic_set_turbo_charge_flag(unsigned int type, bool flag)
{
}
...
static inline void wlrx_ic_set_cur_pmode_name(unsigned int type, const char *cur_pmode_name)
{
}

static inline void wlrx_ic_set_fod_offset(unsigned int type, u8 offset)
{
}
