...
#define EMCOM_MPROUTER_MAX_MARK 16
...
#define MPFLOW_RUNNING 1
#define MPROUTER_RUNNING 2

#define WLAN0_RATIO  0
#define CELL0_RATIO  1
#define WLAN1_RATIO  2
#define CELL1_RATIO  3
#define WLAN2_RATIO  4
#define BURST_SIZE   5
#define LEAST_BURST_PATH_NUM 2
...
#define EMCOM_MPROUTE_VER_V1 3

#define EMCOM_MPFLOW_AI_RESET_DURATION msecs_to_jiffies(500)

#define EMCOM_MPFLOW_DEV_NUM  5
...
struct emcom_xengine_mpflow_ai_burst_port {
	...
	uint16_t launch_path; /* last match path */
