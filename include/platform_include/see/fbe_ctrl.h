...
#ifdef CONFIG_FBE3_1
	SEC_FILE_ENCRY_CMD_ID_GEN_SK = 0xD,
#endif
#ifdef CONFIG_FBE_S4
	SEC_FILE_ENCRY_CMD_ID_ADD_S4 = 0x20,
	SEC_FILE_ENCRY_CMD_ID_DELETE_S4 = 0x21,
	SEC_FILE_ENCRY_CMD_ID_RESTORE_S4 = 0x22,
#endif
	SEC_FILE_ENCRY_CMD_ID_MAX_SUPPORT,
};

#define SEC_FILE_ENCRY_CMD_ID_MASK 0xFF
#define FILE_ECE       2
...
#ifdef CONFIG_FBE3_1
#define FILE_ENCRY_GEN_SK_TYPE 0x00000001
#define FILE_ENCRY_RESTORE_SK_TYPE 0x00000002
#define FBE_CA_MSP_AVAILABLE 0x5A5AA5A5
#define FBE_CA_MSP_UNAVAILABLE 0xA5A55A5A
...
#else
static inline bool fbex_slot_clean(u32 slot) {return false; }
static inline void fbe3_flushcache_done(void) {}
static inline u32 fbex_enable_kdf(void) {return 0; }
static inline u32 fbex_gen_sk(uint32_t type _unused) {return 0; }
static u32 fbe_ca_msp_available(u32 *flag) {return 0; }
...
static inline u32 fbex_ca_lock_screen(u32 user, u32 file) {return 0; }
static inline u32 fbex_ca_unlock_screen(u32 user, u32 file, u8 *iv, u32 iv_len)
{
	return 0;
}
static inline void fbex_set_status(u32 user, bool lock) {}
#endif
