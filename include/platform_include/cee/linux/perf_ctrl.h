...
#define PERF_CTRL_SET_HECA_CONFIG \
	_IOW(PERF_CTRL_MAGIC, SET_HECA_CONFIG, struct task_config)
...
#define PERF_CTRL_SET_TASK_USERSPACE_THROTTLE \
	_IOW(PERF_CTRL_MAGIC, SET_TASK_USERSPACE_THROTTLE, struct task_config)
