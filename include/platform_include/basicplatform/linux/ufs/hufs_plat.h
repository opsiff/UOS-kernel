...
#define SCTRL_SCEFUSEDATA8_OFFSET 0x060
...
#define SCTRL_SCBAKDATA1_MASK_OFFSET 0x4C4
...
#define SCBAKDATA_SOC_SCTRL_SCBAKDATA1_MSK_ADDR(base)                   ((base) + (0x4C4))
...
#define PERI_AUTODIV1_OFFSET 0x6A0
...
#define GT_PCLK_AUTODIV_UFS_DFA_SYS UFS_BIT(25)
#define UFS_DFA_SYS_IDLE_BYPASS_DIS 0x1
#define UFS_DFA_SYS_DIV_AUTO_CFG_MASK 0x7E00000
#define UFS_DFA_SYS_DIV_AUTO_8_DIV (0x7 << 21)
/*
...
#define UFS_SELECT_PLL0 0x0C000400
...
/* hsdt xcltrl define */
#define HSDT0_QIC_SYSPDC_PWRD_REQ 0x424
#define HSDT0_QIC_SYSPDC_PWRD_ACK 0x428
#define PDC_DFA_SYSPDC_PWRD_REQ (0x1 << 2)
#define PDC_DFA_SYSPDC_PWRD_ACK (0x1 << 2)

/* ufs1 define */
#define UFS1_MEM_RETENTION_MASK 0xC0000000
#define IP_RST_UFS_CRG_HSDT1 (0x1 << 27)
#define IP_RST_UFS_SYS_SUBSYS_HSDT1 (0x1 << 26)
#define IP_RST_QIC_UFS_HCI (0x1 << 25)
#define UFS1_SUBSYS_CLK_DIV 0xFC000400
#define UFS1_MPHY_CLK_DIV 0x1E000600
#define GT_CLK_QIC_UFS_HCI_HSDT1 (0x1 << 4)
#define GT_CLK_UFS_SYS_SUBSYS_HSDT1 (0x1 << 1)
#define GT_CLK_UFS_MPHY_SYS_HSDT1 (0x1 << 0)
#define HSDT1_QIC_PDC_REQ_CTRL (0x314)
#define HSDT1_QIC_PDC_ACK_CTRL (0x318)
#define PDC_UFS_HCI_SYSPDC_PWRD_REQ 0x40000
#define PDC_UFS_HCI_SYSPDC_PWRD_ACK 0x4
#define UFS1_SYSCTRL_UFS_RESET_CTRL (REG_BASE_UFS1_SYS_CTRL_ADDR + 0x08)
...
#define ACTRL_HSDT1_MEM_CTRL0_OFFSET 0x9B4
#define HSDT1_CRG_PEREN1_OFFSET 0x10
#define HSDT1_CRG_PERDIS1_OFFSET 0x14
#define HSDT1_CRG_PERRSTEN0_OFFSET 0x20
#define HSDT1_CRG_PERRSTDIS0_OFFSET 0x24
#define HSDT1_CRG_PERRSTSTAT0_OFFSET 0x28
#define HSDT1_CRG_CLKDIV1_OFFSET 0xAC
#define CRGPERIPH_CLKDIV1_OFFSET 0xAC
...
#define HUFS_CONSISTENT_ACCESS UFS_BIT(23)
...
struct hufs_host {
	...
	void __iomem *hsdt1_crg;
	void __iomem *ao_crg;
	void __iomem *core_ctrl;
	void __iomem *hsdt_ctrl;
	void __iomem *hsdt1_ctrl;
