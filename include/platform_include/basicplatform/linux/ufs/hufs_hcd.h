...
#if defined(CONFIG_SCSI_UFS_AQUILA) || defined(CONFIG_SCSI_UFS_ARA)
...
#define UFS_VS_IS (DFA_HCI_CFG_OFFSET + 0x0254)
#define UFS_VS_IS_SET (DFA_HCI_CFG_OFFSET + 0x0258)
#define UFS_CFG_IDLE_TIME_THRESHOLD (DFA_HCI_CFG_OFFSET + 0x390)
#define UFS_CFG_IDLE_ENABLE (DFA_HCI_CFG_OFFSET + 0x3A4)
...
#define CFG_RX_CPORT_IDLE_CHK_EN UFS_BIT(21)
#define CFG_RX_CPORT_IDLE_TIMEOUT_TRSH (0xFF << 13)
#define BIT_SHIFT_DEV_TMT_TRSH 13
#define DEV_TMT_VAL 0x14
#else
...
#ifdef DSM_FOR_FACTORY_MODE
#ifdef CONFIG_UFS_4_0_HC
#define DEV_TMT_VAL_HH_V7 0xa
#else
#define DEV_TMT_VAL_HH_V7 0x64
#endif
#else
...
#define UFS_HW_PRESS_CFG (DFA_HCI_CFG_OFFSET + 0x200)
#define UFS_TR_TIMEOUT_STATUS (DFA_HCI_CFG_OFFSET + 0x250)
#define UFS_TRP_DFX0 (DFA_HCI_CFG_OFFSET + 0x290)
#define UFS_TRP_DFX1 (DFA_HCI_CFG_OFFSET + 0x294)
#define UFS_TRP_DFX2 (DFA_HCI_CFG_OFFSET + 0x298)
#define UFS_TRP_DFX3 (DFA_HCI_CFG_OFFSET + 0x29C)
#define UFS_UTP_RX_DFX0 (DFA_HCI_CFG_OFFSET + 0x2C0)
#define UFS_UTP_RX_DFX1 (DFA_HCI_CFG_OFFSET + 0x2C4)
#define UFS_UTP_RX_DFX2 (DFA_HCI_CFG_OFFSET + 0x2C8)
#define UFS_UTP_RX_DFX3 (DFA_HCI_CFG_OFFSET + 0x2CC)
#define UFS_UTP_RX_DFX4 (DFA_HCI_CFG_OFFSET + 0x2D0)
#define UFS_UTP_RX_NORM_NUM (DFA_HCI_CFG_OFFSET + 0x2D4)
#define UFS_UTP_RX_DISC_NUM (DFA_HCI_CFG_OFFSET + 0x2D8)
#define UFS_UTP_RX_DFX5 (DFA_HCI_CFG_OFFSET + 0x2DC)
#define UFS_DMA1_RX_DFX0 (DFA_HCI_CFG_OFFSET + 0x2F0)
#define UFS_DMA1_RX_DFX1 (DFA_HCI_CFG_OFFSET + 0x2F4)
#define UFS_DMA1_RX_DFX2 (DFA_HCI_CFG_OFFSET + 0x2F8)
#define UFS_DMA1_RX_DFX3 (DFA_HCI_CFG_OFFSET + 0x2FC)
#define UFS_DMA1_RX_AXI_ERR_ADDRL (DFA_HCI_CFG_OFFSET + 0x300)
#define UFS_DMA1_RX_AXI_ERR_ADDRU (DFA_HCI_CFG_OFFSET + 0x304)
#define TRP_MARB_DBR_NEW_DFX0 (DFA_HCI_CFG_OFFSET + 0x3B8)
...
#define UFS_IE_KEY_KDF_EN (DFA_HCI_CFG_OFFSET + 0x03AC)
...
/* HM_KERNEL: Reserve last 7 cores and 56 slots for UDK_UFS */
#define UTR_CORE_NUM 1
#define UTR_RESERVED_CORE_NUM 7
#define CORE_SLOT_NUM (UTR_CORE_NUM * SLOT_NUM_EACH_CORE)
...
#define HSDT1_INTR_HUB_UFS_GROUP 0
#define HSDT1_INTR_UFSHC_GIC_BIT 1
...
int ufshcd_get_sk_state(void);

enum ufs_sk_state{
	UFSHCD_SK_STATE_INVAL		= 0x0,
	UFSHCD_SK_STATE_AVABLE		= 0x1,
};

extern enum ufs_sk_state gufs_sk_state;
extern struct delayed_work fbx_gensk_worker;
#else
static inline int ufshcd_get_sk_state(void) { return 0; }
#endif
