...
/* smmu svm assign ssid range[64, 4096) */
#define SSID_ASSIGN_MIN  64
#define SSID_ASSIGN_MAX  4096
...
struct mm_svm *mm_svm_bind_task(struct device *dev, struct task_struct *task, u16 ssid);
...
struct mm_svm *mm_svm_bind_task(struct device *dev, u32 pid);
