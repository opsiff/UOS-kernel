...
struct coulometer_ops {
	...
	enum bat_model_bat_type (*get_cathode_type)(void);
};
...
static inline int coul_drv_battery_cc_cache(void)
{
	return -EPERM;
}
...
static inline enum bat_model_bat_type coul_drv_get_cathode_type(void)
{
