...
enum rpmb_op_type {
	...
	RPMB_OP_WR_DATA,
	RPMB_OP_WR_CNT,
	RPMB_OP_WR_PROTECT = 4,
	RPMB_OP_RD_PROTECT = 5,
};
...
#else
static inline int get_rpmb_key_status(void) {return 0;}
static inline u32 get_rpmb_support_key_num(void) {return 0;}
static inline int32_t mspc_exception_to_reset_rpmb(void) {return 0;}
static inline void mspc_report_rpmb(void) {}
static inline int get_rpmb_init_status(void) {return 0;}
#endif
