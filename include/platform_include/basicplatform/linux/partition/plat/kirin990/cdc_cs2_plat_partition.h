#ifndef _TAURUS_CDC_CS2_PLAT_PARTITION_H_
#define _TAURUS_CDC_CS2_PLAT_PARTITION_H_
...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_KPATCH,                    772 * 1024,   29 * 1024,    EMMC_USER_PART}, /* kpatch          29M    p50 */
    ...
    {PART_BOOT,                      630 * 1024,    31 * 1024, EMMC_USER_PART}, /* boot                31M p46 */
    {PART_RECOVERY,                  661 * 1024,    38 * 1024, EMMC_USER_PART}, /* recovery            38M p47 */
    {PART_ERECOVERY,                 699 * 1024,    38 * 1024, EMMC_USER_PART}, /* erecovery           38M p48 */
    {PART_METADATA,                  737 * 1024,    16 * 1024, EMMC_USER_PART}, /* metadata            16M p49 */
    {PART_KPATCH,                    753 * 1024,    48 * 1024, EMMC_USER_PART}, /* kpatch              48M p50 */
#else
    {PART_ERECOVERY_RAMDISK,         574 * 1024,    32 * 1024, EMMC_USER_PART}, /* erecovery_ramdisk   32M p44 */
    {PART_ERECOVERY_VENDOR,          606 * 1024,    16 * 1024, EMMC_USER_PART}, /* erecovery_vendor    16M p45 */
    {PART_BOOT,                      622 * 1024,    31 * 1024, EMMC_USER_PART}, /* boot                31M p46 */
    {PART_RECOVERY,                  653 * 1024,    42 * 1024, EMMC_USER_PART}, /* recovery            42M p47 */
    {PART_ERECOVERY,                 695 * 1024,    42 * 1024, EMMC_USER_PART}, /* erecovery           42M p48 */
    {PART_METADATA,                  737 * 1024,    16 * 1024, EMMC_USER_PART}, /* metadata            16M p49 */
    {PART_KPATCH,                    753 * 1024,    48 * 1024, EMMC_USER_PART}, /* kpatch              48M p50 */
#endif
    ...
    {PART_VBMETA,                    996 * 1024,    4 * 1024,    EMMC_USER_PART}, /* vbmeta             4M    p69 */
...
static struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT_A,                  622 * 1024,    31 * 1024, UFS_PART_3}, /* boot_a              31M p56 */
    ...
    {PART_BOOT_B,                  849 * 1024,    31 * 1024, UFS_PART_3}, /* boot_b              31M p63 */
    {PART_RECOVERY_B,              880 * 1024,    38 * 1024, UFS_PART_3}, /* recovery_b          38M p64 */
    {PART_ERECOVERY_B,             918 * 1024,    38 * 1024, UFS_PART_3}, /* erecovery_b         38M p65 */
    ...
    {PART_BOOT_A,                  614 * 1024,    31 * 1024, UFS_PART_3}, /* boot_a              31M p56 */
    ...
    {PART_BOOT_B,                  841 * 1024,    31 * 1024, UFS_PART_3}, /* boot_b              31M p63 */
