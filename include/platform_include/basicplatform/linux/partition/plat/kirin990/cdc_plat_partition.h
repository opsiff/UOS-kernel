#ifndef _TAURUS_CDC_PLAT_PARTITION_H_
#define _TAURUS_CDC_PLAT_PARTITION_H_
...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_BOOT,                      630 * 1024,   31 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,            661 * 1024,    38 * 1024, EMMC_USER_PART}, /* recovery            38MB p47 */
    {PART_ERECOVERY,           699 * 1024,    38 * 1024, EMMC_USER_PART}, /* erecovery           38MB p48 */
    {PART_METADATA,            737 * 1024,    16 * 1024, EMMC_USER_PART}, /* metadata            16MB p49 */
    {PART_KPATCH,              753 * 1024,    48 * 1024, EMMC_USER_PART}, /* kpatch              48MB p50 */
#else
    {PART_ERECOVERY_RAMDISK,         574 * 1024,   32 * 1024,    EMMC_USER_PART}, /* erecovery_ramdisk 32M    p44 */
    {PART_ERECOVERY_VENDOR,          606 * 1024,   16 * 1024,    EMMC_USER_PART}, /* erecovery_vendor  16M    p45 */
    {PART_BOOT,                      622 * 1024,   31 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,            653 * 1024,    42 * 1024, EMMC_USER_PART}, /* recovery            42MB p47 */
    {PART_ERECOVERY,           695 * 1024,    42 * 1024, EMMC_USER_PART}, /* erecovery           42MB p48 */
    {PART_METADATA,            737 * 1024,    16 * 1024, EMMC_USER_PART}, /* metadata            16MB p49 */
    {PART_KPATCH,              753 * 1024,    48 * 1024, EMMC_USER_PART}, /* kpatch              48MB p50 */
#endif
...
static struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT_A,                  622 * 1024,     31 * 1024,    UFS_PART_3}, /* boot_a              30M    p56 */
    {PART_RECOVERY_A,              653 * 1024,    38 * 1024, UFS_PART_3}, /* recovery_a              38M    p57 */
    {PART_ERECOVERY_A,             691 * 1024,    38 * 1024, UFS_PART_3}, /* erecovery_a             38M    p58 */
    ...
    {PART_BOOT_B,                  849 * 1024,     31 * 1024,    UFS_PART_3}, /* boot_b              30M    p63 */
    {PART_RECOVERY_B,              880 * 1024,    38 * 1024, UFS_PART_3}, /* recovery_b              38MB   p64 */
    {PART_ERECOVERY_B,             918 * 1024,    38 * 1024, UFS_PART_3}, /* erecovery_b             38MB   p65 */
    {PART_KPATCH_B,                956 * 1024,    48 * 1024, UFS_PART_3}, /* kpatch_b                48MB   p66 */
#else
    {PART_ERECOVERY_RAMDISK_A,     566 * 1024,     32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk_a 32M    p54 */
    {PART_ERECOVERY_VENDOR_A,      598 * 1024,     16 * 1024,    UFS_PART_3}, /* erecovery_vendor_a  16M    p55 */
    {PART_BOOT_A,                  614 * 1024,     31 * 1024,    UFS_PART_3}, /* boot_a              30M    p56 */
    {PART_RECOVERY_A,              645 * 1024,    42 * 1024, UFS_PART_3}, /* recovery_a              42M    p57 */
    {PART_ERECOVERY_A,             687 * 1024,    42 * 1024, UFS_PART_3}, /* erecovery_a             42M    p58 */
    {PART_METADATA,                729 * 1024,    16 * 1024, UFS_PART_3}, /* metadata                16M    p59 */
    {PART_KPATCH_A,                745 * 1024,    48 * 1024, UFS_PART_3}, /* kpatch_a                48M    p60 */
    {PART_ERECOVERY_RAMDISK_B,     793 * 1024,     32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk_b 32M    p61 */
    {PART_ERECOVERY_VENDOR_B,      825 * 1024,     16 * 1024,    UFS_PART_3}, /* erecovery_vendor_b  16M    p62 */
    {PART_BOOT_B,                  841 * 1024,     31 * 1024,    UFS_PART_3}, /* boot_b              30M    p63 */
    {PART_RECOVERY_B,              872 * 1024,    42 * 1024, UFS_PART_3}, /* recovery_b              42M    p64 */
    {PART_ERECOVERY_B,             914 * 1024,    42 * 1024, UFS_PART_3}, /* erecovery_b             42M    p65 */
