...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_SUPER,              1652 * 1024,  9956 * 1024, UFS_PART_3}, /* super             9956MB p84 */
    {PART_VERSION,           11608 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           12184 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p86 */
    {PART_HIBENCH_IMG,       13584 * 1024,   128 * 1024, UFS_PART_3}, /* hibench_img        128MB p87 */
    {PART_HIBENCH_DATA,      13712 * 1024,   512 * 1024, UFS_PART_3}, /* hibench_data       512MB p88 */
    {PART_FLASH_AGEING,      14224 * 1024,   512 * 1024, UFS_PART_3}, /* flash_ageing       512MB p89 */
    {PART_HIBENCH_LOG,       14736 * 1024,    32 * 1024, UFS_PART_3}, /* hibench_log         32MB p90 */
    {PART_HIBENCH_LPM3,      14768 * 1024,     2 * 1024, UFS_PART_3}, /* hibench_lpm3         2MB p91 */
    {PART_USERDATA,          14770 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p92 */
    ...
    {PART_SUPER,              1316 * 1024, 10988 * 1024, UFS_PART_3}, /* super             10988MB p84 */
    {PART_VERSION,           12304 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           12880 * 1024,  1144 * 1024, UFS_PART_3}, /* preload           1144MB p86 */
    {PART_USERDATA,          14024 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#else
    {PART_PREAS,              1252 * 1024,  1280 * 1024, UFS_PART_3}, /* preas             1280MB p82 */
    {PART_PREAVS,             2532 * 1024,    32 * 1024, UFS_PART_3}, /* preavs              32MB p83 */
    {PART_SUPER,              2564 * 1024, 10988 * 1024, UFS_PART_3}, /* super             10988MB p84 */
    {PART_VERSION,           13552 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p85 */
    {PART_PRELOAD,           14128 * 1024,  1144 * 1024, UFS_PART_3}, /* preload           1144MB p86 */
#if defined(CONFIG_BOOT_UEFI) && defined(CONFIG_PARTITION_ENG)
    {PART_FTTEST,            15272 * 1024,   192 * 1024, UFS_PART_3}, /* fttest             192MB p87 */
    {PART_DDRTEST,           15464 * 1024,    48 * 1024, UFS_PART_3}, /* ddrtest             48MB p88 */
    {PART_HITEST_GPU,        15512 * 1024,   512 * 1024, UFS_PART_3}, /* hitest_gpu         512MB p89 */
    {PART_HITEST_ASP_DHRYSTONE, 16024 * 1024,    20 * 1024, UFS_PART_3}, /* hitest_asp_dhrystone  20MB p90 */
    {PART_HITEST_ASP_TEST,   16044 * 1024,   300 * 1024, UFS_PART_3}, /* hitest_asp_test    300MB p91 */
    {PART_HITEST_SENSORHUB,  16344 * 1024,     6 * 1024, UFS_PART_3}, /* hitest_sensorhub     6MB p92 */
    {PART_HITEST_ISP,        16350 * 1024,    25 * 1024, UFS_PART_3}, /* hitest_isp          25MB p93 */
    {PART_HITEST_ISP_AVS,    16375 * 1024,    25 * 1024, UFS_PART_3}, /* hitest_isp_avs      25MB p94 */
    {PART_HITEST_NPU,        16400 * 1024,    80 * 1024, UFS_PART_3}, /* hitest_npu          80MB p95 */
    {PART_HITEST_DSS,        16480 * 1024,    18 * 1024, UFS_PART_3}, /* hitest_dss          18MB p96 */
    {PART_DSS_DISP_BUF,      16498 * 1024,    64 * 1024, UFS_PART_3}, /* dss_disp_buf        64MB p97 */
    {PART_HITEST_JPEGENC,    16562 * 1024,   200 * 1024, UFS_PART_3}, /* hitest_jpegenc     200MB p98 */
    {PART_HITEST_HIPP,       16762 * 1024,   100 * 1024, UFS_PART_3}, /* hitest_hipp        100MB p99 */
    {PART_HIBENCH_LPM3,      16862 * 1024,     2 * 1024, UFS_PART_3}, /* hibench_lpm3         2MB p100 */
    {PART_JPEG_DEC_TEST_SRC, 16864 * 1024,    20 * 1024, UFS_PART_3}, /* jpeg_dec_test_src   20MB p101 */
    {PART_JPEG_DEC_TEST_DEST, 16884 * 1024,    80 * 1024, UFS_PART_3}, /* jpeg_dec_test_dest  80MB p102 */
    {PART_VCODE_DATA,        16964 * 1024,   130 * 1024, UFS_PART_3}, /* vcode_data         130MB p103 */
    {PART_VCODE_MAX_DATA,    17094 * 1024,   140 * 1024, UFS_PART_3}, /* vcode_max_data     140MB p104 */
    {PART_MODEM_TSP_TEST,    17234 * 1024,    79 * 1024, UFS_PART_3}, /* modem_tsp_test      79MB p105 */
    {PART_MODEM_TSP_DT,      17313 * 1024,     1 * 1024, UFS_PART_3}, /* modem_tsp_dt      1024KB p106 */
    {PART_MODEM_TSP_AVS,     17314 * 1024,    80 * 1024, UFS_PART_3}, /* modem_tsp_avs       80MB p107 */
    {PART_MODEM_PDE_TEST,    17394 * 1024,     4 * 1024, UFS_PART_3}, /* modem_pde_test       4MB p108 */
    {PART_USERDATA,          17398 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p109 */
#else
    {PART_USERDATA,          15272 * 1024,(8UL) * 1024 * 1024, UFS_PART_3}, /* userdata        8G p87 */
#endif
#endif
    {"0", 0, 0, 0},
};
