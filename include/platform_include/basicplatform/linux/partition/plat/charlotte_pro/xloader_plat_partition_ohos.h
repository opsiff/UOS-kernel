...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_HIBENCH_IMG,          11741 * 1024,        128 * 1024,    UFS_PART_3}, /* hibench_img      128M    p87 */
    {PART_HIBENCH_LOG,          12893 * 1024,         32 * 1024,    UFS_PART_3}, /* hibench_log       32M    p90 */
#endif
#if defined(CONFIG_BOOT_UEFI) && defined(CONFIG_PARTITION_ENG)
#ifdef CONFIG_HISI_DEBUG_FS
    {PART_FTTEST,               11741 * 1024,   192 * 1024,    UFS_PART_3}, /* fttest           192M    p90 */
#endif
#ifdef XLOADER_DDR_TEST
    {PART_DDRTEST,              11933 * 1024,    48 * 1024,    UFS_PART_3}, /* ddrtest           48M    p91 */
#endif
