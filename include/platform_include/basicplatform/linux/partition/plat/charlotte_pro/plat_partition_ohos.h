...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_SEPLAT,              230 * 1024,     4 * 1024, UFS_PART_3}, /* seplat               4MB p81 */
    {PART_RESERVED2,     234 * 1024,  (16 * 1024 + 752), UFS_PART_3}, /* reserved2           21MB p17 */
    ...
    {PART_DACC,                507 * 1024,          256, UFS_PART_3}, /* dacc               512KB p34 */
...
#ifdef CONFIG_USE_HM_KERNEL
    {PART_ROOTFS,             1217 * 1024,   400 * 1024, UFS_PART_3}, /* rootfs             400MB p80 */
    {PART_KPATCH,             1617 * 1024,     4 * 1024, UFS_PART_3}, /* kpatch               4MB p81 */
    {PART_PATCH,              1621 * 1024,    32 * 1024, UFS_PART_3}, /* patch               32MB p82 */
    {PART_CUST,               1653 * 1024,    88 * 1024, UFS_PART_3}, /* cust                88MB p83 */
    {PART_CHIP_PROD,          1741 * 1024,   616 * 1024, UFS_PART_3}, /* chip_prod          616MB p84 */
    {PART_VENDOR,             2357 * 1024,   920 * 1024, UFS_PART_3}, /* vendor             920MB p85 */
    {PART_SYS_PROD,           3277 * 1024,  1936 * 1024, UFS_PART_3}, /* sys_prod          1936MB p86 */
    {PART_SYSTEM,             5213 * 1024,  3416 * 1024, UFS_PART_3}, /* system            3416MB p87 */
    {PART_HYPERHOLD,          8629 * 1024,  1536 * 1024, UFS_PART_3}, /* hyperhold         1536MB p88 */
    {PART_RESERVED5,         10165 * 1024,   137 * 1024, UFS_PART_3}, /* reserved5          137MB p89 */
    {PART_VERSION,           10302 * 1024,   576 * 1024, UFS_PART_3}, /* version            576MB p90 */
    {PART_PRELOAD,           10878 * 1024,  1400 * 1024, UFS_PART_3}, /* preload           1400MB p91 */
    {PART_USERDATA,          12278 * 1024,(16UL) * 1024 * 1024, UFS_PART_3}, /* userdata        6G p92 */
#else
    ...
    {PART_CHIP_PROD,          1341 * 1024,   616 * 1024, UFS_PART_3}, /* chip_prod          616MB p83 */
    {PART_VENDOR,             1957 * 1024,   920 * 1024, UFS_PART_3}, /* vendor             920MB p84 */
    {PART_SYS_PROD,           2877 * 1024,  1936 * 1024, UFS_PART_3}, /* sys_prod          1936MB p85 */
    {PART_SYSTEM,             4813 * 1024,  3416 * 1024, UFS_PART_3}, /* system            3416MB p86 */
    {PART_HYPERHOLD,          8229 * 1024,  1536 * 1024, UFS_PART_3}, /* hyperhold         1536MB p87 */
