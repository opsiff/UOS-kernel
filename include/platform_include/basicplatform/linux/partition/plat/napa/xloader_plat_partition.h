...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_HIBENCH_IMG,         12472 * 1024,    128 * 1024,    EMMC_USER_PART}, /* hibench_img      128M    p76 */
    {PART_HIBENCH_LOG,         13624 * 1024,     32 * 1024,    EMMC_USER_PART}, /* HIBENCH_LOG       32M    p79 */
#endif
#ifdef CONFIG_HISI_DEBUG_FS
    {PART_FTTEST,          12.5 * 1024 * 1024,    192 * 1024,    EMMC_USER_PART}, /* fttest        192M */
#endif
#ifdef XLOADER_DDR_TEST
    {PART_DDRTEST,         12.5 * 1024 * 1024 + 934 * 1024,     48 * 1024,    EMMC_USER_PART}, /* ddrtest          48M */
#endif
    {"0", 0, 0, 0},
};
...
#ifdef FACTORY_VERSION
    {PART_HIBENCH_IMG,         12464 * 1024,    128 * 1024,    UFS_PART_3}, /* hibench_img      128M    p72 */
    {PART_HIBENCH_LOG,         13616 * 1024,     32 * 1024,    UFS_PART_3}, /* HIBENCH_LOG       32M    p75 */
#endif
#ifdef CONFIG_HISI_DEBUG_FS
    {PART_FTTEST,          24 * 1024 * 1024,    192 * 1024,    UFS_PART_3}, /* fttest       192M */
#endif
#ifdef XLOADER_DDR_TEST
    {PART_DDRTEST,         12.5 * 1024 * 1024 + 934 * 1024,    48 * 1024,     UFS_PART_3}, /* ddrtest         48M */
#endif
    {"0", 0, 0, 0},
};
