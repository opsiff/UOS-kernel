...
#if defined(CONFIG_MMC_SDHCI_ZODIAC_ANTLIA)
#define GPIO_DEFAULT_NUMBER_FOR_SD_CLK      128
#define GPIO_DEFAULT_NUMBER_FOR_SD_CMD      129
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA0    130
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA1    131
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA2    132
#define GPIO_DEFAULT_NUMBER_FOR_SD_DATA3    133

#define IOMG_BASE_GPIO_128 0xE8303000
#define IOMG_BASE_GPIO_PD_128 0xE8304000
#define IOCG_BASE_GPIO_128 0xE8304800
#else
