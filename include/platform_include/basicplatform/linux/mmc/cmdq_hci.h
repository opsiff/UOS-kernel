...
/* attribute fields */
#define cq_valid(x)	((x & 1) << 0)
#define cq_end(x)		(((x) & 1) << 1)
#define cq_int(x)		((x & 1) << 2)
#define cq_act(x)		((x & 0x7) << 3)

/* data command task descriptor fields */
#define cmdq_forced_prog(x)	((x & 1) << 6)
#define cmdq_context(x)	((x & 0xF) << 7)
#define cmdq_data_tag(x)	((x & 1) << 11)
#define cmdq_data_dir(x)	((x & 1) << 12)
#define cmdq_priority(x)	((x & 1) << 13)
#define cmdq_qbar(x)		((x & 1) << 14)
#define cmdq_rel_write(x)	((x & 1) << 15)
#define cmdq_blk_count(x)	((x & 0xFFFF) << 16)
#define cmdq_blk_addr(x)	((x & 0xFFFFFFFF) << 32)

/* direct command task descriptor fields */
#define cmd_index(x)	((x & 0x3F) << 16)
#define cmd_timing(x)	((x & 1) << 22)
#define cq_resp_type(x)	((x & 0x3) << 23)
