...
typedef struct _tag_hwlaser_calibration_data_3 {
    uint32_t                              struct_version;
    hwlaser_customer_nvm_managed_t        customer;
    hwlaser_dmax_calibration_data_t       fmt_dmax_cal;
    hwlaser_dmax_calibration_data_t       cust_dmax_cal;
    hwlaser_additional_offset_cal_data_t  add_off_cal_data;
    hwlaser_optical_centre_t              optical_centre;
    hwlaser_xtalk_histogram_data_t        xtalkhisto;
    hwlaser_gain_calibration_data_t       gain_cal;
    hwlaser_cal_peak_rate_map_t           cal_peak_rate_map;
...
typedef struct _tag_hwlaser_calibration_data_L3 {
    hwlaser_calibration_FOV               HW_FOV;
    hwlaser_calibration_data_3            RAW_CalibData;
...
#define TOF8801_OFFSET_DATA_SIZE 14
typedef struct _tag_hwlaser_calibration_data_L4 { /* ams */
	unsigned int xtalk;
	unsigned char offset_data[TOF8801_OFFSET_DATA_SIZE];
} hwlaser_calibration_data_L4;
...
typedef struct __tag_hwlaser_calibration_data {
    ...
    union laser_calibration_data{
        ...
        hwlaser_calibration_data_L3  dataL3; /* vl53l3 */
        hwlaser_calibration_data_L4  dataL4; /* tof880x */
    }u;
...
typedef struct _tag_hwlaser_ranging_data
{
    union hwlaser_measurement_data
    {
        ...
        hwlaser_RangingData_simple   data_1; /* tof8801 */
    }u;
...
#define HWLASER_CALIBRATION_OFFSET_SIMPLE    7
...
typedef struct _tag_hwlaser_ioctl_freq_param {
    uint32_t freq;
} hwlaser_ioctl_freq_param_t;
...
#define HWLASER_IOCTL_SET_FREQ                 _IOWR('M', BASE_VIDIOC_PRIVATE + 14, hwlaser_ioctl_freq_param_t)
