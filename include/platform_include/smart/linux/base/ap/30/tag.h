...
enum obj_tag {
	...
	TAG_CAP_PROX1,
	TAG_SOUND,
	TAG_AUX_END = TAG_SOUND, /* aux_end 44 */
	TAG_THERMOMETER,
	TAG_DEBUGS = TAG_THERMOMETER,
	...
	// all tags need do recovery, put it between TAG_EXTEND_BEGIN and TAG_AUX_EXTEND_END
	TAG_EXTEND_BEGIN = 200, // don't change its value
	TAG_ACC2 = TAG_EXTEND_BEGIN,
	TAG_GYRO2,
	TAG_AUDIO_FUSION = 210,
	TAG_AUX_EXTEND_END,
	TAG_EXTEND_END = 230, // don't change its value
	TAG_DBG = 0xFD,
	TAG_END = 0xFF
};
#endif
