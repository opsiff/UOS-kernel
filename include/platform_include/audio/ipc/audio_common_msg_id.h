...
enum AUDIO_COMMON_MSG_ENUM {
    ...
    ID_AP_AUDIO_PLAY_SET_BUF_WATERLINE_REQ  = 0xDD61, /* The AP notifies the HiFi set new buf waterline command */
    ID_AUDIO_AP_PLAY_SET_BUF_WATERLINE_CNF  = 0xDD62, /* dsp set new buf waterline audio player call back AP confirm */
    ...
    ID_HIFI_RDA_MSG_ABNORMAL_CMD        = 0xDE06, /* dsp notifies RDA message abnormal */
    ID_AP_HIFI_CHIME_STOP_CMD           = 0xDE07, /* The AP to stop HiFi chime request command */
    ID_HIFI_AP_CHIME_STOP_CNF_CMD       = 0xDE08, /* dsp stop chime call back AP confirm */

    /* dsp notifies RDA that hifi is reset */
    ID_HIFI_RDA_RESET_MSG_CMD           = 0xDE10,
    ...
    ID_AP_AUDIO_CMD_SET_SCO_SCENE       = 0xDF14,
    ...
    /* OH mmap */
    ID_AP_AUDIO_MMAP_GET_POSITION = 0xFF14, /* acpu->dsp */
    ID_AUDIO_AP_MMAP_POSITION_ACK = 0xFF15, /* dsp->acpu */

    /* dsp info */
    ID_AP_AUDIO_GET_DSP_INFO = 0xFF16, /* acpu->dsp */
    ID_AP_AUDIO_GET_DSP_INFO_ACK = 0xFF17, /* dsp->acpu */
};
