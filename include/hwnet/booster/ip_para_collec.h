...
#define TCP_RECOVER_ESTIMATE_TIME_THR 5000 // ms
#define TIME_MAX_RECOVER_SRTT 120 // ms
#define TIME_MAX_RECOVER_OFO_RTT 3000 // ms
...
#define TCP_RECOVER_PORT 443
#define TCP_RECOVER_FORBIDDEN_TIME (60 * 60 * HZ)
