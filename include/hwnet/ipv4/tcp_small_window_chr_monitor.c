...
#else
	return single_open(file, tcp_small_window_show, inode);
#endif
}
...
#else
static const struct proc_ops g_tcp_small_window_seq_fops = {
	.proc_open = tcp_small_window_open,
	.proc_read = seq_read,
	.proc_write = tcp_small_window_write,
...
#else
	return single_open(file, tcp_small_win_cnt_show, inode);
#endif
}
...
#else
static const struct proc_ops g_tcp_small_win_cnt_seq_fops = {
	.proc_open = tcp_small_win_cnt_open,
	.proc_read = seq_read,
	.proc_write = tcp_small_win_cnt_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
#endif
...
#else
	return single_open(file, tcp_min_report_time_show, inode);
#endif
}
...
#else
static const struct proc_ops g_tcp_min_report_time_seq_fops = {
	.proc_open = tcp_min_report_time_open,
	.proc_read = seq_read,
	.proc_write = tcp_min_report_time_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
#endif
...
#else
	return single_open(file, tcp_max_report_cnt_show, inode);
#endif
}
...
#else
static const struct proc_ops g_tcp_max_report_cnt_seq_fops = {
	.proc_open = tcp_max_report_cnt_open,
	.proc_read = seq_read,
	.proc_write = tcp_max_report_cnt_write,
	.proc_lseek = seq_lseek,
	.proc_release = single_release,
};
#endif
