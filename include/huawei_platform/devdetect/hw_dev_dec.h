...
enum dev_check_type {               /* id */
	...
	DEV_I2C_HUMITURE,           /* 45 used in kernel layer */
	DEV_I2C_FORCE_TOUCH,        /* 46 used in kernel layer */
	DEV_I2C_POWER_MCU,          /* 47 used in kernel layer */
	DEV_I2C_MAX,                /* MAX 48 */
};
...
static const struct dev_detect_type dev_detect_table[] = {
	...
	{ DEV_I2C_HUMITURE, "humiture" },            /* id : 45 in number 46 */
	{ DEV_I2C_FORCE_TOUCH, "forcetouch" },       /* id : 46 in number 47 */
	{ DEV_I2C_POWER_MCU,   "hc32l10_mcu" },      /* id : 47 in number 48 */
};
