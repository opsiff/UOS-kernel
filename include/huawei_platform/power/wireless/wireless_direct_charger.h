...
#define WLDC_DFT_MAX_CP_IOUT              9000
...
enum wldc_iin_thermal_channel_type {
	...
	WLDC_SC_SINGLE_CHANNEL = WLDC_CHANNEL_TYPE_BEGIN,
	WLDC_SC_DUAL_CHANNEL,
	WLDC_LVC_SINGLE_CHANNEL,
	WLDC_SC4_SINGLE_CHANNEL,
	WLDC_SC4_DUAL_CHANNEL,
