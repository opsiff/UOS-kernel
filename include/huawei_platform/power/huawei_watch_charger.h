...
enum {
	WIRELESS_CHARGE_NORMAL = 0,
	WIRELESS_CHARGE_QUICK  = 1,
};
...
struct mcu_chg_info {
	...
	int bat_charge_now;
	/* quich charger status 0:normal 1:quick charger */
...
#define MCU_REPORT_BUFFER_LEN       (INFO_MAX * RESOLVE_STEP_LEN)
