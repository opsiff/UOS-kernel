...
#define BST_IOC_SYNC_PROP_STOP_IPV6 _IOW(BST_IOC_MAGIC, 42, \
	struct bst_sock_comm_prop_ipv6)
#define BST_IOC_CHECK_MAC_ADDRESS_AVAILABLE _IOW(BST_IOC_MAGIC, 44, struct bst_sock_id)

#define BST_IOC_SOCK_CMD_MIN 1
#define BST_IOC_SOCK_CMD_MAX 44
...
#define BST_IOC_CHECK_MAC_ADDRESS_AVAILABLE_ID 44
...
enum bst_ind_type {
	...
	BST_IND_WIFI_ROAMED_EVENT,
	BST_IND_SENSORHUB_RESET
};
...
struct bst_mac_address_comm_prop {
	struct bst_sock_comm_prop comm_prop;
