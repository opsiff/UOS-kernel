...
extern void xreclaimer_cond_quick_reclaim(struct task_struct *tsk, int sig);
#else
extern void xreclaimer_cond_quick_reclaim(struct task_struct *tsk, int sig,
...
extern void xreclaimer_exit_mmap_locked(struct mm_struct *mm);
#else
#if (KERNEL_VERSION(5, 10, 0) <= LINUX_VERSION_CODE)
...
static inline void xreclaimer_exit_mmap_locked(struct mm_struct *mm)
{
}
#endif
#endif
