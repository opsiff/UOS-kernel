...
extern void anon_vma_sign(struct vm_area_struct *vma,
				const char __user *name);
extern inline bool acc_swapin_enable(void);
extern inline u64 get_tuning_swapout_cnt_value(void);
#else
static inline bool acc_swapin_enable(void)
{
	return false;
}

static inline u64 get_tuning_swapout_cnt_value(void)
{
	return 0;
}
#endif

extern inline u64 get_shrink_sys_cnt_value(void);
extern inline u64 get_skrink_sys_page_value(void);

extern pid_t get_kswapd_pid(void);
extern void set_kswapd_pid(pid_t pid);
