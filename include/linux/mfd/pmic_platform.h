...
#ifdef CONFIG_PMIC_VM_DRV
int pmic_get_dieid_vm(char *dieid, unsigned int len);
int pmic_subpmu_get_dieid_vm(char *dieid, unsigned int len);
#else
...
#else
static inline void pmu_set_bt_power_enable(int enable)
{
}
static inline void pmu_set_bt_enable(int enable)
{
}
static inline void pmu_set_uwb_enable(int enable)
{
}
static inline int pmu_get_bt_power_status(void)
{
	return 0;
}
static inline int pmu_get_bt_status(void)
{
	return 0;
}
static inline int pmu_get_uwb_status(void)
{
	return 0;
}
static inline void pmu_set_offd_flag(int flag)
{
}
static inline int pmu_get_offd_flag(void)
{
	return 0;
}
static inline void pmu_set_offd_time(int time)
{
}
#endif
