...
static inline int mem_cgroup_charge_nonprotect(struct page *page, struct mm_struct *mm,
				    gfp_t gfp_mask)
{
	if (mem_cgroup_disabled())
		return 0;
	return __mem_cgroup_charge_nonprotect(page, mm, gfp_mask, false);
}
#else
				    ...
				    gfp_t gfp_mask)
{
	if (mem_cgroup_disabled())
		return 0;
#ifdef CONFIG_PROTECT_LRU_ENHANCED
	return __mem_cgroup_charge_nonprotect(page, mm, gfp_mask, true);
#else
