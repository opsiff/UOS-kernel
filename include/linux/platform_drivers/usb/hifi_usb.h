 ...
 * This function should used when switch to poweroff mode.
 */
...
#else
static inline int usb_start_hifi_usb(struct usb_device *udev)
{
	return -1;
}
static inline int usb_start_hifi_usb_reset_power(struct usb_device *udev)
{
	return -1;
}
static inline void usb_stop_hifi_usb_by_portid(int portid)
{
}
static inline void usb_stop_hifi_usb(struct usb_device *udev)
{
}
static inline void usb_stop_hifi_usb_reset_power(struct usb_device *udev)
{
}
...
static inline int usb_find_portid_by_udev(struct usb_device *udev)
{
	return 0;
}
static inline bool is_hifi_usb_in_used(void)
{
	return false;
}
