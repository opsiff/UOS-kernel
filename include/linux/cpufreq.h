...
#ifdef CONFIG_CPU_FREQ_GOV_SCHEDUTIL_OPT
	struct sugov_policy	*cached_sugov_policy;
#endif
#ifdef CONFIG_CPU_FREQ_GOV_MIPS
	struct mipsgov_policy	*cached_mipsgov_policy;
#endif
	void			*governor_data;
...
extern unsigned int adjust_freq_buf(unsigned int max_freq, struct cpufreq_policy *policy);
#endif
