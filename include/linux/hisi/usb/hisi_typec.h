...
/* typec status */
enum tcpc_typec_status {
	TCPC_TYPEC_NONE, /* typec status unknow */
	TCPC_TYPEC_DETACHED, /* typec detached */
	TCPC_TYPEC_DEVICE_ATTACHED, /* this device act as device */
	TCPC_TYPEC_HOST_ATTACHED, /* this device act as host */
	TCPC_TYPEC_AUDIO_ATTACHED, /* this device detect analog andio plug in */
	TCPC_TYPEC_AUDIO_DETACHED, /* this device detect analog andio plug out */
};
...
#else
static inline int hisi_usb_typec_set_wake_lock(bool wake_lock_en) { return 0; }
#endif

#ifdef CONFIG_VENDOR_USB_TYPEC
bool hisi_usb_typec_sourcing_vbus(void);
#else
static inline bool hisi_usb_typec_sourcing_vbus(void) { return false; }
#endif
