...
typedef enum pm_s4_logo_state {
	PM_S4_LOGO_STATE_START = 1,
	PM_S4_LOGO_STATE_LOAD_IMG = 2,
	PM_S4_LOGO_STATE_STOP = 3,
	PM_S4_LOGO_STATE_EXIT = 4,
} pm_s4_logo_state_t;

extern int register_pm_logo_notifier(struct notifier_block *nb);
#endif
