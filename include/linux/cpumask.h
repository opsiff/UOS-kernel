...
extern struct cpumask __cpu_primary_mask;
extern struct cpumask __cpu_secondary_mask;
#endif
...
#endif
#ifdef CONFIG_SCHED_SMT_USER_HIDE
#define cpu_primary_mask ((const struct cpumask *)&__cpu_primary_mask)
#define cpu_secondary_mask ((const struct cpumask *)&__cpu_secondary_mask)
#endif
...
#ifdef CONFIG_SCHED_SMT_USER_HIDE
#define primary_cpu(cpu)	cpumask_test_cpu((cpu), cpu_primary_mask)
#define secondary_cpu(cpu)	cpumask_test_cpu((cpu), cpu_secondary_mask)
#define num_primary_cpus()	cpumask_weight(cpu_primary_mask)
#define num_secondary_cpus()	cpumask_weight(cpu_secondary_mask)
#endif
...
#ifdef CONFIG_SCHED_SMT_USER_HIDE
#define primary_cpu(cpu)	0
#define secondary_cpu(cpu)	0
#define num_primary_cpus()	0
#define num_secondary_cpus()	0
#endif
#endif
