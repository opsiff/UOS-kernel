...
#define VDR_TAS_RSSI_REPORT (301)
		...
		case EVENT_DRV_WIFI_EVENT:
#define VDR_WIFI_EVENT_REPORT (303)
			/* 302 is occupied in wificond */
			pr_info("receive VDR_WIFI_EVENT_REPORT (303)");
			cfg80211_do_drv_private_params(wdev->netdev, GFP_KERNEL,
				NL80211_CMD_VDR_COMMON, VDR_WIFI_EVENT_REPORT,
				ev->dc.ie, ev->dc.ie_len);
			break;
#endif
		}
