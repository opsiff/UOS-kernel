...
enum peripheral_temp_chanel {
	...
	DETECT_PA_2_CHANEL,
	DETECT_PA_S_CHANEL,
	DETECT_DDR_TYPE_CHANEL,
	DETECT_DDR_SPEED_CHANEL,
	DETECT_DDR_SWAP_CHANEL,
	DETECT_DRMOS_ID_CHANEL,
	DETECT_DRMOS_CPUB_CHANEL,
	DETECT_DRMOS_CPUM_CHANEL,
	DETECT_DRMOS_GPU_NPU_CHANEL,
	DETECT_R1272_AUX_CHANEL,
	DETECT_PMU_A_CHANEL,
	DETECT_PMU_B_CHANEL
};
...
char *peripheral_chanel[] = {
	...
	[DETECT_DDR_TYPE_CHANEL] = "ddr_type",
	[DETECT_DDR_SPEED_CHANEL] = "ddr_speed",
	[DETECT_DDR_SWAP_CHANEL] = "ddr_swap",
	[DETECT_DRMOS_ID_CHANEL] = "drmos_id",
	[DETECT_DRMOS_CPUB_CHANEL] = "drmos_cpub",
	[DETECT_DRMOS_CPUM_CHANEL] = "drmos_cpum",
	[DETECT_DRMOS_GPU_NPU_CHANEL] = "drmos_gpu_npu",
	[DETECT_R1272_AUX_CHANEL] = "r1272_aux",
	[DETECT_PMU_A_CHANEL] = "pmu_a",
	[DETECT_PMU_B_CHANEL] = "pmu_b"
};
...
int peripheral_tm_target(union ipc_data *tm_ipc, int *value)
{
	int ret;
	u32 ack_buffer[2] = {0};
	struct cmd_parse *ipc_cmd = (struct cmd_parse *)&ack_buffer[0];
