...
#ifndef CONFIG_NPU_PM_FFA_TRANSPORT
...
static int npu_pm_hardlock_get(void)
{
#ifndef CONFIG_NPU_PM_FFA_TRANSPORT
	return hwspin_lock_timeout(g_npu_pm_hwlock, NPU_PM_LOCK_TIMEOUT);
#else
	return 0;
#endif
}

static void npu_pm_hardlock_put(void)
{
#ifndef CONFIG_NPU_PM_FFA_TRANSPORT
...
static int npu_pm_hwspinlock_init(struct device *dev __maybe_unused)
{
#ifndef CONFIG_NPU_PM_FFA_TRANSPORT
