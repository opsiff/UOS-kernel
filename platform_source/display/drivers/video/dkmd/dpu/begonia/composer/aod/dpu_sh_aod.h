...
static inline void dp_wait_for_aod_stop(struct dpu_composer *dpu_comp) {};
static inline void dpu_restore_fast_unblank_status(struct dpu_composer *dpu_comp) {};
static inline int dpu_blank_peri_handle(uint32_t panel_id, int blank_mode) { return 0; };
static inline int dpu_sh_dmabuf_map_iova(uint64_t *iova, struct dma_buf *buf, uint32_t size) { return 0; };
static inline void dpu_sh_dmabuf_unmap_iova(uint64_t iova, struct dma_buf *dmabuf) {};
static inline int dpu_sensorhub_aod_dvfs_vote(uint32_t seq_num) { return true; };
static inline int32_t dpu_sensorhub_peri_handle(uint32_t panel_id, int32_t blank_mode) { return 0; };
#endif
