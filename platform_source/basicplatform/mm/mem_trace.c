/*
 * mm/platform_drivers/mem_trace.c
 *
...
static size_t get_stats_slub(void)
{
	...
	return pages_to_byte(global_node_page_state(NR_SLAB_UNRECLAIMABLE_B));
#else
...
unsigned int record_threshold = MM_ALLOC_DEBUG_MAX_LATENCY_US;
void mm_set_record_threshold(unsigned int value)
{
