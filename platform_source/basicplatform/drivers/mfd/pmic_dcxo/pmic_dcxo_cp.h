...
#ifndef	__PMIC_CP_DCXO_H
#define	__PMIC_CP_DCXO_H

#include <pmic_interface.h>
#ifdef CONFIG_PMIC_AP_DCXO
...
#elif defined(PMIC_NP_XO_CTRL0_ADDR)
#define PMIC_DCXO_CFIX1  PMIC_NP_XO_CTRL0_ADDR(0)
#define PMIC_DCXO_CFIX2  PMIC_NP_XO_CTRL1_ADDR(0)
#else
