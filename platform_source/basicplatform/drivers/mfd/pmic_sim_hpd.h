...
/* main pmic sim hpd process interface */
	...
	defined(CONFIG_PMIC_21BV100_PMU)

#include <pmic_interface.h>

#define PMIC_SIM_HPD_EN 1

#if defined (PMIC_IRQ1_ADDR)
...
#elif defined (PMIC_IRQ_L3_SIM_HPD_ADDR)
#define SIM_IRQ_ADDR PMIC_IRQ_L3_SIM_HPD_ADDR(0)
#define SIM0_HPD_R_MASK BIT(PMIC_IRQ_L3_SIM_HPD_sim0_hpd_r_START)
#define SIM0_HPD_F_MASK BIT(PMIC_IRQ_L3_SIM_HPD_sim0_hpd_f_START)
#define SIM1_HPD_R_MASK BIT(PMIC_IRQ_L3_SIM_HPD_sim1_hpd_r_START)
#define SIM1_HPD_F_MASK BIT(PMIC_IRQ_L3_SIM_HPD_sim1_hpd_f_START)
#endif
