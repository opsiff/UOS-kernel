...
static u32 g_lpmcu_rdr_flag = false;
...
static void rdr_addr_send_lpm3(void)
{
	...
	if (g_lpmcu_rdr_ddr_addr != NULL && g_lpmcu_rdr_flag == false) {
...
static int __init early_parse_vm_reboot_flag(char *cmdline)
{
	if (cmdline != NULL && *cmdline == '0')
		g_lpmcu_rdr_flag = true;
	else
		g_lpmcu_rdr_flag = false;
	return 0;
}
early_param("vm_first_start_flag", early_parse_vm_reboot_flag);
#endif
