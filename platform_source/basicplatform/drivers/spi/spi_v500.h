...
#define SSP_MIS(r) ((r) + 0x024) /* after mask interrupt status register */
#define SSP_ICR(r) ((r) + 0x028) /* interrupt clear register */
#ifdef CONFIG_SPI_DMA_DIFF
#define SSP_DMA_CTRL(r)  ((r) + 0x100) /* interrupt clear register */
#define SSP_SDMA_ADDR_H_R(r) ((r) + 0x104) /* rx buffer addr high */
#define SSP_SDMA_ADDR_L_R(r) ((r) + 0x108) /* rx buffer addr low */
#define SSP_SDMA_ADDR_H_W(r) ((r) + 0x10c) /* tx buffer addr high */
#define SSP_SDMA_ADDR_L_W(r) ((r) + 0x110) /* tx buffer addr low */
#define SSP_DMA_CMD_START(r) ((r) + 0x124) /* exclusive dma enable */
#define INTR_SPI_DMA_MASK(r) ((r) + 0x128) /* exclusive dma irq mask */
#define INTR_SPI_DMA_CLR(r) ((r) + 0x12c) /* exclusive dma irq clr */
#define INTR_SPI_DMA_RAW(r) ((r) + 0x130) /* exclusive dma irq row */
#define INTR_SPI_DMA(r) ((r) + 0x134)     /* exclusive dma irq */
#else
...
#define  SPI_RATIO_MASK   0xFFFF0
#define  SPI_RATIO_START  4
#define  SPI_RATIO_CLEAR  0xFFF0000F
#define  STS_CFG_BAKDATA_OFFSET 0x4cc
#define  STS_CFG_BAKDATA_HIGH_MASK 0xFFFF0000
#endif
