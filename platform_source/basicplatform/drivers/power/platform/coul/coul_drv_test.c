	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((di == NULL) || (kstrtol(buf, HEX, &val) < 0) || (val < 0)) /* size */
		return -EINVAL;
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((di == NULL) || (kstrtol(buf, DEC, &val) < 0) || (val < 0) || (val > 1)) /* size */
		return -EINVAL;
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_batt_exist;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* size */
}
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((di == NULL) || (kstrtol(buf, DEC, &val) < 0) || (val < 0) || (val > CAPACITY_MAX)) /* capacity */
		return -EINVAL;
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_batt_capacity;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* size */
}
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((di == NULL) || (kstrtol(buf, DEC, &val) < 0) ||
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_batt_temp;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* size */
}
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_batt_full;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* size */
}
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_batt_fcc;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* size */
}
	...
	struct device_attribute *attr, const char *buf, size_t count)
{
	...
	if ((di == NULL) || (kstrtol(buf, HEX, &val) < 0) ||
	...
	struct device_attribute *attr, char *buf)
{
	...
	val = (unsigned long)di->input_event;
	return snprintf_s(buf, PAGE_SIZE, SRC_LEN, "%lu\n", val); /* buf size */
}
