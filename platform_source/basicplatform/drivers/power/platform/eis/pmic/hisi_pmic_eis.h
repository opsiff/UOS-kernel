...
#define CUR_FREQ_THRES_H_ERR_500UOHM  140 /* unit: mA */
#define CUR_FREQ_THRES_L_ERR_500UOHM  140 /* unit: mA */
#define VOL_REF_MV              1800 /* unit: mV */
#define DIGIT2ANA_MAG           10000
#define CUR_TOTAL_STEP          4095
#define R_OHM_1M                1000 /* unit: uohm */
#define R_OHM_2M                2000 /* unit: uohm */
#define R_OHM_5M                5000 /* unit: uohm */
#define R_OHM_500               500  /* unit: uohm */
...
#define EIS_I_CURRENT_H         PMIC_EIS_I_CURRENT_H_ADDR(0) /* 0xA032 */
...
#define EIS_IRQ                 PMIC_EIS_IRQ_ADDR(0) /* 0x023C */
#define EIS_IRQ_MASK            PMIC_IRQ_MASK_16_ADDR(0) /* 0x0222 */
...
#else /* CONFIG_COUL_PMIC6X21BV100 */
#define EIS_IRQ                 PMIC_IRQ_L3_EIS_ADDR(0) /* 0x01B8 */
#define EIS_IRQ_MASK            PMIC_IRQ_L3_EIS_MASK_ADDR(0) /* 0x01E8 */
#endif
