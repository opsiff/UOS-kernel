...
#ifdef CONFIG_UART_FIFO_OFFSET_DIFF
#define UART_TX_FIFO               0x400 /* Data written to the interface */
#define UART_RX_FIFO               0x800 /* Data read from the interface */
#else
...
#define UART_V500_CFG_FIFO_EN      0x04000400 /* UART FIFO enable */
...
#define UART_V500_CFG_FIFO_DIS     0x04000000 /* UART FIFO disable */
...
#define UART_V500_INT_DSRS      (1 << 10) /* data device ready interrupt status */
#define UART_V500_INT_DCDS      (1 << 9) /* data carrier detect interrupt status */
#define UART_V500_INT_RIS       (1 << 8) /* ring alert nterrupt status */
...
#define UART_V500_INT_DSRM      (1 << 10) /* data device ready interrupt mask */
#define UART_V500_INT_DCDM      (1 << 9) /* data carrier detect interrupt mask */
#define UART_V500_INT_RIM       (1 << 8) /* ring alert nterrupt mask */
...
#define UART_V500_INT_DSRC      (1 << 10) /* data device ready interrupt clear */
#define UART_V500_INT_DCDC      (1 << 9) /* data carrier detect interrupt clear */
#define UART_V500_INT_RIC       (1 << 8) /* ring alert nterrupt clear */
...
#define UART_V500_MSK_INT_ALL           0x7FF
