...
#define MAX_PERIMEM_DVS_DUMP_REG_NUM   6
#define MAX_PERI_DVS_VOTE_WIDTH        3
...
struct peri_dvs_mediabus {
	...
	struct clk         *pll_clks[DVFS_MAX_VOLT_NUM];
...
struct peri_dvs_config {
	...
	unsigned int  perimem_dvs_enabled;
#ifdef CONFIG_CLK_DEBUG
	int dump_reg_num;
	unsigned int dump_reg[MAX_PERI_DVS_DUMP_REG_NUM];
	int dump_perimem_reg_num;
	unsigned int dump_perimem_reg[MAX_PERIMEM_DVS_DUMP_REG_NUM];
#endif
};
