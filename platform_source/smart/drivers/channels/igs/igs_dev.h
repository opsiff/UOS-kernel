...
#define IGS_IOCTL_IGS_SENSOR_SETS    _IOW(IGS_IO, 0xDA, short)
#endif
...
struct igs_set_sensor_t {
	u32 sensor_type;
	u32 sensor_para1;
	u32 sensor_para2;
};

struct igs_set_sensor_resp_t {
	u32 ret_code;
	u32 sensor_type;
	u32 sensor_para1;
	u32 sensor_para2;
...
struct igs_set_sensor_param_t {
	struct igs_set_sensor_t set;
