 ...
 * History       :  2021/11/15 16:49:08 Create file
 */
...
#define IPP_TOP_BUS_CFG0_REG               0x0   /* configure register for top axi path */
...
#define IPP_TOP_MEM_CTRL_BP_REG            0x2C  /* BPRAM configure register for subsys */
...
#define IPP_TOP_KLT_CRG_CFG0_REG           0x4C0 /* CRG config register for clk */
#define IPP_TOP_KLT_CRG_CFG1_REG           0x4C4 /* CRG configure register for reset */
#define IPP_TOP_KLT_MEM_CFG_REG            0x4C8 /* SRAM configure register for CPE MCF */
#define IPP_TOP_KLT_IRQ_REG0_REG           0x4CC /* IRQ related cfg register */
#define IPP_TOP_KLT_IRQ_REG1_REG           0x4D0 /* IRQ related cfg register */
#define IPP_TOP_KLT_IRQ_REG2_REG           0x4D4 /* IRQ related cfg register */
#define IPP_TOP_KLT_IRQ_REG3_REG           0x4D8 /* IRQ related cfg register */
#define IPP_TOP_KLT_IRQ_REG4_REG           0x4DC /* IRQ related cfg register */
...
#define IPP_TOP_SMMU_IN_AXCACHE_REG        0x720 /* axcache to smmu input */
#define IPP_TOP_ARPPBUSCONTROL_REG         0x724 /* control the arpp internal bus */
