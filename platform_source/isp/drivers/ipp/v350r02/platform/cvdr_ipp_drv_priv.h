...
union u_cvdr_ipp_nr_wr_limiter_6 {
	struct {
		...
		unsigned int    rsv_42                       : 8  ; /* [23:16] */
		unsigned int    nrwr_access_limiter_reload_6 : 4  ; /* [27:24] */
		unsigned int    rsv_43                       : 4  ; /* [31:28] */
	} bits;

	unsigned int    u32;
};

union u_cvdr_ipp_nr_wr_debug_6{
	struct {
		unsigned int    nr_wr_debug_6 : 32  ; /* [31:0] */
	} bits;
...
union u_cvdr_ipp_vp_rd_lwg_0 {
	...
	struct {
		...
		unsigned int    rsv_52           : 9  ; /* [23:15] */
		unsigned int    vprd_ihleft_0    : 6  ; /* [29:24] Number of pixels to crop at each line start */
		unsigned int	rsv_53	         : 2  ; /* [31:30] */
	} bits;
...
union u_cvdr_ipp_vp_rd_limiter_0 {
	...
	struct {
		...
		unsigned int    rsv_58                       : 8  ; /* [23:16] */
		unsigned int    vprd_access_limiter_reload_0 : 4  ; /* [27:24] */
		unsigned int    rsv_59                       : 4  ; /* [31:28] */
	} bits;
...
union u_cvdr_ipp_vp_wr_limiter_0 {
	...
	struct {
		...
		unsigned int    rsv_142                      : 8  ; /* [23:16] */
		unsigned int    vpwr_access_limiter_reload_0 : 4  ; /* [27:24] */
		unsigned int    rsv_143                      : 4  ; /* [31:28] */
	} bits;
