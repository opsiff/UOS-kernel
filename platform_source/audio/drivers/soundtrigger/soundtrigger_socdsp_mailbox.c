...
static bool g_is_mad_open = false;
...
static int soundtrigger_mailbox_send_data(const void *pmsg_body, uint32_t msg_len, uint32_t msg_priority)
{
	uint32_t ret;
...
bool get_mad_open_status(void)
{
	return g_is_mad_open;
}
