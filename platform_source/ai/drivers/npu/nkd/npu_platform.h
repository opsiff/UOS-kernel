...
enum npu_register_index {
	...
	NPU_REG_AIC_SMMU_0_CFG_BASE,
	NPU_REG_AIC_SMMU_1_CFG_BASE,
	NPU_REG_TS_TBU_BASE,
#endif
...
enum npu_irq_index {
	...
	NPU_IRQ_EASC,
#ifdef CONFIG_NPU_ECC
	NPU_IRQ_MECC_TBU_CORE0,
	NPU_IRQ_MECC_TBU_CORE1,
	NPU_IRQ_MECC_TBU_TS,
	NPU_IRQ_DECC_TBU_CORE0,
	NPU_IRQ_DECC_TBU_CORE1,
	NPU_IRQ_DECC_TBU_TS,
#endif
};
...
struct npu_resource_adapter {
	...
	int (*npu_mailbox_send)(void *mailbox, unsigned long mailbox_len,
...
struct npu_dts_info {
	...
	int irq_easc;
#ifdef CONFIG_NPU_ECC
	int irq_ecc_err[NPU_IRQ_ECC_MAX];
#endif
	u32 tscpu_cluster;
	u32 tscpu_core;
...
struct npu_resmem_info {
	...
	struct npu_mem_desc *ffrt_mdc_buf;
	struct npu_mem_desc *ffrt_swap_buf;
#endif
#ifdef CONFIG_NPU_ISPNN_INFO
	struct npu_mem_desc *ispnn_info_buf;
#endif
};
