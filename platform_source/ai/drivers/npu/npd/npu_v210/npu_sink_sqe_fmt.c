...
static void add_model_event_id(npu_model_desc_info_t *model_desc_info, u16 event_id)
{
	// uint8_t bit map
...
static void format_evt_rec_sqe(void *hwts_sqe_addr, npu_rt_task_t *hwts_task,
	npu_model_desc_info_t *model_desc_info)
{
...
static void format_wait_evt_sqe(void *hwts_sqe_addr, npu_rt_task_t *hwts_task,
	npu_model_desc_info_t *model_desc_info)
{
...
static void format_memcpy_task(void *hwts_sqe_addr, npu_rt_task_t *hwts_task,
	npu_model_desc_info_t *model_desc_info)
{
	...
	memcpy_sqe->length = (unsigned int)(hwts_task->u.memcpy_task.length);
