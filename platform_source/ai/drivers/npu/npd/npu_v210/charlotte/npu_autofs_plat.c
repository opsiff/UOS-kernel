...
static void npu_autofs_npubus_on(void *autofs_crg_vaddr)
{
...
static void npu_autofs_npubuscfg_on(void *autofs_crg_vaddr)
{
...
static void npu_autofs_npubus_aicore_on(void *autofs_crg_vaddr)
{
...
static void npu_autofs_npubus_off(void *autofs_crg_vaddr)
{
...
static void npu_autofs_npubuscfg_off(void *autofs_crg_vaddr)
{
...
static void npu_autofs_npubus_aicore_off(void *autofs_crg_vaddr)
{
...
{
	npu_autofs_npubus_on(autofs_crg_vaddr);
	npu_autofs_npubuscfg_on(autofs_crg_vaddr);
	npu_autofs_npubus_aicore_on(autofs_crg_vaddr);
}

void npu_autofs_off(void *autofs_crg_vaddr)
{
	npu_autofs_npubus_aicore_off(autofs_crg_vaddr);
	npu_autofs_npubuscfg_off(autofs_crg_vaddr);
	npu_autofs_npubus_off(autofs_crg_vaddr);
}
