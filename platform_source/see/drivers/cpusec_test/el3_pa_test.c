...
#define GET_PA_RESTRICTION_VAL   0xCA00000A
...
void get_el3_pa_restriction_val(void)
{
	u64 val;

	val = smc_to_atf(GET_PA_RESTRICTION_VAL, 0, 0, 0);
	pr_err("EL3 PA Restriction reg val is 0x%llx\n", val);
}