...
#define TOF8801_APP0_MAX_DATA_SIZE          (TOF8801_APP0_DATA_END - TOF8801_APP0_DATA_START + 1)
#define TOF8801_APP0_OFFSET(x)              ((x) - 0x20)
#define TOF8801_APP0_IS_MEAS_CMD(x)         (((x) >= OL_COMMAND_ASYNC_MIN) && ((x) <= OL_COMMAND_ASYNC_MAX))
...
#define TOF8801_APP0_MAX_NUM_HIST_BINS      ((TOF8801_APP0_MAX_HIST_BYTE_SIZE) / (TOF8801_APP0_HIST_BIN_SIZE))
...
#define TOF8801_INT_MASK                    (TOF8801_INT1 | TOF8801_INT2 | TOF8801_INT3 | TOF8801_INT4)
#define LSB(x)                              ((x) & 0xFF)
...
#define tof8801_infomsg(str, args...) \
	 pr_info("%s: " str, __func__, ##args)
#define tof8801_dbgmsg(str, args...) \
	 pr_debug("%s: " str, __func__, ##args)
#define tof8801_errmsg(str, args...) \
