...
#define LOG_FUNCTION_START(fmt, ...) \
	_LOG_FUNCTION_START(VL53L3_TRACE_MODULE_REGISTERS, fmt, ##__VA_ARGS__)
#define LOG_FUNCTION_END(status, ...) \
	_LOG_FUNCTION_END(VL53L3_TRACE_MODULE_REGISTERS, status, ##__VA_ARGS__)
#define LOG_FUNCTION_END_FMT(status, fmt, ...) \
	_LOG_FUNCTION_END_FMT(VL53L3_TRACE_MODULE_REGISTERS,\
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_STATIC_NVM_MANAGED_I2C_SIZE_BYTES)
	...
	VL53L3_static_nvm_managed_t  *pdata)
{
	...
	pdata->ana_config__fast_osc__trim =
		(*(pbuffer +   4)) & 0x7F;
	pdata->osc_measured__fast_osc__frequency =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   5));
	pdata->vhv_config__timeout_macrop_loop_bound =
		(*(pbuffer +   7));
	pdata->vhv_config__count_thresh =
		(*(pbuffer +   8));
	...
	VL53L3_static_nvm_managed_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_STATIC_NVM_MANAGED_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_static_nvm_managed(
			pdata,
			VL53L3_STATIC_NVM_MANAGED_I2C_SIZE_BYTES,
			comms_buffer);

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_I2C_SLAVE__DEVICE_ADDRESS,
			comms_buffer,
			VL53L3_STATIC_NVM_MANAGED_I2C_SIZE_BYTES);
	...
	VL53L3_static_nvm_managed_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_static_nvm_managed(
			VL53L3_STATIC_NVM_MANAGED_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_CUSTOMER_NVM_MANAGED_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_customer_nvm_managed_t  *pdata)
{
	...
	pdata->ref_spad_man__ref_location =
		(*(pbuffer +   8)) & 0x3;
	pdata->algo__crosstalk_compensation_plane_offset_kcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   9));
	pdata->algo__crosstalk_compensation_x_plane_gradient_kcps =
		(VL53L3_i2c_decode_int16_t(2, pbuffer +  11));
	pdata->algo__crosstalk_compensation_y_plane_gradient_kcps =
		(VL53L3_i2c_decode_int16_t(2, pbuffer +  13));
	pdata->ref_spad_char__total_rate_target_mcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  15));
	pdata->algo__part_to_part_range_offset_mm =
		(VL53L3_i2c_decode_int16_t(2, pbuffer +  17)) & 0x1FFF;
	pdata->mm_config__inner_offset_mm =
		(VL53L3_i2c_decode_int16_t(2, pbuffer +  19));
	pdata->mm_config__outer_offset_mm =
		(VL53L3_i2c_decode_int16_t(2, pbuffer +  21));
	...
	VL53L3_customer_nvm_managed_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_CUSTOMER_NVM_MANAGED_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_customer_nvm_managed(
			pdata,
	...
	VL53L3_customer_nvm_managed_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_customer_nvm_managed(
			VL53L3_CUSTOMER_NVM_MANAGED_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_STATIC_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_static_config_t    *pdata)
{
	...
	pdata->dss_config__target_total_rate_mcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   0));
	pdata->debug__ctrl =
		(*(pbuffer +   2)) & 0x1;
	...
	pdata->spare_host_config__static_config_spare_1 =
		(*(pbuffer +  23));
	pdata->algo__range_ignore_threshold_mcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  24));
	pdata->algo__range_ignore_valid_height_mm =
		(*(pbuffer +  26));
	pdata->algo__range_min_clip =
		(*(pbuffer +  27));
	...
	VL53L3_static_config_t    *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_STATIC_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_static_config(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_DSS_CONFIG__TARGET_TOTAL_RATE_MCPS,
			comms_buffer,
			VL53L3_STATIC_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_static_config_t    *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_static_config(
			VL53L3_STATIC_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_GENERAL_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_general_config_t   *pdata)
{
	...
	pdata->cal_config__repeat_rate =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   4)) & 0xFFF;
	...
	pdata->dss_config__roi_mode_control =
		(*(pbuffer +  11)) & 0x7;
	pdata->system__thresh_rate_high =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  12));
	pdata->system__thresh_rate_low =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  14));
	pdata->dss_config__manual_effective_spads_select =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  16));
	pdata->dss_config__manual_block_select =
		(*(pbuffer +  18));
	pdata->dss_config__aperture_attenuation =
		(*(pbuffer +  19));
	...
	VL53L3_general_config_t   *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_GENERAL_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_general_config(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_GPH_CONFIG__STREAM_COUNT_UPDATE_VALUE,
			comms_buffer,
			VL53L3_GENERAL_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_general_config_t   *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_general_config(
			VL53L3_GENERAL_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_TIMING_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_timing_config_t    *pdata)
{
	...
	pdata->range_config__vcsel_period_b =
		(*(pbuffer +   9)) & 0x3F;
	pdata->range_config__sigma_thresh =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  10));
	pdata->range_config__min_count_rate_rtn_limit_mcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  12));
	pdata->range_config__valid_phase_low =
		(*(pbuffer +  14));
	pdata->range_config__valid_phase_high =
		(*(pbuffer +  15));
	pdata->system__intermeasurement_period =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  18));
	...
	VL53L3_timing_config_t    *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_TIMING_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_timing_config(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_MM_CONFIG__TIMEOUT_MACROP_A_HI,
			comms_buffer,
			VL53L3_TIMING_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_timing_config_t    *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_timing_config(
			VL53L3_TIMING_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_DYNAMIC_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_dynamic_config_t   *pdata)
{
	...
	pdata->system__grouped_parameter_hold_0 =
		(*(pbuffer +   0)) & 0x3;
	pdata->system__thresh_high =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   1));
	pdata->system__thresh_low =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   3));
	...
	VL53L3_dynamic_config_t   *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_DYNAMIC_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_dynamic_config(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_SYSTEM__GROUPED_PARAMETER_HOLD_0,
			comms_buffer,
			VL53L3_DYNAMIC_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_dynamic_config_t   *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_dynamic_config(
			VL53L3_DYNAMIC_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_SYSTEM_CONTROL_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_system_control_t   *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_SYSTEM_CONTROL_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_system_control(
			pdata,
	...
	VL53L3_system_control_t   *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_system_control(
			VL53L3_SYSTEM_CONTROL_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_SYSTEM_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_system_results_t   *pdata)
{
	...
	pdata->result__peak_signal_count_rate_mcps_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   6));
	pdata->result__ambient_count_rate_mcps_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   8));
	pdata->result__sigma_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  10));
	pdata->result__phase_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  12));
	...
	pdata->result__peak_signal_count_rate_crosstalk_corrected_mcps_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  16));
	pdata->result__mm_inner_actual_effective_spads_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  18));
	pdata->result__mm_outer_actual_effective_spads_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  20));
	pdata->result__avg_signal_count_rate_mcps_sd0 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  22));
	pdata->result__dss_actual_effective_spads_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  24));
	pdata->result__peak_signal_count_rate_mcps_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  26));
	pdata->result__ambient_count_rate_mcps_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  28));
	pdata->result__sigma_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  30));
	pdata->result__phase_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  32));
	pdata->result__final_crosstalk_corrected_range_mm_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  34));
	pdata->result__spare_0_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  36));
	pdata->result__spare_1_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  38));
	pdata->result__spare_2_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  40));
	pdata->result__spare_3_sd1 =
		(*(pbuffer +  42));
	pdata->result__thresh_info =
		(*(pbuffer +  43));
	...
	VL53L3_system_results_t   *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_SYSTEM_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_system_results(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_RESULT__INTERRUPT_STATUS,
			comms_buffer,
			VL53L3_SYSTEM_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_system_results_t   *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_system_results(
			VL53L3_SYSTEM_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_CORE_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_core_results_t     *pdata)
{
	...
	pdata->result_core__ambient_window_events_sd0 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +   0));
	pdata->result_core__ranging_total_events_sd0 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +   4));
	pdata->result_core__signal_total_events_sd0 =
		(VL53L3_i2c_decode_int32_t(4, pbuffer +   8));
	pdata->result_core__total_periods_elapsed_sd0 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  12));
	pdata->result_core__ambient_window_events_sd1 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  16));
	pdata->result_core__ranging_total_events_sd1 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  20));
	pdata->result_core__signal_total_events_sd1 =
		(VL53L3_i2c_decode_int32_t(4, pbuffer +  24));
	pdata->result_core__total_periods_elapsed_sd1 =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  28));
	pdata->result_core__spare_0 =
		(*(pbuffer +  32));
	...
	VL53L3_core_results_t     *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_CORE_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_core_results(
			pdata,
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_RESULT_CORE__AMBIENT_WINDOW_EVENTS_SD0,
			comms_buffer,
			VL53L3_CORE_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_core_results_t     *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_core_results(
			VL53L3_CORE_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_DEBUG_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_debug_results_t    *pdata)
{
	...
	pdata->result__osc_calibrate_val =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   8)) & 0x3FF;
	...
	pdata->firmware__cal_repeat_rate_counter =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  18)) & 0xFFF;
	pdata->gph__system__thresh_high =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  22));
	pdata->gph__system__thresh_low =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  24));
	...
	pdata->pad_startup_mode__value_ctrl =
		(*(pbuffer +  45)) & 0x3F;
	pdata->pll_period_us =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  46)) & 0x3FFFF;
	pdata->interrupt_scheduler__data_out =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  50));
	...
	VL53L3_debug_results_t    *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_DEBUG_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_debug_results(
			pdata,
	...
	VL53L3_debug_results_t    *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_debug_results(
			VL53L3_DEBUG_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_NVM_COPY_DATA_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_nvm_copy_data_t    *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_NVM_COPY_DATA_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_nvm_copy_data(
			pdata,
			VL53L3_NVM_COPY_DATA_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_IDENTIFICATION__MODEL_ID,
			comms_buffer,
			VL53L3_NVM_COPY_DATA_I2C_SIZE_BYTES);
	...
	VL53L3_nvm_copy_data_t    *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_nvm_copy_data(
			VL53L3_NVM_COPY_DATA_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_PREV_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_prev_shadow_system_results_t  *pdata)
{
	...
	pdata->prev_shadow_result__spare_2_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  40));
	pdata->prev_shadow_result__spare_3_sd1 =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  42));
	...
	VL53L3_prev_shadow_system_results_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_PREV_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_prev_shadow_system_results(
			pdata,
			VL53L3_PREV_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_PREV_SHADOW_RESULT__INTERRUPT_STATUS,
			comms_buffer,
			VL53L3_PREV_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_prev_shadow_system_results_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_prev_shadow_system_results(
			VL53L3_PREV_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_PREV_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_prev_shadow_core_results_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_PREV_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_prev_shadow_core_results(
			pdata,
			VL53L3_PREV_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
		Dev,
		VL53L3_PREV_SHADOW_RESULT_CORE__AMBIENT_WINDOW_EVENTS_SD0,
		comms_buffer,
		VL53L3_PREV_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_prev_shadow_core_results_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_prev_shadow_core_results(
			VL53L3_PREV_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_PATCH_DEBUG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_patch_debug_t      *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_PATCH_DEBUG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_patch_debug(
			pdata,
			VL53L3_PATCH_DEBUG_I2C_SIZE_BYTES,
			comms_buffer);
	...
	VL53L3_patch_debug_t      *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_patch_debug(
			VL53L3_PATCH_DEBUG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_GPH_GENERAL_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_gph_general_config_t  *pdata)
{
	...
	pdata->gph__system__thresh_rate_high =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   0));
	pdata->gph__system__thresh_rate_low =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +   2));
	pdata->gph__system__interrupt_config_gpio =
		(*(pbuffer +   4));
	...
	VL53L3_gph_general_config_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_GPH_GENERAL_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_gph_general_config(
			pdata,
			VL53L3_GPH_GENERAL_CONFIG_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_GPH__SYSTEM__THRESH_RATE_HIGH,
			comms_buffer,
			VL53L3_GPH_GENERAL_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_gph_general_config_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_gph_general_config(
			VL53L3_GPH_GENERAL_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_GPH_STATIC_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_gph_static_config_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_GPH_STATIC_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_gph_static_config(
			pdata,
			VL53L3_GPH_STATIC_CONFIG_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_GPH__DSS_CONFIG__ROI_MODE_CONTROL,
			comms_buffer,
			VL53L3_GPH_STATIC_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_gph_static_config_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_gph_static_config(
			VL53L3_GPH_STATIC_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_GPH_TIMING_CONFIG_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_gph_timing_config_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_GPH_TIMING_CONFIG_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_gph_timing_config(
			pdata,
			VL53L3_GPH_TIMING_CONFIG_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_GPH__MM_CONFIG__TIMEOUT_MACROP_A_HI,
			comms_buffer,
			VL53L3_GPH_TIMING_CONFIG_I2C_SIZE_BYTES);
	...
	VL53L3_gph_timing_config_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_gph_timing_config(
			VL53L3_GPH_TIMING_CONFIG_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_FW_INTERNAL_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_fw_internal_t      *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_FW_INTERNAL_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_fw_internal(
			pdata,
			VL53L3_FW_INTERNAL_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_FIRMWARE__INTERNAL_STREAM_COUNT_DIV,
			comms_buffer,
			VL53L3_FW_INTERNAL_I2C_SIZE_BYTES);
	...
	VL53L3_fw_internal_t      *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_fw_internal(
			VL53L3_FW_INTERNAL_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_PATCH_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_patch_results_t    *pdata)
{
	...
	pdata->sigma_estimator_calc__spare_0 =
		(*(pbuffer +  44));
	pdata->vhv_result__peak_signal_rate_mcps =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  46));
	pdata->vhv_result__signal_total_events_ref =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  48));
	pdata->phasecal_result__phase_output_ref =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  52));
	pdata->dss_result__total_rate_per_spad =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  54));
	pdata->dss_result__enabled_blocks =
		(*(pbuffer +  56));
	pdata->dss_result__num_requested_spads =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  58));
	pdata->mm_result__inner_intersection_rate =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  62));
	pdata->mm_result__outer_complement_rate =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  64));
	pdata->mm_result__total_offset =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  66));
	pdata->xtalk_calc__xtalk_for_enabled_spads =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  68)) & 0xFFFFFF;
	pdata->xtalk_result__avg_xtalk_user_roi_kcps =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  72)) & 0xFFFFFF;
	pdata->xtalk_result__avg_xtalk_mm_inner_roi_kcps =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  76)) & 0xFFFFFF;
	pdata->xtalk_result__avg_xtalk_mm_outer_roi_kcps =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  80)) & 0xFFFFFF;
	pdata->range_result__accum_phase =
		(VL53L3_i2c_decode_uint32_t(4, pbuffer +  84));
	pdata->range_result__offset_corrected_range =
		(VL53L3_i2c_decode_uint16_t(2, pbuffer +  88));
	...
	VL53L3_patch_results_t    *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_PATCH_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_patch_results(
			pdata,
			VL53L3_PATCH_RESULTS_I2C_SIZE_BYTES,
			comms_buffer);
	...
	VL53L3_patch_results_t    *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_patch_results(
			VL53L3_PATCH_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_shadow_system_results_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_shadow_system_results(
			pdata,
			VL53L3_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_SHADOW_PHASECAL_RESULT__VCSEL_START,
			comms_buffer,
			VL53L3_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_shadow_system_results_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_shadow_system_results(
			VL53L3_SHADOW_SYSTEM_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
	...
	uint8_t                  *pbuffer)
{
	...
	if (buf_size < VL53L3_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES)
		return VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL;
	...
	VL53L3_shadow_core_results_t  *pdata)
{
	...
	VL53L3_Error status = VL53L3_ERROR_NONE;
	uint8_t comms_buffer[VL53L3_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES];

	LOG_FUNCTION_START("");

	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_encode_shadow_core_results(
			pdata,
			VL53L3_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES,
			comms_buffer);
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_WriteMulti(
			Dev,
			VL53L3_SHADOW_RESULT_CORE__AMBIENT_WINDOW_EVENTS_SD0,
			comms_buffer,
			VL53L3_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES);
	...
	VL53L3_shadow_core_results_t  *pdata)
{
	...
	if (status == VL53L3_ERROR_NONE)
		status = VL53L3_i2c_decode_shadow_core_results(
			VL53L3_SHADOW_CORE_RESULTS_I2C_SIZE_BYTES,
			comms_buffer,
			pdata);
