...
/**
 * @file vl53l3_error_codes.h
 *
 * @brief Error Code definitions for VL53L3 API.
 *
 */

#ifndef _VL53L3_ERROR_CODES_H_
#define _VL53L3_ERROR_CODES_H_
...
/*
 * @defgroup VL53L3_define_Error_group Error and Warning code returned by API
 *  The following DEFINE are used to identify the PAL ERROR
 *  @{
 */

typedef int8_t VL53L3_Error;

#define VL53L3_ERROR_NONE                              ((VL53L3_Error)  0)
#define VL53L3_ERROR_CALIBRATION_WARNING               ((VL53L3_Error) - 1)
	/*!< Warning invalid calibration data may be in used
	 *	\a  VL53L3_InitData()
	 *	\a VL53L3_GetOffsetCalibrationData
	 *	\a VL53L3_SetOffsetCalibrationData
	 */
#define VL53L3_ERROR_MIN_CLIPPED                       ((VL53L3_Error) - 2)
	/*!< Warning parameter passed was clipped to min before to be applied */

#define VL53L3_ERROR_UNDEFINED                         ((VL53L3_Error) - 3)
	/*!< Unqualified error */
#define VL53L3_ERROR_INVALID_PARAMS                    ((VL53L3_Error) - 4)
	/*!< Parameter passed is invalid or out of range */
#define VL53L3_ERROR_NOT_SUPPORTED                     ((VL53L3_Error) - 5)
	/*!< Function is not supported in current mode or configuration */
#define VL53L3_ERROR_RANGE_ERROR                       ((VL53L3_Error) - 6)
	/*!< Device report a ranging error interrupt status */
#define VL53L3_ERROR_TIME_OUT                          ((VL53L3_Error) - 7)
	/*!< Aborted due to time out */
#define VL53L3_ERROR_MODE_NOT_SUPPORTED                ((VL53L3_Error) - 8)
	/*!< Asked mode is not supported by the device */
#define VL53L3_ERROR_BUFFER_TOO_SMALL                  ((VL53L3_Error) - 9)
	/*!< ... */
#define VL53L3_ERROR_COMMS_BUFFER_TOO_SMALL            ((VL53L3_Error) - 10)
	/*!< Supplied buffer is larger than I2C supports */
#define VL53L3_ERROR_GPIO_NOT_EXISTING                 ((VL53L3_Error) - 11)
	/*!< User tried to setup a non-existing GPIO pin */
#define VL53L3_ERROR_GPIO_FUNCTIONALITY_NOT_SUPPORTED  ((VL53L3_Error) - 12)
	/*!< unsupported GPIO functionality */
#define VL53L3_ERROR_CONTROL_INTERFACE                 ((VL53L3_Error) - 13)
	/*!< error reported from IO functions */
#define VL53L3_ERROR_INVALID_COMMAND                   ((VL53L3_Error) - 14)
	/*!< The command is not allowed in the current device state
	 *  (power down)
	 */
#define VL53L3_ERROR_DIVISION_BY_ZERO                  ((VL53L3_Error) - 15)
	/*!< In the function a division by zero occurs */
#define VL53L3_ERROR_REF_SPAD_INIT                     ((VL53L3_Error) - 16)
	/*!< Error during reference SPAD initialization */
#define VL53L3_ERROR_GPH_SYNC_CHECK_FAIL               ((VL53L3_Error) - 17)
	/*!<  GPH sync interrupt check fail - API out of sync with device*/
#define VL53L3_ERROR_STREAM_COUNT_CHECK_FAIL           ((VL53L3_Error) - 18)
	/*!<  Stream count check fail - API out of sync with device */
#define VL53L3_ERROR_GPH_ID_CHECK_FAIL                 ((VL53L3_Error) - 19)
	/*!<  GPH ID check fail - API out of sync with device */
#define VL53L3_ERROR_ZONE_STREAM_COUNT_CHECK_FAIL      ((VL53L3_Error) - 20)
	/*!<  Zone dynamic config stream count check failed - API out of sync */
#define VL53L3_ERROR_ZONE_GPH_ID_CHECK_FAIL            ((VL53L3_Error) - 21)
	/*!<  Zone dynamic config GPH ID check failed - API out of sync */

#define VL53L3_ERROR_XTALK_EXTRACTION_NO_SAMPLE_FAIL   ((VL53L3_Error) - 22)
	 ...
	 */
#define VL53L3_ERROR_XTALK_EXTRACTION_SIGMA_LIMIT_FAIL ((VL53L3_Error) - 23)
...
#define VL53L3_ERROR_OFFSET_CAL_NO_SAMPLE_FAIL           ((VL53L3_Error) - 24)
	/*!<  Thrown if there one of stages has no valid offset calibration
	 *    samples. A fatal error calibration not valid
	 */
#define VL53L3_ERROR_OFFSET_CAL_NO_SPADS_ENABLED_FAIL    ((VL53L3_Error) - 25)
	 ...
	 */
#define VL53L3_ERROR_ZONE_CAL_NO_SAMPLE_FAIL             ((VL53L3_Error) - 26)
	/*!<  Thrown if then some of the zones have no valid samples
	 *    A fatal error calibration not valid
	 */

#define VL53L3_ERROR_TUNING_PARM_KEY_MISMATCH             ((VL53L3_Error) - 27)
...
#define VL53L3_WARNING_REF_SPAD_CHAR_NOT_ENOUGH_SPADS   ((VL53L3_Error) - 28)
	/*!<  Thrown if there are less than 5 good SPADs are available. */
#define VL53L3_WARNING_REF_SPAD_CHAR_RATE_TOO_HIGH      ((VL53L3_Error) - 29)
	 ...
	 */
#define VL53L3_WARNING_REF_SPAD_CHAR_RATE_TOO_LOW       ((VL53L3_Error) - 30)
...
#define VL53L3_WARNING_OFFSET_CAL_MISSING_SAMPLES       ((VL53L3_Error) - 31)
	/*!<  Thrown if there is less than the requested number of
	 *    valid samples.
	 */
#define VL53L3_WARNING_OFFSET_CAL_SIGMA_TOO_HIGH        ((VL53L3_Error) - 32)
	 ...
	 *    offset measurement
	 */
#define VL53L3_WARNING_OFFSET_CAL_RATE_TOO_HIGH         ((VL53L3_Error) - 33)
	/*!< Thrown when VL53L3_run_offset_calibration()  peak rate is greater
	 * than that 50.0Mcps. This is the recommended  max rate to avoid
	 * pile-up influencing the offset measurement
	 */
#define VL53L3_WARNING_OFFSET_CAL_SPAD_COUNT_TOO_LOW    ((VL53L3_Error) - 34)
	/*!< Thrown when VL53L3_run_offset_calibration() when one of stages
	 * range has less that 5.0 effective SPADS. This is the recommended
	 * min value to yield a stable offset
	 */


#define VL53L3_WARNING_ZONE_CAL_MISSING_SAMPLES       ((VL53L3_Error) - 35)
	/*!<  Thrown if one of more of the zones have less than
	 * the requested number of valid samples
	 */
#define VL53L3_WARNING_ZONE_CAL_SIGMA_TOO_HIGH        ((VL53L3_Error) - 36)
	/*!<  Thrown if one or more zones have sigma estimate value greater
	 *    than 8.0 mm. This is the recommended min value to yield a stable
	 *    offset measurement
	 */
#define VL53L3_WARNING_ZONE_CAL_RATE_TOO_HIGH         ((VL53L3_Error) - 37)
...
#define VL53L3_WARNING_XTALK_MISSING_SAMPLES             ((VL53L3_Error) - 38)
	/*!< Thrown to notify that some of the xtalk samples did not yield
	 * valid ranging pulse data while attempting to measure
	 * the xtalk signal in vl53l3_run_xtalk_extract(). This can signify any
	 ...
	 */
#define VL53L3_WARNING_XTALK_NO_SAMPLES_FOR_GRADIENT     ((VL53L3_Error) - 39)
	 ...
	 * measure the xtalk signal in vl53l3_run_xtalk_extract(). This can
	 ...
	 */
#define VL53L3_WARNING_XTALK_SIGMA_LIMIT_FOR_GRADIENT    ((VL53L3_Error) - 40)
	/*!< Thrown to notify that some of the xtalk samples used for gradient
...
#define VL53L3_ERROR_NOT_IMPLEMENTED                   ((VL53L3_Error) - 41)
	/*!< Tells requested functionality has not been implemented yet or
	 * not compatible with the device
	 */
#define VL53L3_ERROR_PLATFORM_SPECIFIC_START           ((VL53L3_Error) - 60)
	/*!< Tells the starting code for platform */
/** @} VL53L3_define_Error_group */
