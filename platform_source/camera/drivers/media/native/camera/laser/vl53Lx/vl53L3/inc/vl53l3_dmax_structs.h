...
#ifndef _VL53L3_DMAX_STRUCTS_H_
#define _VL53L3_DMAX_STRUCTS_H_
...
#define VL53L3_MAX_AMBIENT_DMAX_VALUES        5
...
} VL53L3_dmax_calibration_data_t;
...
typedef struct {
	...
	uint16_t  target_reflectance_for_dmax_calc[
			VL53L3_MAX_AMBIENT_DMAX_VALUES];
...
} VL53L3_hist_gen3_dmax_config_t;
