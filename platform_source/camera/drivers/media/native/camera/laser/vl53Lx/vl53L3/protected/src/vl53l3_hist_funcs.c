...
#include "vl53l3_hist_private_structs.h"
	...
	uint8_t                            *HistMergeNumber)
{
	...
	VL53L3_hist_gen3_algo_private_data_t  *palgo_gen3 =
			(VL53L3_hist_gen3_algo_private_data_t *) pArea1;
	VL53L3_hist_gen4_algo_filtered_data_t *pfiltered4 =
			(VL53L3_hist_gen4_algo_filtered_data_t *) pArea2;

	VL53L3_hist_gen3_dmax_private_data_t   dmax_algo_gen3;
	VL53L3_hist_gen3_dmax_private_data_t  *pdmax_algo_gen3 =
						&dmax_algo_gen3;

	VL53L3_histogram_bin_data_t             bins_averaged;
	VL53L3_histogram_bin_data_t           *pbins_averaged = &bins_averaged;
	...
	VL53L3_init_histogram_bin_data_struct(
			0,
			pxtalk_shape->xtalk_shape.VL53L3_p_024,
			&(pxtalk_shape->xtalk_hist_removed));



	VL53L3_copy_xtalk_bin_data_to_histogram_data_struct(
	...
	for (r = 0 ; r <= xtalk_enable ; r++) {
		...
		if (!(status == VL53L3_ERROR_NONE && r == 0))
			continue;
		...
		if (presults->active_results == 0) {
			...
			pdata->ambient_count_rate_mcps =
				pdmax_algo_gen3->VL53L3_p_001;
			pdata->VL53L3_p_006 =
				pdmax_algo_gen3->VL53L3_p_006;
		}
		...
		for (t = 0 ; t < presults->active_results ; t++) {
			...
			pdata->VL53L3_p_005 < XtalkDetectMaxSigma &&
			delta_mm <
	...
	int16_t                            *pambient_dmax_mm)
{
	...
	VL53L3_hist_gen3_dmax_private_data_t   dmax_algo;
	VL53L3_hist_gen3_dmax_private_data_t  *pdmax_algo = &dmax_algo;
