...
#ifndef _VL53L3_NVM_STRUCTS_H_
#define _VL53L3_NVM_STRUCTS_H_
...
} VL53L3_decoded_nvm_fmt_range_data_t;
...
typedef struct {
	...
	uint8_t   nvm__ews__spad_enables_rtn[VL53L3_RTN_SPAD_BUFFER_SIZE];

	uint8_t   nvm__ews__spad_enables_ref__loc1[VL53L3_REF_SPAD_BUFFER_SIZE];

	uint8_t   nvm__ews__spad_enables_ref__loc2[VL53L3_REF_SPAD_BUFFER_SIZE];

	uint8_t   nvm__ews__spad_enables_ref__loc3[VL53L3_REF_SPAD_BUFFER_SIZE];

	uint8_t   nvm__fmt__spad_enables_rtn[VL53L3_RTN_SPAD_BUFFER_SIZE];

	uint8_t   nvm__fmt__spad_enables_ref__loc1[VL53L3_REF_SPAD_BUFFER_SIZE];

	uint8_t   nvm__fmt__spad_enables_ref__loc2[VL53L3_REF_SPAD_BUFFER_SIZE];

	uint8_t   nvm__fmt__spad_enables_ref__loc3[VL53L3_REF_SPAD_BUFFER_SIZE];
	...
	VL53L3_optical_centre_t              fmt_optical_centre;
	VL53L3_cal_peak_rate_map_t           fmt_peak_rate_map;
	VL53L3_additional_offset_cal_data_t  fmt_add_offset_data;

	VL53L3_decoded_nvm_fmt_range_data_t
		fmt_range_data[VL53L3_NVM_MAX_FMT_RANGE_DATA];

	VL53L3_decoded_nvm_fmt_info_t        fmt_info;
	VL53L3_decoded_nvm_ews_info_t        ews_info;

} VL53L3_decoded_nvm_data_t;
