...
#ifndef _VL53L3_HIST_STRUCTS_H_
#define _VL53L3_HIST_STRUCTS_H_
...
#define  VL53L3_MAX_BIN_SEQUENCE_LENGTH  6
#define  VL53L3_MAX_BIN_SEQUENCE_CODE   15
#define  VL53L3_HISTOGRAM_BUFFER_SIZE   24
#define  VL53L3_XTALK_HISTO_BINS        12
...
typedef struct {
	...
	VL53L3_HistAlgoSelect  hist_algo_select;
	...
	VL53L3_HistAmbEstMethod hist_amb_est_method;
...
} VL53L3_hist_post_process_config_t;
...
typedef struct {
	...
	uint8_t  bin_seq[VL53L3_MAX_BIN_SEQUENCE_LENGTH];

	uint8_t  bin_rep[VL53L3_MAX_BIN_SEQUENCE_LENGTH];

	int32_t  bin_data[VL53L3_HISTOGRAM_BUFFER_SIZE];
...
typedef struct {
	...
	uint32_t bin_data[VL53L3_XTALK_HISTO_BINS];
...
} VL53L3_xtalk_histogram_shape_t;
...
typedef struct {
	...
	VL53L3_xtalk_histogram_shape_t  xtalk_shape;

	VL53L3_histogram_bin_data_t     xtalk_hist_removed;

} VL53L3_xtalk_histogram_data_t;
