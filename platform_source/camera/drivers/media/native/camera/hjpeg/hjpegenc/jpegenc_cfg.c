...
static void hjpeg_hufftable_init_luma_dc(void __iomem *base_addr)
{
	...
	length_bit = (uint32_t)ARRAY_SIZE(luma_dc_bits);
	length_value = (uint32_t)ARRAY_SIZE(luma_dc_value);
...
static void hjpeg_hufftable_init_luma_ac(void __iomem *base_addr)
{
	...
	length_bit = (uint32_t)ARRAY_SIZE(luma_ac_bits);
	length_value = (uint32_t)ARRAY_SIZE(luma_ac_value);
	length = length_bit + length_value;
	set_reg_val((void __iomem *)((char *)base_addr +
...
static void hjpeg_hufftable_init_chroma_dc(void __iomem *base_addr)
{
	...
	length_bit = (uint32_t)ARRAY_SIZE(chroma_dc_bits);
	length_value = (uint32_t)ARRAY_SIZE(chroma_dc_value);
	length = length_bit + length_value;
	set_reg_val((void __iomem *)((char *)base_addr +
...
static void hjpeg_hufftable_init_chroma_ac(void __iomem *base_addr)
{
	...
	length_bit = (uint32_t)ARRAY_SIZE(chroma_ac_bits);
	length_value = (uint32_t)ARRAY_SIZE(chroma_ac_value);
	length = length_bit + length_value;
	set_reg_val((void __iomem *)((char *)base_addr +
...
static void hjpeg_qtable_init(void __iomem *base_addr)
{
	...
	/* q-table 0 */
	length = (int)ARRAY_SIZE(luma_qtable1);
	set_reg_val((void __iomem *)((char *)base_addr +
	...
	/* q-table 1 */
	length = (int)ARRAY_SIZE(chroma_qtable1);
	set_reg_val((void __iomem *)((char *)base_addr +
	...
	/* q-table 2 */
	length = (int)ARRAY_SIZE(luma_qtable2);
	set_reg_val((void __iomem *)((char *)base_addr +
	...
	/* q-table 3 */
	length = (int)ARRAY_SIZE(chroma_qtable2);
	set_reg_val((void __iomem *)((char *)base_addr +
	...
	uint32_t power_controller, bool smmu_bypass)
{
	...
	if (is_hjpeg_prefetch_bypass() == PREFETCH_BYPASS_YES) {
		...
		cam_info("%s prefetch bypass", __func__);
		return;
	}
...
static void hjpeg_synccfg_init(void __iomem *base_addr)
{
	...
	set_reg_val((void __iomem *)((char *)base_addr + JPGENC_SYNCCFG_REG),
		tmp);
}
