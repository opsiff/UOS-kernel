...
typedef struct _tag_hwsensor_board_info {
	...
	int i2c_use_gpio_group; /* gpio group use for i2c gpio switch */
...
typedef struct _sensor_t {
	...
	struct sensor_power_setting_array vcm_power_up_setting_array;
	struct sensor_power_setting_array vcm_power_down_setting_array;
	enum hwsensor_state_kind_t vcm_state;
} sensor_t;
