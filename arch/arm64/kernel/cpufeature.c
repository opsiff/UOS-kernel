...
static void update_cpu_ftr_reg(struct arm64_ftr_reg *reg, u64 new)
{
	...
	for (ftrp = reg->ftr_bits; ftrp->width; ftrp++) {
		...
		/* avoid update apa for showing paca in cpuinfo */
		if(strcmp(reg->name, "SYS_ID_AA64ISAR1_EL1") == 0 && ftrp->shift == ID_AA64ISAR1_APA_SHIFT)
			continue;
#endif
		if (ftr_cur == ftr_new)
			continue;
...
{
#ifdef CONFIG_PAC_QARMA3_ENABLE
	return has_address_auth_cpucap(cpu_hwcaps_ptrs[ARM64_HAS_ADDRESS_AUTH_ARCH_QARMA3], scope);
#endif
...
{
#ifdef CONFIG_PAC_QARMA3_ENABLE
	return __system_matches_cap(ARM64_HAS_GENERIC_AUTH_ARCH_QARMA3);
#endif
...
#endif /* CONFIG_ARM64_MTE */
#ifdef CONFIG_PLATFORM_ARM64_AMU
	HWCAP_CAP(SYS_ID_AA64PFR0_EL1, ID_AA64PFR0_AMU_SHIFT, FTR_UNSIGNED, ID_AA64PFR0_AMU, CAP_HWCAP, KERNEL_HWCAP_AMU),
#endif /* CONFIG_PLATFORM_ARM64_AMU */
	{},
};
