...
static
#endif
inline bool ext4_need_verity(const struct inode *inode, pgoff_t idx)
{
...
static
#endif
void ext4_set_bio_post_read_ctx(struct bio *bio,
...
static
#endif
inline loff_t ext4_readpage_limit(struct inode *inode)
{
