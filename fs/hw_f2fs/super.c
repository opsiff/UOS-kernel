...
#include "../../platform_source/basicplatform/fs/f2fs/sdp_metadata.h"
#endif
...
#if (LINUX_VERSION_CODE < KERNEL_VERSION(5, 4, 0)) || defined(CONFIG_MAS_ORDER_PRESERVE)
...
#ifdef CONFIG_F2FS_TURBO_ZONE
		err = f2fs_gc(sbi, true, false, false, false, NULL_SEGNO);
#else
...
static struct fscrypt_operations f2fs_cryptops = {
	...
	.operate_sdp_lock	= f2fs_operate_sdp_lock,
#else
	.get_keyinfo          	= NULL,
	.update_context		= NULL,
...
static void f2fs_crypto_configure(struct f2fs_sb_info *sbi)
{
#ifdef CONFIG_F2FS_FS_ENCRYPTION
