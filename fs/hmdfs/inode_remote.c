				    ...
				    struct inode *inode)
{
	...
	gid_t user_system_gid = multiuser_get_uid(sbi->user_id, AID_SYSTEM);
	...
	inode->i_uid = KUIDT_INIT(user_system_uid);
	inode->i_gid = KGIDT_INIT(user_system_gid);
