...
{
	/* We only consider ctx as fscrypt v1 */
...
static inline const u8 *fscrypt_context_iv(const union fscrypt_context *ctx)
{
	return ctx->v1.iv;
}
...
#define fscrypt_debug(inode, fmt, ...)		\
	fscrypt_msg((inode), KERN_DEBUG, fmt, ##__VA_ARGS__)
